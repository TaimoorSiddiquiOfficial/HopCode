...
Environment Variables: Commands executed via `!` will set the `HOPCODE_CODE=1` environment variable.
...
These commands are run from the shell as `hopcode <subcommand>` before starting an interactive session.

### Session Management

| Command                 | Description                       | Usage Examples                                                     |
| ----------------------- | --------------------------------- | ------------------------------------------------------------------ |
| `hopcode sessions list` | List recent conversation sessions | `hopcode sessions list`, `hopcode sessions list --json --limit 50` |

#### `hopcode sessions list`

Lists your recent HopCode sessions with metadata.
...
hopcode sessions list --limit 50

# Output as JSON for scripting
hopcode sessions list --json | jq .
```
