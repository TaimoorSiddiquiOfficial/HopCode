...
For the current PR, HopCode keeps the renderer extension point in Web Shell
...
HopCode needs a clear way to decide whether a host-specific skill should be
...
Choose Option A if maintainers expect HopCode to support more client-rendered
