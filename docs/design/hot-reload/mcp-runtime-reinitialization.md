...
```text
① User edits .hopcode/settings.json (add/remove/edit mcpServers, or mcp.excluded / mcp.allowed)
       │
       ▼
...
A gated-source server (`project`'s `.mcp.json` and `workspace`'s `.hopcode/settings.json`, see
