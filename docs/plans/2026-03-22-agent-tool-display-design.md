...
**Tech Stack:** TypeScript, React, Vitest, shared `@hopcode/webui` tool-call components.

### Task 1: Lock in the failing data-flow behavior

**Files:**

- Modify: `packages/vscode-ide-companion/src/services/hopcodeSessionUpdateHandler.test.ts`
...
Run: `npm test --workspace=packages/vscode-ide-companion -- --run hopcodeSessionUpdateHandler.test.ts useToolCalls.test.tsx`
...
- Modify: `packages/vscode-ide-companion/src/services/hopcodeSessionUpdateHandler.ts`
...
- Forward `rawOutput` in `HopCodeSessionUpdateHandler`.
...
Run: `npm test --workspace=packages/vscode-ide-companion -- --run hopcodeSessionUpdateHandler.test.ts useToolCalls.test.tsx packages/vscode-ide-companion/src/webview/components/messages/toolcalls/index.test.tsx`
