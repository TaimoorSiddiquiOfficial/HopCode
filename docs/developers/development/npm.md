...
Releases are managed through the [release.yml](https://github.com/QwenLM/hopcode/actions/workflows/release.yml) GitHub Actions workflow. To perform a manual release for a patch or hotfix:
...
1.  Go to the [Actions tab](https://github.com/QwenLM/hopcode/actions/workflows/release.yml) of the repository.
