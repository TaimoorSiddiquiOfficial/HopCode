...
> **Note for nvm users**: If you use nvm to manage Node.js versions, the SDK may not be able to auto-detect the HopCode executable. You should explicitly set the `pathToHopCodeExecutable` option to the full path of the `qwen` binary.
