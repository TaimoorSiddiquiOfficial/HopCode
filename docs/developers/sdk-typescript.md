...
| `authType`                | `'openai' \| 'hopcode-oauth'`                 | `'openai'`       | Authentication type for the AI service. Using `'hopcode-oauth'` in SDK is not recommended as credentials are stored in `~/.hopcode` and may need periodic refresh.                                                                                                                                                                                                                                                                                                                                        |
