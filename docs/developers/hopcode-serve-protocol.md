...
Stage 1 of the [qwen-code daemon design](https://github.com/TaimoorSiddiquiOfficial/HopCode/issues/3803). All routes live under the daemon's base URL (default `http://127.0.0.1:4170`).
