...
This document describes the `exit_plan_mode` tool for HopCode.
...
## How to use `exit_plan_mode` with HopCode

The Exit Plan Mode tool is part of HopCode's planning workflow. When you're in plan mode (typically after exploring a codebase and designing an implementation approach), you use this tool to:
