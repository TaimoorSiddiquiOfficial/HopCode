...
phase_1_core_identity() {
    ...
    replace_in_file "package.json" "@hoptrendy/hopcode" "@hoptrendy/hopcode"
    ...
    find packages -name "package.json" -type f | while read -r pkg; do
        replace_in_file "$pkg" "@hoptrendy/" "@hoptrendy/"
...
phase_2_high_visibility() {
    ...
    replace_in_file "README.md" "@hoptrendy/hopcode" "@hoptrendy/hopcode"
    replace_in_file "README.md" "npm install -g @hoptrendy/hopcode" "npm install -g @hoptrendy/hopcode"
    ...
    if [ -f "scripts/installation/install-qwen-with-source.sh" ]; then
        ...
        replace_in_file "scripts/installation/install-qwen-with-source.sh" "@hoptrendy/hopcode" "@hoptrendy/hopcode"
    ...
    if [ -f "scripts/installation/install-qwen-with-source.bat" ]; then
        ...
        replace_in_file "scripts/installation/install-qwen-with-source.bat" "@hoptrendy/hopcode" "@hoptrendy/hopcode"
    ...
    replace_in_file "packages/webui/tailwind.preset.cjs" "@hoptrendy/webui" "@hoptrendy/webui"
...
phase_4_documentation() {
    ...
    if [ -f "packages/sdk-typescript/README.md" ]; then
        replace_in_file "packages/sdk-typescript/README.md" "@hoptrendy/sdk" "@hoptrendy/sdk"
...
phase_5_infrastructure() {
    ...
    find .github/workflows -name "*.yml" -o -name "*.yaml" | while read -r file; do
        replace_in_file "$file" "qwen-code" "hopcode"
        replace_in_file "$file" "@hoptrendy/" "@hoptrendy/"
    done
