...
# This script handles the remaining "hopcode" references that were missed by the initial rebranding.
#
# Key rules:
# - Model names (qwen3-max, qwen3-coder-plus, etc.) are PRESERVED - they reference external AI models
# - HOPCODE_code_sdk is PRESERVED - it references an external Python SDK
...
# ============================================================
# PHASE 2A: Environment Variables (HOPCODE_ -> HOPCODE_)
# ============================================================
...
# HOPCODE_CODE_* -> HOPCODE_CODE_* (keeping CODE part for consistency)
$envReplacements = @{
    "HOPCODE_CODE_SESSION_ID" = "HOPCODE_CODE_SESSION_ID"
    "HOPCODE_CODE_MAX_TOOL_CONCURRENCY" = "HOPCODE_CODE_MAX_TOOL_CONCURRENCY"
    "HOPCODE_CODE_AGENT_ID" = "HOPCODE_CODE_AGENT_ID"
    "HOPCODE_CODE_PROMPT_ID" = "HOPCODE_CODE_PROMPT_ID"
    "HOPCODE_CODE_LEGACY_MCP_BLOCKING" = "HOPCODE_CODE_LEGACY_MCP_BLOCKING"
    "HOPCODE_CODE_NO_RELAUNCH" = "HOPCODE_CODE_NO_RELAUNCH"
    "HOPCODE_CODE_EMIT_TOOL_USE_SUMMARIES" = "HOPCODE_CODE_EMIT_TOOL_USE_SUMMARIES"
    "HOPCODE_CODE_UNATTENDED_RETRY" = "HOPCODE_CODE_UNATTENDED_RETRY"
    "HOPCODE_CODE_TOOL_CALL_STYLE" = "HOPCODE_CODE_TOOL_CALL_STYLE"
    "HOPCODE_CODE_PROFILE_RUNTIME" = "HOPCODE_CODE_PROFILE_RUNTIME"
    "HOPCODE_CODE_PROFILE_STARTUP" = "HOPCODE_CODE_PROFILE_STARTUP"
    "HOPCODE_CODE_DISABLE_SYNCHRONIZED_OUTPUT" = "HOPCODE_CODE_DISABLE_SYNCHRONIZED_OUTPUT"
    "HOPCODE_CODE_DEBUG" = "HOPCODE_CODE_DEBUG"
    "HOPCODE_CODE_SIMPLE" = "HOPCODE_CODE_SIMPLE"
    "HOPCODE_CODE_ENABLE_CRON" = "HOPCODE_CODE_ENABLE_CRON"
}

# Other HOPCODE_* env vars (without CODE)
$otherEnvReplacements = @{
    "HOPCODE_OAUTH" = "HOPCODE_OAUTH"
    "HOPCODE_DEFAULT_AUTH_TYPE" = "HOPCODE_DEFAULT_AUTH_TYPE"
    "HOPCODE_AUDIT_RAW_PATHS" = "HOPCODE_AUDIT_RAW_PATHS"
    "HOPCODE_COMPUTER_USE_PACKAGE" = "HOPCODE_COMPUTER_USE_PACKAGE"
    "HOPCODE_COMPUTER_USE_AUTO_APPROVE" = "HOPCODE_COMPUTER_USE_AUTO_APPROVE"
    "HOPCODE_MEMORY_PRESSURE_SOFT" = "HOPCODE_MEMORY_PRESSURE_SOFT"
    "HOPCODE_MEMORY_PRESSURE_HARD" = "HOPCODE_MEMORY_PRESSURE_HARD"
    "HOPCODE_MEMORY_PRESSURE_CRITICAL" = "HOPCODE_MEMORY_PRESSURE_CRITICAL"
    "HOPCODE_MEMORY_ENABLE_GC" = "HOPCODE_MEMORY_ENABLE_GC"
    "HOPCODE_RUNTIME_DIR" = "HOPCODE_RUNTIME_DIR"
    "HOPCODE_DEBUG" = "HOPCODE_DEBUG"
    "HOPCODE_TELEMETRY_METRICS_INCLUDE_SESSION_ID" = "HOPCODE_TELEMETRY_METRICS_INCLUDE_SESSION_ID"
    "HOPCODE_SERVER_TOKEN" = "HOPCODE_SERVER_TOKEN"
    "HOPCODE_SYSTEM_MD" = "HOPCODE_SYSTEM_MD"
    "HOPCODE_PID" = "HOPCODE_PID"
    "HOPCODE_OAUTH_SCOPE" = "HOPCODE_OAUTH_SCOPE"
    "HOPCODE_IMAGE_TOKEN_ESTIMATE" = "HOPCODE_IMAGE_TOKEN_ESTIMATE"
    "HOPCODE_DAEMON_TOKEN" = "HOPCODE_DAEMON_TOKEN"
    "HOPCODE_DAEMON_URL" = "HOPCODE_DAEMON_URL"
    "HOPCODE_API_KEY" = "HOPCODE_API_KEY"
    "HOPCODE_SHELL_COMMAND" = "HOPCODE_SHELL_COMMAND"
    "HOPCODE_TELEMETRY_TARGET" = "HOPCODE_TELEMETRY_TARGET"
    "HOPCODE_TELEMETRY_OUTFILE" = "HOPCODE_TELEMETRY_OUTFILE"
    "HOPCODE_TELEMETRY_OTLP_TRACES_ENDPOINT" = "HOPCODE_TELEMETRY_OTLP_TRACES_ENDPOINT"
    "HOPCODE_TELEMETRY_OTLP_PROTOCOL" = "HOPCODE_TELEMETRY_OTLP_PROTOCOL"
    "HOPCODE_TELEMETRY_OTLP_METRICS_ENDPOINT" = "HOPCODE_TELEMETRY_OTLP_METRICS_ENDPOINT"
    "HOPCODE_TELEMETRY_OTLP_LOGS_ENDPOINT" = "HOPCODE_TELEMETRY_OTLP_LOGS_ENDPOINT"
    "HOPCODE_TELEMETRY_INCLUDE_SENSITIVE_SPAN_ATTRIBUTES" = "HOPCODE_TELEMETRY_INCLUDE_SENSITIVE_SPAN_ATTRIBUTES"
    "HOPCODE_TELEMETRY_ENABLED" = "HOPCODE_TELEMETRY_ENABLED"
    "HOPCODE_TELEMETRY_LOG_PROMPTS" = "HOPCODE_TELEMETRY_LOG_PROMPTS"
    "HOPCODE_SERVE_MCP_CLIENT_BUDGET" = "HOPCODE_SERVE_MCP_CLIENT_BUDGET"
    "HOPCODE_IDE_DAEMON_URL" = "HOPCODE_IDE_DAEMON_URL"
    "HOPCODE_CHANNEL_DAEMON_URL" = "HOPCODE_CHANNEL_DAEMON_URL"
    "HOPCODE_WEB_DAEMON_URL" = "HOPCODE_WEB_DAEMON_URL"
    "HOPCODE_DAEMON_WORKSPACE" = "HOPCODE_DAEMON_WORKSPACE"
    "HOPCODE_DISABLED_SLASH_COMMANDS" = "HOPCODE_DISABLED_SLASH_COMMANDS"
    "HOPCODE_BASELINE_ENABLE_PROMPT_LATENCY" = "HOPCODE_BASELINE_ENABLE_PROMPT_LATENCY"
    "HOPCODE_BASELINE_HEAVY" = "HOPCODE_BASELINE_HEAVY"
    "HOPCODE_BASELINE_PROMPT_ITERATIONS" = "HOPCODE_BASELINE_PROMPT_ITERATIONS"
    "HOPCODE_BASELINE_RSS_SAMPLE_DURATION_MS" = "HOPCODE_BASELINE_RSS_SAMPLE_DURATION_MS"
    "HOPCODE_BASELINE_RSS_SAMPLE_INTERVAL_MS" = "HOPCODE_BASELINE_RSS_SAMPLE_INTERVAL_MS"
    "HOPCODE_BASELINE_SKIP_PROMPT_LATENCY" = "HOPCODE_BASELINE_SKIP_PROMPT_LATENCY"
    "HOPCODE_TUI_E" = "HOPCODE_TUI_E"
    "HOPCODE_DEBUG_LOG_FILE" = "HOPCODE_DEBUG_LOG_FILE"
    "HOPCODE_COMPACT_MAX_RECENT_FILES" = "HOPCODE_COMPACT_MAX_RECENT_FILES"
    "HOPCODE_COMPACT_MAX_RECENT_IMAGES" = "HOPCODE_COMPACT_MAX_RECENT_IMAGES"
}
...
$identifierReplacements = @{
    ...
    "HOPCODE_status" = "hopcode_status"
    "HOPCODE_count" = "hopcode_count"
    "HOPCODE_version" = "hopcode_version"
    "HOPCODE_stderr" = "hopcode_stderr"
    "HOPCODE_stdout" = "hopcode_stdout"
    "HOPCODE_http" = "hopcode_http"
    "HOPCODE_normalize_err" = "hopcode_normalize_err"
    "HOPCODE_normalize_status" = "hopcode_normalize_status"
    "HOPCODE_executable" = "hopcode_executable"
}
...
# ============================================================
# PHASE 2C: String patterns (hopcode -> hopcode, etc.)
# ============================================================
Write-Host "`n=========================================" -ForegroundColor Cyan
...
# ============================================================
# PHASE 2D: Standalone "hopcode" replacements using regex
# Only replace standalone "hopcode" that's NOT a model name
# ============================================================
Write-Host "`n=========================================" -ForegroundColor Cyan
...
foreach ($file in $regexFiles) {
    ...
    # For remaining "hopcode" references that are product/brand references:
    # - "hopcode" as CLI command name -> "hopcode"
    # - "hopcode" in path contexts -> "hopcode"
}
...
foreach ($file in $githubFiles) {
    # GitHub issue/PR references - keep QwenLM/hopcode for upstream tracking
...
Write-Host "`nNOTE: Model names (qwen3-max, qwen3-coder-plus, etc.) and HOPCODE_code_sdk were PRESERVED as external references." -ForegroundColor Magenta