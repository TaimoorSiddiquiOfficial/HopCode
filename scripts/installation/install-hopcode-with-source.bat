...
if /i "!MIRROR!"=="aliyun" (
    set "STANDALONE_BASE_URL=https://hopcode-assets.oss-cn-hangzhou.aliyuncs.com/releases/hopcode/!VERSION_PATH!"
    exit /b 0
)
...
echo ERROR: !MANAGED_DIR! exists but is not a HopCode standalone install.
