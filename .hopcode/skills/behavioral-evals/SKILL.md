...
> [!NOTE]
> **Single Source of Truth**: For core concepts, policies, running tests, and general best practices, always refer to **[docs/evals/README.md](file:///docs/evals/README.md)**.
...
2.  **Is it UI/Interaction heavy?**
    - _Yes_ -> Use `appEvalTest` (`AppRig`). See **[creating.md](references/creating.md)**.
    - _No_ -> Use `evalTest` (`TestRig`). See **[creating.md](references/creating.md)**.
3.  **Is it a new test?**
...
- _See **[docs/evals/README.md](file:///docs/evals/README.md)** for running commands._
