...
PORT=8765 LOG_FILE=/tmp/mock.log \
  node .hopcode/skills/e2e-testing/scripts/mock-openai-server.js &

http_proxy= https_proxy= \
<hopcode> --auth-type openai \
...
`knowledge/hopcode/scripts/issue-3664-mock-server.js` is a worked example —
