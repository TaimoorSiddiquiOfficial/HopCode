---
name: feat-dev
description: End-to-end workflow for implementing a non-trivial HopCode
...
Use this workflow when implementing a feature in HopCode that needs design,
...
Use `.hopcode/` paths for planning artifacts:

- `.hopcode/design/<feature>.md`
- `.hopcode/e2e-tests/<feature>.md`

## Phase 1: Investigate

Understand the requested behavior and the current HopCode implementation.
...
`hopcode` CLI, not the local build.
