...
- **Inadmissible**: religious or political flame wars, harassment, abusive
  language, spam, or content unrelated to HopCode.
...
1. Run `/goal Is this feature request truly aligned with HopCode's product direction, and is the proposed approach the best solution?`
