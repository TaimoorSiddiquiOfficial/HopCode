...
name: ci
description:
  A specialized skill for HopCode that provides high-performance, fail-fast
...
- **Tool**: `node .hopcode/skills/ci/scripts/ci.mjs [branch]`
...
- **Tool**: `node .hopcode/skills/ci/scripts/ci.mjs [branch] [run_id]`
- **Discovery**: The script **automatically** finds the latest active or recent
