...
```bash
cd /Users/gawain/Documents/codebase/opensource/hopcode-table-wrap-ansi-highlight
...
HOP_TUI_E2E_OUT=/tmp/hop-table-wrap-ansi/fixed \
  npx tsx integration-tests/terminal-capture/table-inline-code-wrap-regression.ts

HOP_TUI_E2E_REPO=/Users/gawain/Documents/codebase/opensource/hopcode-table-wrap-ansi-highlight-base \
HOP_TUI_E2E_OUT=/tmp/hop-table-wrap-ansi/base \
HOP_TUI_E2E_EXPECT_PASS=false \
  npx tsx integration-tests/terminal-capture/table-inline-code-wrap-regression.ts
```
...
- Base summary: `/tmp/hop-table-wrap-ansi/base/summary.json`
- Base raw ANSI: `/tmp/hop-table-wrap-ansi/base/raw.ansi.log`
- Base screenshot: `/tmp/hop-table-wrap-ansi/base/table-inline-code-wrap.png`
- Fixed summary: `/tmp/hop-table-wrap-ansi/fixed/summary.json`
- Fixed raw ANSI: `/tmp/hop-table-wrap-ansi/fixed/raw.ansi.log`
- Fixed screenshot: `/tmp/hop-table-wrap-ansi/fixed/table-inline-code-wrap.png`
