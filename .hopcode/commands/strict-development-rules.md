# HopCode Strict Development Rules
...
- **Keyboard Handling**: Keyboard handling MUST go through `useKeyPress.ts` from
  the HopCode CLI package rather than the standard ink library. This library
...
## General HopCode Design Principles
...
- **Prompts**: Be aware that changes can impact the prompts sent to HopCode
