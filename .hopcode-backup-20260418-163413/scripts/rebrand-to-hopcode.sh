...
phase_1_core_identity() {
    ...
    replace_in_files "*.sh" "\.qwen" ".hopcode"
    replace_in_files "*.bat" "\\.qwen" ".hopcode"
    replace_in_files "*.ts" "\.qwen" ".hopcode"
    replace_in_files "*.js" "\.qwen" ".hopcode"
...
phase_2_high_visibility() {
    ...
    if [ -f "scripts/installation/install-qwen-with-source.sh" ]; then
        ...
        replace_in_file "scripts/installation/install-qwen-with-source.sh" "\.qwen" ".hopcode"
    ...
    if [ -f "scripts/installation/install-qwen-with-source.bat" ]; then
        ...
        replace_in_file "scripts/installation/install-qwen-with-source.bat" "%USERPROFILE%\\.qwen" "%USERPROFILE%\\.hopcode"
    ...
    if [ -f "packages/vscode-ide-companion/package.json" ]; then
        ...
        replace_in_file "packages/vscode-ide-companion/package.json" "qwenlm.qwen-code" "hopcode.hopcode"
    fi
    ...
    if [ -f "packages/zed-extension/extension.toml" ]; then
        ...
        replace_in_file "packages/zed-extension/extension.toml" '\[agent_servers.qwen-code\]' '[agent_servers.hopcode]'
    fi
    ...
    replace_in_file "packages/webui/src/styles/timeline.css" ".qwen-message" ".hopcode-message"
...
phase_3_source_code() {
    ...
    # Note: Keeping com.alibaba.qwen package names for Maven compatibility
...
phase_5_infrastructure() {
    ...
    replace_in_file ".gitignore" ".qwen" ".hopcode"
