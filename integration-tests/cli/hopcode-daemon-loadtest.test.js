 ...
 *
 * Gated by HOPCODE_LOADTEST_ENABLED=1. Run via:
 *   HOPCODE_LOADTEST_ENABLED=1 npx vitest run \
...
// Skip logic
// ---------------------------------------------------------------------------
const SKIP = process.env['HOPCODE_LOADTEST_ENABLED'] !== '1' ||
...
function mockDaemonEnv(mode = 'echo') {
    return {
        HOPCODE_CLI_ENTRY: MOCK_AGENT_PATH,
        MOCK_ACP_MODE: mode,
...
function renderMarkdown(s) {
    const lines = [
        `# hopcode serve daemon — connection stress test report`,
        ``,
...
//# sourceMappingURL=hopcode-daemon-loadtest.test.js.map