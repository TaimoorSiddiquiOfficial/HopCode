...
const IS_SANDBOX = process.env['HOPCODE_SANDBOX'] &&
...
(IS_SANDBOX || !HAS_API_KEY ? describe.skip : describe)('acp integration', () => {
    ...
    it('returns internal error details when model auth is required', async () => {
        ...
        try {
            ...
            const hopcodeOauthModel = newSession.models.availableModels.find((model) => model.modelId.includes('hopcode-oauth'));
...
(IS_SANDBOX || !HAS_API_KEY ? describe.skip : describe)('acp flag backward compatibility', () => {
