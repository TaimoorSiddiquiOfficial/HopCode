 ...
 */
/**
 * `hopcode serve` daemon — HTTP route + middleware integration tests.
 *
 ...
 * (which itself spawns real `hopcode --acp` children), then probe the HTTP
...
import { DaemonClient, DaemonHttpError, } from '@hoptrendy/sdk';
import { SESSION_TRANSCRIPT_MAX_INDEX_BYTES, Storage, } from '@hoptrendy/hopcode-core';
...
describe('hopcode serve — bearer auth (timing-safe compare)', () => {
    ...
    it('/health exempt: missing Authorization header → 200', async () => {
        ...
        // docs/developers/hopcode-serve-protocol.md so a future middleware
...
describe('hopcode serve — CORS browser-origin denial', () => {
...
describe('hopcode serve — POST /permission/:requestId validation', () => {
...
describe('hopcode serve — SSE Content-Type guard (SDK side)', () => {
...
describe('hopcode serve — Last-Event-ID strict parsing', () => {
...
describe('hopcode serve — cancel + list', () => {
...
//# sourceMappingURL=hopcode-serve-routes.test.js.map