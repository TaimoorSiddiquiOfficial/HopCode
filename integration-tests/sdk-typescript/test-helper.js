...
import { isSDKAssistantMessage, isSDKSystemMessage, isSDKResultMessage, } from '@hoptrendy/sdk';
/**
...
export class SDKTestHelper {
    ...
    async setup(testName, options = {}) {
        ...
        if (options.createHopCodeConfig !== false) {
            ...
            await writeFile(join(hopcodeDir, 'settings.json'), JSON.stringify(settings, null, 2), 'utf-8');
        }
        return this.testDir;
    }
    /**
