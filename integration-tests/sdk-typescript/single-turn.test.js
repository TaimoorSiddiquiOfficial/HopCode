...
import { query, isSDKAssistantMessage, isSDKSystemMessage, isSDKResultMessage, isSDKPartialAssistantMessage, } from '@hoptrendy/sdk';
    ...
    describe('Simple Text Queries', () => {
        ...
        it('should handle greeting and self-description', async () => {
            ...
            try {
                ...
                expect(assistantText.length).toBeGreaterThan(0);
                expect(assistantText.toLowerCase()).toMatch(/hello|hi|greetings|hopcode|assistant/);
    ...
    describe('Error Handling', () => {
        it('should throw if CLI not found', async () => {
            try {
                ...
                expect(error.message).toContain('Invalid pathToHopCodeExecutable');
            }
        });
    });
