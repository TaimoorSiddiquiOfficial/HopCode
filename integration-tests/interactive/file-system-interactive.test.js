...
describe('Interactive file system', () => {
    ...
    it.skipIf(process.platform === 'win32')('should perform a read-then-write sequence in interactive mode', { timeout: 180_000 }, async () => {
        ...
        await type(ptyProcess, '\r');
        const toolCall = await rig.waitForAnyToolCall(['write_file', 'edit'], 120_000);
        if (!toolCall) {
