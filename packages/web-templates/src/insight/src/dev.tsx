    ...
    improvements: {
      ...
      usage_patterns: [
        ...
        },
        {
          ...
          detail:
            '5 buggy_code friction points mostly came from test mock implementation issues. Documenting your testing patterns in HOPCODE.md would help Qwen generate correct tests on the first attempt.',
          copyable_prompt:
