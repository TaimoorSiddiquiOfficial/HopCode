...
function InsightApp({ data }) {
    ...
    return (_jsxs("div", { children: [_jsx("header", { className: "insights-header", children: _jsxs("div", { className: "header-content", children: [_jsxs("div", { className: "header-title-section", children: [_jsx("h1", { className: "header-title", children: "HopCode Insights" }), _jsxs("p", { className: "header-subtitle", children: [data.totalMessages
