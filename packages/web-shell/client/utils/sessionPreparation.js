...
export async function createAndAttachSessionForPrompt({ sessionActions, modelId, modeId, workspaceCwd, onSessionCreated, onSessionAllocated, getCurrentSessionId, warn = console.warn, }) {
