...
import { normalizeDaemonEvent } from '@hoptrendy/sdk/daemon';
import { computeTodoDetails, computeTodoTimeline, extractTodoStats, extractTodosFromToolCall, getFloatingTodos, getTodoStatusIcon, getTodoWindow, isTodoWriteToolName, todoDetailSignature, todoStateKey, todoTimelineSignature, } from './todos';
...
function todoWriteMessage(id, todos, stats) {
    const tool = {
        callId: `call-${id}`,
        toolName: 'todo_write',
        status: 'completed',
