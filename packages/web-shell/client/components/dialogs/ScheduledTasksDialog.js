...
function setPromptEditorText(root, text) {
...
function normalizePromptEditor(root) {
...
function makePromptTagElement(item) {
...
function appendPromptLine(root, line) {
    let cursor = 0;
...
function insertPromptTagElement(root, item) {
    const selection = window.getSelection();
...
function PromptReferenceEditor({ value, label, placeholder, onChange, insertItem, onInserted, }) {
    ...
    return (_jsxs("div", { className: styles.promptEditorWrap, children: [_jsx("div", { ref: editorRef, className: styles.promptEditor, contentEditable: true, role: "textbox", "aria-label": label, "aria-multiline": "true", "aria-placeholder": placeholder, onInput: (event) => {
...
export function ScheduledTasksDialog({ onRunPrompt, onCreateViaChat, onOpenSession, workspaces, lockedWorkspace, onError, }) {
    ...
    return (_jsxs("div", { className: styles.root, children: [_jsx("div", { className: styles.intro, children: t('scheduledTasks.subtitle') }), _jsxs("div", { className: styles.toolbar, children: [_jsx("div", { className: styles.count, children: tasks === null
                    ...
                    return (_jsxs("div", { className: `${styles.card} ${task.enabled ? '' : styles.cardDisabled}`, children: [_jsxs("div", { className: styles.cardHeader, children: [_jsx("button", { type: "button", role: "switch", "aria-checked": task.enabled, "aria-label": task.enabled
                                        ...
                                        }), children: [_jsx("span", { className: styles.hourglassIcon, "aria-hidden": "true", children: "\u23F3" }), formatCountdown(task.nextRunAt - now, t)] })), _jsx("span", { className: styles.lastFired, children: describeLastRun(task, t) }), task.sessionId && onOpenSession ? (_jsx("button", { type: "button", className: styles.runsToggle, onClick: () => onOpenSession(task.sessionId), title: t('scheduledTasks.viewHistoryHint'), children: task.runs.length > 0
