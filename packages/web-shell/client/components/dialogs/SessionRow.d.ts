...
import { type DaemonSessionSummary } from '@hoptrendy/webui/daemon-react-sdk';
 ...
 */
export declare function SessionRow({ session, active, current, confirmed, disabled, currentLabel, optionId, ariaSelected, leading, trailing, resumeSelector, onClick, onActivate, }: SessionRowProps): import("react").JSX.Element;
export {};
