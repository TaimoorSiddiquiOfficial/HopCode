...
export declare function ScheduledTasksDialog({ onRunPrompt, onCreateViaChat, onOpenSession, workspaces, lockedWorkspace, onError, }: ScheduledTasksDialogProps): import("react").JSX.Element;
export {};
