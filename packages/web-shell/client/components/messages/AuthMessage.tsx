    ...
    <div className={styles.panel}>
      ...
      {view === 'groups' && !loading && (
        <div className={styles.terms}>
          ...
          <a
            className={styles.link}
            href="https://taimoorsiddiquiofficial.github.io/HopCode-docs/en/users/support/tos-privacy/"
            target="_blank"
            rel="noreferrer"
          >
            https://taimoorsiddiquiofficial.github.io/HopCode-docs/en/users/support/tos-privacy/
          </a>
        </div>
      )}
      {view !== 'groups' && (
