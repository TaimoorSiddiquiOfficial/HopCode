import type { DaemonSettingDescriptor, DaemonSettingUpdateResult, DaemonWorkspaceSettingsStatus } from '@hoptrendy/webui/daemon-react-sdk';
...
export declare function SettingsMessage({ settingsState, onLanguageChange, onSubDialog, onThemeChange, chatWidthMode, onChatWidthModeChange, modelManagement, embedded, }: SettingsMessageProps): import("react").JSX.Element;
export {};
