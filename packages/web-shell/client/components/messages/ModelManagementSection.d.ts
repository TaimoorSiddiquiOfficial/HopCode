import type { DaemonWorkspaceProviderStatus } from '@hoptrendy/webui/daemon-react-sdk';
...
export declare function ModelManagementSection({ providers, currentModelId, loading, error, busy, onSelectModel, onDeleteModel, onAddModel, }: ModelManagementProps): import("react").JSX.Element;
