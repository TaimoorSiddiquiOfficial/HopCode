...
describe('toolFormatting', () => {
    ...
    it('falls back to the basename when workspace cwd does not match', () => {
        expect(getToolDescription(tool({
            args: {
                file_path: '/Users/ytahdn/Documents/Codes/alishu/hopcode/README.md',
            },
        }), '/Users/ytahdn/Documents/Codes/hopcode/hopcode')).toBe('README.md');
    });
    ...
    it('matches CLI-style glob fallback descriptions', () => {
        expect(getToolDescription(tool({
            toolName: 'glob',
            args: { pattern: '**/*.ts', path: '/Users/ytahdn/.hopcode' },
        }), '/workspace/project')).toBe("'**/*.ts' in path '/Users/ytahdn/.hopcode'");
    });
    it('matches CLI-style glob result summaries', () => {
        expect(getToolResultSummary(tool({
            toolName: 'glob',
            rawOutput: '/Users/ytahdn/.hopcode/settings.json\n',
    ...
    it('includes shell descriptions in fallback descriptions', () => {
        expect(getToolDescription(tool({
            ...
            args: {
                ...
                description: '查看 ~/.hopcode/settings.json 文件内容',
            },
        }))).toBe('cat ~/.hopcode/settings.json (查看 ~/.hopcode/settings.json 文件内容)');
    });
