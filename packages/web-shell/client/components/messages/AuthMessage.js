...
export function AuthMessage({ onMessage, onClose }) {
    ...
    return (_jsxs("div", { className: styles.panel, children: [_jsx("div", { className: styles.steps, children: stepItems.map((label, index) => {
                ...
                }) }), _jsx("div", { className: styles.body, children: body }), error && _jsx("div", { className: styles.error, children: error }), view === 'groups' && !loading && (_jsxs("div", { className: styles.terms, children: [_jsxs("div", { children: [t('auth.termsTitle'), ":"] }), _jsx("a", { className: styles.link, href: "https://taimoorsiddiquiofficial.github.io/HopCode-docs/en/users/support/tos-privacy/", target: "_blank", rel: "noreferrer", children: "https://taimoorsiddiquiofficial.github.io/HopCode-docs/en/users/support/tos-privacy/" })] })), view !== 'groups' && (_jsx("div", { className: styles.footer, children: currentStep === 'advancedConfig'
