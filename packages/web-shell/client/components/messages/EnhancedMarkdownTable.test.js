...
describe('EnhancedMarkdownTable', () => {
    ...
    it('resizes a column from its header handle', () => {
        ...
        expect(button(container, 'Sort by Team').closest('th')?.style.width).toBe('220px');
    ...
    it('clamps resized columns to the minimum width', () => {
        ...
        expect(button(container, 'Sort by Team').closest('th')?.style.width).toBe('80px');
    ...
    it('clamps resized columns to the maximum width', () => {
        ...
        expect(button(container, 'Sort by Team').closest('th')?.style.width).toBe('640px');
    ...
    it('stops resizing a column when the window blurs', () => {
        ...
        expect(button(container, 'Sort by Team').closest('th')?.style.width).toBe('160px');
    });
    it('flushes pending resize width when the window blurs', () => {
        ...
        expect(button(container, 'Sort by Team').closest('th')?.style.width).toBe('260px');
    });
    ...
    it('keeps resizing when page visibility changes while visible', () => {
        ...
        expect(button(container, 'Sort by Team').closest('th')?.style.width).toBe('280px');
    });
    it('resizes a column with keyboard arrows', () => {
        ...
        expect(button(container, 'Sort by Team').closest('th')?.style.width).toBe('176px');
        act(() => {
            resize.dispatchEvent(new KeyboardEvent('keydown', {
                bubbles: true,
                key: 'ArrowLeft',
    ...
    it('does not offer hiding the last visible column', () => {
        ...
        click(textButton(container, 'Hide column'));
        click(button(container, 'Filter Score'));
        expect([...container.querySelectorAll('button')].some((el) => el.textContent === 'Hide column')).toBe(false);
    });
