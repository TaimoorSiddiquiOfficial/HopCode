...
export declare function formatToolGroupSummary(tools: ACPToolCall[], t: ReturnType<typeof useI18n>['t'], duration?: string): string;
...
export declare function hasActiveTool(tools: ACPToolCall[]): boolean;
export declare function isWebFetchToolName(toolName: string): boolean;
export declare const ToolLine: import("react").MemoExoticComponent<({ tool, approval, workspaceCwd, summaryOnly, forceExpanded, forceExpandable, hideHeader, hideCollapsedOutput, }: ToolLineProps) => import("react").JSX.Element>;
export declare const ToolGroup: import("react").MemoExoticComponent<({ tools, pendingApproval, workspaceCwd, isLocateFlashing, }: ToolGroupProps) => import("react").JSX.Element>;
export {};
