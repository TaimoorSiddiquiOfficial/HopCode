...
export declare function PluginManagerPage({ mcpMessage, loadMcpMessage, onClose, onUseSkill, initialFocusRef, }: PluginManagerPageProps): import("react").JSX.Element;
export {};
