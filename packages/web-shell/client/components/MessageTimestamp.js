 ...
 */
export function MessageTimestamp({ timestamp, children, chatMode = false, copyText, copyTitle = 'Copy', }) {
    ...
    if (timestamp === undefined) {
        return (_jsxs("div", { className: chatMode ? styles.chatRow : styles.row, children: [children, copyButton] }));
    }
    return (_jsxs("div", { className: chatMode ? styles.chatRow : styles.row, children: [children, chatMode ? (_jsxs("span", { className: styles.chatActions, children: [_jsx("span", { className: styles.chatTip, "aria-hidden": "true", children: formatTimestamp(timestamp) }), copyButton] })) : (_jsx("span", { className: styles.tip, "aria-hidden": "true", children: formatTimestamp(timestamp) }))] }));
}
function CopyIcon() {
