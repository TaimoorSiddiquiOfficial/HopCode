...
export declare function applyTurnCollapse(items: DisplayItem[], { overrides, isResponding, activeTurnStartedAt, pendingApprovalCallId, enabled, }: ApplyTurnCollapseOptions): DisplayItem[];
/**
