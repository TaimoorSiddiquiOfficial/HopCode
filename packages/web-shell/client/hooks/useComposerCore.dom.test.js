...
let root = null;
let latest = null;
function Harness({ composerInput, onSubmit, renderComposerTag, renderComposerTagTooltip, }) {
    ...
    latest = composer;
    return _jsx("div", { ref: composer.containerRef });
}
async function mount({ composerInput, onSubmit = vi.fn(), renderComposerTag, renderComposerTagTooltip, } = {}) {
    container = document.createElement('div');
    document.body.append(container);
    root = createRoot(container);
    await act(async () => {
        root.render(_jsx(I18nProvider, { language: "en", children: _jsx(Harness, { composerInput: composerInput, onSubmit: onSubmit, renderComposerTag: renderComposerTag, renderComposerTagTooltip: renderComposerTagTooltip }) }));
    });
    return { onSubmit };
}
afterEach(() => {
