...
function Harness({ actions, disabled = false, builtinProviders, providers, shellMode = false, view, createInlineTagEffect, }) {
...
function mount({ actions, disabled, builtinProviders, providers, shellMode, view, createInlineTagEffect, } = {}) {
    container = document.createElement('div');
    document.body.appendChild(container);
    root = createRoot(container);
    act(() => {
        root.render(_jsx(Harness, { actions: actions, disabled: disabled, builtinProviders: builtinProviders, providers: providers, shellMode: shellMode, view: view, createInlineTagEffect: createInlineTagEffect }));
    });
}
