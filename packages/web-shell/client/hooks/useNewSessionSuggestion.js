...
function tryParseDecision(text) {
    try {
        ...
        if (typeof parsed.shouldSuggestNewSession !== 'boolean')
            return null;
...
export function useNewSessionSuggestion({ enabled, inputText, messages, sessionId, contextUsageRatio, isRunning, dialogOpen, generateContent, }) {
