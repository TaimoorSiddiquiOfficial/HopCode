...
import { useActions, useConnection, usePromptStatus, useWorkspaceEventSignals, } from '@hoptrendy/webui/daemon-react-sdk';
...
export function useSessionArtifacts() {
    ...
    const loadedSessionIdRef = useRef(undefined);
    ...
    const refresh = useCallback(async () => {
        ...
        if (loadedSessionIdRef.current !== undefined &&
...
function isSessionDisconnectedError(error) {
