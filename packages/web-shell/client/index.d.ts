 ...
 */
export declare function WebShell(props: WebShellProps): import("react").JSX.Element;
/**
 ...
 */
export declare function WebShellWithProviders(props: WebShellWithProvidersProps): import("react").JSX.Element;
...
export type { WebShellApi, WebShellComposerPlaceholders, WebShellComposerPlaceholderState, WebShellProps, WebShellSidebarOptions, BugReportInfo, SessionChangeEvent, } from './App';
export type { ToastTone } from './components/ToastHost';
export type { WebShellSidebarBranding, WebShellSidebarFooterItem, WebShellSidebarFooterOptions, WebShellSidebarLockedWorkspace, } from './components/sidebar/WebShellSidebar';
...
export type { DatasetCell, EchartsFullDataBlockProps, EchartsFullDataOption, EchartsFullDataRefMeta, EchartsFullDataRefResolver, EchartsFullDataResolvedDataset, EchartsFullDataRendererOptions, EchartsInstance, EchartsRuntime, EchartsRuntimeLoader, } from './components/messages/EchartsFullDataBlock';
