...
const EN: Messages = {
  ...
  'agent.create.method.hopcode.recommended':
    'Generate with HopCode (Recommended)',
  'agent.create.method.hopcode.desc':
  ...
  'agent.create.hopcodeHint':
    'Describe what this subagent should do and when it should be used. (Be comprehensive for best results)',
  'agent.create.hopcodePlaceholder':
  ...
  'skilldesc.extensionCreator':
    'Create, test, and customize HopCode extensions',
...
const ZH: Messages = {
  ...
  'help.intro':
    'HopCode 可以理解代码库，在你的许可下修改文件，并直接执行命令。',
  ...
  'settings.description.ui.enableUserFeedback':
    '对话结束后显示可选反馈对话框，帮助改进 HopCode 表现。',
  ...
  'settings.description.context.fileFiltering.respectGitIgnore':
    '搜索时遵守 .gitignore 文件。',
  'settings.label.context.fileFiltering.respecthopcodeignore':
    '遵守 .hopcodeignore',
  'settings.description.context.fileFiltering.respecthopcodeignore':
