...
name: hopcode-viz
description: >
  Generate renderable chart outputs for clients that support the HopCode Web
...
# HopCode Visualization Skill

Use this skill to emit chart blocks that a HopCode Web Shell host can render.
...
- The active host is HopCode Web Shell, or an equivalent Web Shell client.
