...
import type { ChannelAgentBridge, ChannelBaseOptions, ChannelConfig, ChannelTaskLifecycleEvent, Envelope, SessionTarget } from '@hoptrendy/channel-base';
