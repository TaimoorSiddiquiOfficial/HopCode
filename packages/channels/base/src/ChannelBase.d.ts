import type { ChannelConfig, ChannelMemoryCallbacks, ChannelMemoryIntentClassifier, ChannelRuntimeIdentity, ChannelRuntimeMemoryScope, ChannelTaskLifecycleEvent, Envelope, ObservedChannelContactObservation, SessionTarget } from './types.js';
...
export declare abstract class ChannelBase {
    ...
    protected sendResponseMessage(chatId: string, text: string, _sessionId: string): Promise<void>;
    /**
