...
export declare const CLIENT_MCP_MESSAGE_METHOD = "hopcode/control/client_mcp/message";
export declare const WORKSPACE_MCP_RUNTIME_ADD_METHOD = "hopcode/control/workspace/mcp/runtime-add";
