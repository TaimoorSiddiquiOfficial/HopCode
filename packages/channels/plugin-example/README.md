...
Add a channel entry to `~/.hopcode/settings.json`:
...
```bash
HTTP_PORT=8080 WS_PORT=8081 npx hopcode-channel-plugin-example-server
```
...
```bash
hopcode channel start my-plugin-test
```
...
4. Add a `hopcode-extension.json` manifest
