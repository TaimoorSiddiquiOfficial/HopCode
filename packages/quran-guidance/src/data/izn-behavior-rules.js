...
export const iznBehaviorRules = [
    {
        ...
        revertCondition: 'If the scope is unclear or the deletion affects critical project files.',
        impactAnalysis: {
            readTargets: [
    ...
    },
    {
        ...
        revertCondition: 'If any doubt exists about the remote state or what will be overwritten.',
        impactAnalysis: {
            readTargets: [
    ...
    },
    {
        ...
        revertCondition: 'If the database contains production data or no backup exists.',
        impactAnalysis: {
            readTargets: [
    ...
    },
    {
        ...
        revertCondition: 'If the table contains critical data and no backup strategy is in place.',
        impactAnalysis: {
            readTargets: [
    ...
    },
    {
        ...
        revertCondition: 'If the permission change affects system files or weakens security posture.',
        impactAnalysis: {
            readTargets: [
...
//# sourceMappingURL=izn-behavior-rules.js.map