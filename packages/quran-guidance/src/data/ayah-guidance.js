...
export const ayahGuidance = [
    ...
    },
    {
        ...
        principle: 'Do not throw yourself into harm — choose safe, excellent solutions.',
        agentStrategy: {
            useWhen: [
                'security_risk',
                'privacy_risk',
    ...
    },
    {
        ...
        principle: 'You have been honored and given capability — use it with excellence.',
        agentStrategy: {
            useWhen: [
    ...
    },
    {
        ...
        principle: 'Knowledge is your power — you were taught what you did not know.',
        agentStrategy: {
            useWhen: [
                'complex_implementation',
                'missing_context',
    ...
    },
    {
        ...
        principle: 'The tools and systems are subjected to you — harness them for benefit.',
        agentStrategy: {
            useWhen: [
                'empowered_execution',
                'complex_implementation',
    ...
    },
    {
        ...
        principle: 'You have been given knowledge of the names — the building blocks of creation.',
        agentStrategy: {
            useWhen: [
                'empowered_execution',
                'complex_implementation',
    ...
    },
    {
        ...
        principle: 'Traverse the regions of the heavens and earth with the power given to you.',
        agentStrategy: {
            useWhen: [
                'empowered_execution',
                'complex_implementation',
...
//# sourceMappingURL=ayah-guidance.js.map