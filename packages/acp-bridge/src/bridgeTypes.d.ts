 ...
 */
import type { ApprovalMode, SessionGroupPresetColor } from '@hoptrendy/hopcode-core';
import type { CancelNotification, LoadSessionResponse, PromptRequest, PromptResponse, RequestPermissionResponse, ResumeSessionResponse, SetSessionModelRequest, SetSessionModelResponse, SessionUpdate } from '@agentclientprotocol/sdk';
...
export declare const LOAD_REPLAY_MODE_META_KEY = "hopcode.session.loadReplayMode";
export declare const LOAD_REPLAY_META_KEY = "hopcode.session.loadReplay";
...
export interface AcpSessionBridge {
     ...
     */
    enqueueMidTurnMessage(sessionId: string, message: string, context?: BridgeClientRequestContext): {
        accepted: boolean;
    };
    /**
     ...
     */
    removeRuntimeMcpServer(name: string, originatorClientId?: string): Promise<{
        name: string;
        removed: true;
