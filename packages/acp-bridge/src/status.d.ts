 ...
 */
export declare const SERVE_ERROR_KINDS: readonly ["missing_binary", "blocked_egress", "auth_env_error", "init_timeout", "protocol_error", "missing_file", "parse_error", "stat_failed", "budget_exhausted", "mcp_budget_would_exceed", "mcp_server_spawn_failed", "invalid_config", "prompt_deadline_exceeded", "writer_idle_timeout"];
...
export declare const SERVE_STATUS_EXT_METHODS: {
    ...
    readonly workspaceResource: "hopcode/status/workspace/resource";
};
/**
