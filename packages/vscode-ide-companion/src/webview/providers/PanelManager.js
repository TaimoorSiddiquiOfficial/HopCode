...
export class PanelManager {
    ...
    async createPanel() {
        ...
        // First, check if there's an existing HopCode group
        ...
        if (existingGroup) {
            ...
            this.panel = vscode.window.createWebviewPanel('HopCode.chat', 'HopCode', { viewColumn: existingGroup.viewColumn, preserveFocus: false }, {
                enableScripts: true,
            ...
            // If no existing HopCode group, create a new group to the right of the active editor group
            try {
                ...
                this.panel = vscode.window.createWebviewPanel('HopCode.chat', 'HopCode', { viewColumn: activeColumn, preserveFocus: false }, {
                    enableScripts: true,
                    retainContextWhenHidden: true,
                    localResourceRoots: getLocalResourceRoots(this.extensionUri, vscode.workspace.workspaceFolders),
                });
            ...
            this.panel = vscode.window.createWebviewPanel('HopCode.chat', 'HopCode', { viewColumn: newGroupColumn, preserveFocus: false }, {
                enableScripts: true,
                retainContextWhenHidden: true,
                localResourceRoots: getLocalResourceRoots(this.extensionUri, vscode.workspace.workspaceFolders),
            });
    ...
    /**
     * Find the group and view column where the existing HopCode webview is located
     * @returns The found group and view column, or undefined if not found
     */
    findExistingHopCodeGroup() {
