...
export declare function resolveHopCodeCliEntryPath(extensionUri: vscode.Uri, extensionMode: vscode.ExtensionMode | undefined): string;
export declare class WebViewProvider {
     ...
     */
    private syncVSCodeSettingsToHopCodeConfig;
    /**
     ...
     */
    private syncHopCodeConfigToVSCodeSettings;
    /**
