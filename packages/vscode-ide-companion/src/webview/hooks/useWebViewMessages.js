    ...
    const handleMessage = useCallback((event) => {
        ...
        switch (message.type) {
            ...
            case 'hopcodeSessionList': {
                ...
                handlers.sessionManagement.setHopCodeSessions((prev) => append ? [...prev, ...sessions] : sessions);
            ...
            case 'sessionDeleted': {
                ...
                if (deletedId) {
                    handlers.sessionManagement.setHopCodeSessions((prev) => prev.filter((s) => s.sessionId !== deletedId && s.id !== deletedId));
                }
                break;
            }
            case 'sessionRenamed': {
                ...
                if (renamedId && newTitle) {
                    handlers.sessionManagement.setHopCodeSessions((prev) => prev.map((s) => s.sessionId === renamedId || s.id === renamedId
