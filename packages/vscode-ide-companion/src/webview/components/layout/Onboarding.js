...
export const Onboarding = () => (_jsxs("div", { className: "flex flex-col flex-1 min-h-0 px-6", style: {
        ...
        textAlign: 'center',
    }, children: [_jsxs("div", { className: "flex flex-col items-center gap-3 mb-6", children: [_jsx("img", { src: iconUrl, alt: "HopCode", className: "w-12 h-12 object-contain" }), _jsxs("div", { className: "text-center", children: [_jsx("h1", { className: "text-base font-semibold", style: { color: 'var(--app-primary-foreground)' }, children: "HopCode" }), _jsx("p", { className: "text-xs mt-1", style: { color: 'var(--app-secondary-foreground)' }, children: "AI-powered coding assistant for your editor" })] })] }), _jsxs("div", { className: "w-full max-w-[300px] rounded-lg border p-4", style: {
