 ...
 */
import { type ProviderInstallPlan } from '@hoptrendy/hopcode-core';
/**
...
/**
 * Apply a ProviderInstallPlan to ~/.hopcode/settings.json.
 ...
 */
export declare function readHopCodeSettingsForVSCode(): HopcodeSettingsForVSCode | null;
/**
