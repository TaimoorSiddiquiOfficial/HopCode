...
export declare class AcpConnectionDisconnectError extends Error {
    constructor(message: string);
}
export declare function isAcpConnectionDisconnectError(error: unknown): error is AcpConnectionDisconnectError;
/**
