...
export class HopCodeSessionUpdateHandler {
    ...
    handleSessionUpdate(data) {
        ...
        switch (sessionUpdate) {
            ...
            case 'agent_message_chunk': {
                ...
                // both carry hopcodeDiscreteMessage. Persist only the original here so the
                // notification is not stored twice; the rewritten copy falls through to
                // onStreamChunk like any other streamed text.
                const isDiscreteMessage = (meta?.hopcodeDiscreteMessage === true ||
    ...
    emitUsageMeta(meta) {
        ...
        if (Array.isArray(meta.availableSkills) &&
...
//# sourceMappingURL=hopcodeSessionUpdateHandler.js.map