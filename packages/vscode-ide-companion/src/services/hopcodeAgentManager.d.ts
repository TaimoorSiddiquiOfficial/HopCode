...
import { type HopCodeConnectionResult } from '../services/hopcodeConnectionHandler.js';
...
export declare class HopCodeAgentManager {
    private connection;
     ...
     */
    connect(workingDir: string, cliEntryPath: string, options?: AgentConnectOptions): Promise<HopCodeConnectionResult>;
    /**
