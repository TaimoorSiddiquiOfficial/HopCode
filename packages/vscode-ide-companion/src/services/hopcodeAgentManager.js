...
import { HopCodeSessionReader, } from './hopcodeSessionReader.js';
import { HopCodeSessionManager } from './hopcodeSessionManager.js';
import { SessionService } from '@hoptrendy/hopcode-core';
import { HopCodeConnectionHandler, } from '../services/hopcodeConnectionHandler.js';
...
export class HopCodeAgentManager {
    ...
    async deleteSession(sessionId) {
        ...
        try {
            ...
            console.warn('[HopCodeAgentManager] SessionService deleteSession failed:', error);
        }
        return ((await this.sessionReader.deleteSession(sessionId, this.currentWorkingDir)) ||
            (await this.sessionManager.deleteSession(sessionId, this.currentWorkingDir)));
    }
    async renameSession(sessionId, title) {
        try {
            if (this.connection.isConnected) {
        ...
        try {
            ...
            console.warn('[HopCodeAgentManager] SessionService renameSession failed:', error);
            return false;
        }
    }
    /**
...
//# sourceMappingURL=hopcodeAgentManager.js.map