...
import { CloseDiffRequestSchema, detectIdeFromEnv, IdeContextNotificationSchema, OpenDiffRequestSchema, } from '@hoptrendy/hopcode-core';
...
const createMcpServer = (diffManager) => {
    const server = new McpServer({
        name: 'hopcode-companion-mcp-server',
        version: '1.0.0',
