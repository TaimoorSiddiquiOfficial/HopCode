...
/**
 * Copy the already-built root dist/ folder into the extension dist/hopcode-cli/.
 *
...
const bundledCliDir = path.join(extensionDistDir, 'hopcode-cli');
