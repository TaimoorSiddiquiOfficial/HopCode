...
function findSdkPackageRoot() {
    try {
        ...
        const packageJsonPath = require.resolve('@hoptrendy/sdk/package.json');
        ...
        if (fs.existsSync(packageJsonPath)) {
            ...
            if (fs.existsSync(cliPath)) {
                try {
                    ...
                    if (packageJson.name === '@hoptrendy/sdk') {
                        return dir;
                    }
                    if (!bestMatch) {
                        bestMatch = dir;
...
export function findBundledCliPath() {
    ...
    const candidates = getBundledCliCandidatePaths();
    throw new Error('Bundled hopcode CLI not found. The CLI should be included in the SDK package.\n' +
        'Searched locations:\n' +
