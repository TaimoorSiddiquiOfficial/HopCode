 ...
 */
export declare const DAEMON_ERROR_KINDS: readonly ["missing_binary", "blocked_egress", "auth_env_error", "init_timeout", "protocol_error", "missing_file", "parse_error", "budget_exhausted", "mcp_budget_would_exceed", "mcp_server_spawn_failed", "invalid_config", "prompt_deadline_exceeded", "writer_idle_timeout", "model_stream_interrupted"];
 ...
 * advertised sequence.
 */
export declare const DAEMON_APPROVAL_MODES: readonly ["plan", "default", "auto-edit", "auto", "izn"];
...
export type DaemonExtensionOriginSource = 'HopCode' | 'Claude' | 'Gemini';
