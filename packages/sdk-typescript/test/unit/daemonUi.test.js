...
describe('daemon UI normalizer — Wave 3/4 event coverage (PR-A)', () => {
    ...
    it('normalizes github_setup_completed', () => {
        const events = normalizeDaemonEvent(envelopeOf('github_setup_completed', {
            releaseTag: 'v1.2.3',
            readmeUrl: 'https://github.com/QwenLM/hopcode-action/blob/v1.2.3/README.md#quick-start',
            workflows: [
                {
...
describe('daemon UI reducer state machine (PR-E)', () => {
    ...
    it('mirrors approval mode from session.approval_mode.changed event', async () => {
        ...
        expect(selectApprovalMode(state)).toBe('izn');
    });
