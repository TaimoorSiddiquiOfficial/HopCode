...
| `authType`               | `'openai' \| 'qwen-oauth'`                     | `'openai'`       | Authentication type for the AI service. hopcode OAuth free tier was discontinued on 2026-04-15; new SDK setups should use OpenAI-compatible authentication or another supported provider.                                                                                                                                                                                                                                                                                                |
...
running `hopcode serve` daemon over HTTP + SSE. It binds one daemon session so TUI,
...
4. `permissionMode: 'izn'` - Auto-approves all tools
