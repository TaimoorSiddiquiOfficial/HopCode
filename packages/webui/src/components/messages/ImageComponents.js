...
export const ImageMessageRenderer = ({ msg, imageIndex, }) => {
    ...
    return (_jsx("div", { className: "hopcode-message user-message-container flex gap-0 my-1 items-start text-left flex-col relative", children: _jsxs("div", { className: "inline-block relative whitespace-pre-wrap rounded-md max-w-full overflow-x-auto overflow-y-hidden select-text leading-[1.5]", style: {
