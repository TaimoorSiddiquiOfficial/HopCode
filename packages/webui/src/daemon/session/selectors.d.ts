 ...
 */
import type { DaemonToolTranscriptBlock, DaemonTranscriptBlock } from '@hoptrendy/sdk/daemon';
...
export declare function parseDaemonTodoItemsFromEntries(entries: readonly unknown[]): DaemonTodoItem[] | undefined;
