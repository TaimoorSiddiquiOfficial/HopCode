...
export declare function useDaemonUsageDashboard(options?: DaemonUsageDashboardOptions): {
    dashboard: import("@hoptrendy/sdk/daemon").DaemonUsageDashboard | undefined;
    reload: () => Promise<import("@hoptrendy/sdk/daemon").DaemonUsageDashboard | undefined>;
    data: import("@hoptrendy/sdk/daemon").DaemonUsageDashboard | undefined;
    loading: boolean;
