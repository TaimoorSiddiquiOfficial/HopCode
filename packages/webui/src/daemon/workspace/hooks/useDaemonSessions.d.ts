 ...
 */
import type { DaemonSessionArchiveState, DaemonSessionExportFormat } from '@hoptrendy/sdk/daemon';
...
export declare function useDaemonSessions(options?: DaemonSessionsOptions): {
    data: import("@hoptrendy/sdk/daemon").DaemonSessionSummary[] | undefined;
    reload: () => Promise<import("@hoptrendy/sdk/daemon").DaemonSessionSummary[] | undefined>;
    sessions: import("@hoptrendy/sdk/daemon").DaemonSessionSummary[];
    ...
    exportSession: (sessionId: string, format?: DaemonSessionExportFormat) => Promise<import("@hoptrendy/sdk/daemon").DaemonSessionExportResult>;
