...
DaemonPromptImage, 
/** Permission approval level: `'plan' | 'default' | 'auto-edit' | 'auto' | 'izn'`. */
...
DaemonWorkspaceProvidersStatus, DaemonWorkspaceProviderStatus, DaemonWorkspaceProviderModel, 
...
DaemonTranscriptStore, } from '@hoptrendy/sdk/daemon';
