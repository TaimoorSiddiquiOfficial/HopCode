...
export function computeWindowTitle(folderName) {
    return sanitizeWindowTitle(process.env['CLI_TITLE'] || `HopCode - ${folderName || DEFAULT_WINDOW_TITLE}`);
}
/**
 ...
 */
export function formatSessionWindowTitle(sessionName, folderName) {
    return sessionName
