...
import { Storage, FILE_HISTORY_DIR, createDebugLogger, } from '@hoptrendy/hopcode-core';
...
async function sweepOldSessionDirs(_root, opts) {
...
export async function cleanupOldFileHistoryBackups(opts) {
    return sweepOldSessionDirs(join(Storage.getGlobalHopCodeDir(), FILE_HISTORY_DIR), opts);
}
