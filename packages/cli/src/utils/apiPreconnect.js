 ...
 */
import { createDebugLogger, detectRuntime, getAllProviderBaseUrls, getOrCreateSharedDispatcher, redactProxyCredentials, } from '@hoptrendy/hopcode-core';
...
export function preconnectApi(authType, options = {}) {
    ...
    // Check if disabled
    if (process.env['HOPCODE_DISABLE_PRECONNECT'] === '1' ||
