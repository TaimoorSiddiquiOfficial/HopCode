...
describe('handleAutoUpdate', () => {
    ...
    it('should show manual update message when enableAutoUpdate is false', () => {
        // When enableAutoUpdate is false, interactive.tsx won't call checkForUpdates(),
        ...
        mockGetInstallationInfo.mockReturnValue({
            ...
            updateMessage: 'Please run npm i -g @hoptrendy/hopcode@latest to update',
            isGlobal: true,
    ...
    it('should emit "update-success" when the update process succeeds', async () => {
        ...
        expect(emitSpy).toHaveBeenCalledWith('update-success', {
            message: 'Update successful! Please restart HopCode to use the new version. ' +
...
describe('handleAutoUpdate — standalone path', () => {
    ...
    it('calls performStandaloneUpdate and does NOT spawn npm', async () => {
        ...
        expect(mockPerformStandaloneUpdate).toHaveBeenCalledWith('/home/user/.local/lib/hopcode', '2.0.0');
        expect(mockSpawn).not.toHaveBeenCalled();
    });
...
describe('setUpdateHandler', () => {
    ...
    it('should use default success message when update-success has no message', () => {
        ...
        expect(addItem).toHaveBeenCalledWith({
            type: MessageType.INFO,
            text: 'Update successful! Please restart HopCode to use the new version. ' +
                'Switching model providers before restarting may not work correctly.',
        }, expect.any(Number));
        cleanup();
    });
