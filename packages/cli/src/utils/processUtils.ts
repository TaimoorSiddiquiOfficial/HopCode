...
export const SKIP_UPDATE_CHECK_ENV_VAR = 'HOPCODE_CODE_SKIP_UPDATE_CHECK_ONCE';

export const CUSTOM_SANDBOX_IMAGE_ENV_VAR = 'HOPCODE_CODE_CUSTOM_SANDBOX_IMAGE';

export const HOST_UPDATE_RELAUNCH_ENV_VAR = 'HOPCODE_CODE_HOST_UPDATE_RELAUNCH';

export const UPDATE_ON_EXIT_MESSAGE = 'hopcode:update-on-exit';
