...
export const HEADLESS_IZN_NO_SANDBOX_WARNING = 'Warning: running headless with --izn / approval-mode=izn and no sandbox. ' +
 ...
 */
export function getHeadlessIznSafetyWarning(config, env = process.env) {
    ...
    if (env['SANDBOX'])
        return null;
    if (isTruthyEnv(env['HOPCODE_CODE_SUPPRESS_IZN_WARNING']))
        return null;
