...
export declare const SKIP_UPDATE_CHECK_ENV_VAR = "HOPCODE_CODE_SKIP_UPDATE_CHECK_ONCE";
export declare const CUSTOM_SANDBOX_IMAGE_ENV_VAR = "HOPCODE_CODE_CUSTOM_SANDBOX_IMAGE";
export declare const HOST_UPDATE_RELAUNCH_ENV_VAR = "HOPCODE_CODE_HOST_UPDATE_RELAUNCH";
