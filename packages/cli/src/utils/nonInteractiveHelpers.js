 ...
 */
import { ApprovalMode, OutputFormat, ToolErrorType, createDebugLogger, getArenaSystemReminder, getMCPServerStatus, getPlanModeSystemReminder, isShellProgressData, } from '@hoptrendy/hopcode-core';
...
export async function buildSystemMessage(config, sessionId, permissionMode) {
    ...
    const systemMessage = {
        ...
        HOPCODE_version: config.getCliVersion() || 'unknown',
        agents: agentNames,
    };
