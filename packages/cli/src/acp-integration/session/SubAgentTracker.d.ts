 ...
 */
import type { AgentEventEmitter } from '@hoptrendy/hopcode-core';
...
export declare class SubAgentTracker {
    ...
    constructor(ctx: SessionContext, client: AgentSideConnection, parentToolCallId: string, subagentType: string, onPermissionCancel?: (() => void) | undefined);
    /**
