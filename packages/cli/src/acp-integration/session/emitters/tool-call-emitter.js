...
import { formatVisionBridgeNoticeDisplay, isVisionBridgeNoticeDisplay, ToolNames, Kind, } from '@hoptrendy/hopcode-core';
import { createTranscriptToolCallResultUpdate, createTranscriptToolCallStartUpdate, } from '@hoptrendy/acp-bridge/transcriptReplay';
...
const KIND_MAP = {
    ...
    // and session/request_permission from the `hopcode --acp` child before fanning out
...
export class ToolCallEmitter extends BaseEmitter {
     ...
     *     `@hoptrendy/hopcode-core` package — mirrors the SDK's same
