 ...
 */
import type { Config, ServerGeminiStreamEvent, ToolCallRequestInfo, ToolCallResponseInfo } from '@hoptrendy/hopcode-core';
 ...
 *
 * Usage:
 *   hopcode --json-fd 3        # JSON events written to fd 3
 *   hopcode --json-file /path  # JSON events written to file/FIFO
 */
