 ...
 */
import { AuthType, InputFormat, isDebugLogFileEnabled, isDebugLoggingDegraded, isBareMode, logUserPrompt, HOPCODE_SIMPLE_ENV_VAR, Storage, SessionService, setStartupEventSink, createDebugLogger, persistSessionUsage, uiTelemetryService, } from '@hoptrendy/hopcode-core';
...
export async function main() {
    ...
    if (!process.env['SANDBOX']) {
        ...
        const onUpdateRelaunch = async () => {
            ...
            const shouldRelaunch = await updateBeforeRelaunch(settings, updateProjectRoot);
