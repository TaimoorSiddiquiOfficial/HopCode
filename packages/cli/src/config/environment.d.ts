...
export declare const SETTINGS_DIRECTORY_NAME = ".hopcode";
 ...
 */
export declare function findEnvFiles(settings: Settings, startDir: string, userLevelPaths?: Set<string>): string[];
...
export declare function buildRuntimeEnvironment(settings: Settings, startDir?: string, baseEnv?: Readonly<NodeJS.ProcessEnv>): RuntimeEnvironmentSnapshot;
/**
 ...
 */
export declare function reloadEnvironment(settings: Settings, workspaceCwd: string): EnvReloadResult;
