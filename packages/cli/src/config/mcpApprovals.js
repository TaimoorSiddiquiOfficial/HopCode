...
import { getErrorMessage, hashMcpServerConfig, isGatedMcpScope, Storage, atomicWriteFile, } from '@hoptrendy/hopcode-core';
 ...
 * project `.mcp.json` and workspace `.hopcode/settings.json` (see
