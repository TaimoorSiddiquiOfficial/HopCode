  ...
  general: {
    ...
    properties: {
      ...
      gitCoAuthor: {
        ...
        default: true,
        description:
          'Automatically add a Co-authored-by trailer to git commit messages when commits are made through HopCode.',
        showInDialog: true,
      },
      checkpointing: {
        type: 'object',
    ...
    properties: {
      ...
      runtimeOutputDir: {
        ...
        description:
          ...
          'Config files remain at ~/.hopcode. Env var QWEN_RUNTIME_DIR takes priority.',
        showInDialog: false,
      },
      tavilyApiKey: {
        type: 'string',
