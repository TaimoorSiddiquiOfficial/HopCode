...
import { DEFAULT_HOPCODE_CUSTOM_IGNORE_FILE_NAMES, DEFAULT_SENSITIVE_SPAN_ATTRIBUTE_MAX_LENGTH, SENSITIVE_SPAN_ATTRIBUTE_MAX_LENGTH_LIMIT, } from '@hoptrendy/hopcode-core';
...
describe('SettingsSchema', () => {
    describe('getSettingsSchema', () => {
        ...
        it('should have fileFiltering nested properties', () => {
            ...
            expect(getSettingsSchema().context.properties.fileFiltering.properties
                ?.respectHopcodeIgnore).toBeDefined();
            expect(getSettingsSchema().context.properties.fileFiltering.properties
                ?.customIgnoreFiles).toBeDefined();
            expect(getSettingsSchema().context.properties.fileFiltering.properties
                ?.customIgnoreFiles?.type).toBe('array');
            expect(getSettingsSchema().context.properties.fileFiltering.properties
                ?.customIgnoreFiles?.default).toEqual([...DEFAULT_HOPCODE_CUSTOM_IGNORE_FILE_NAMES]);
            expect(getSettingsSchema().context.properties.fileFiltering.properties
