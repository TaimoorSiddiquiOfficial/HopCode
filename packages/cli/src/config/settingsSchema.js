 ...
 */
import { ApprovalMode, DEFAULT_MAX_SUBAGENT_DEPTH, DEFAULT_MAX_TOOL_CALLS_PER_TURN, DEFAULT_SENSITIVE_SPAN_ATTRIBUTE_MAX_LENGTH, DEFAULT_HOPCODE_CUSTOM_IGNORE_FILE_NAMES, DEFAULT_STOP_HOOK_BLOCK_CAP, DEFAULT_TOOL_OUTPUT_BATCH_BUDGET, DEFAULT_TOOL_RESULTS_TOTAL_CHARS_THRESHOLD, DEFAULT_TRUNCATE_TOOL_OUTPUT_LINES, DEFAULT_TRUNCATE_TOOL_OUTPUT_THRESHOLD, SENSITIVE_SPAN_ATTRIBUTE_MAX_LENGTH_LIMIT, } from '@hoptrendy/hopcode-core';
...
const SETTINGS_SCHEMA = {
    ...
    providerProtocol: {
        ...
        requiresRestart: true,
        default: {},
        description: 'Maps a custom modelProviders provider id to the SDK protocol that routes its requests (e.g. {"idealab": "openai"}). Lets a custom provider id reuse a built-in protocol. Built-in provider ids (openai, gemini, anthropic, vertex-ai, hopcode-oauth) are routed automatically and need no entry.',
        showInDialog: false,
        mergeStrategy: MergeStrategy.REPLACE,
    },
    plansDirectory: {
        ...
        requiresRestart: true,
        default: undefined,
        description: 'Custom directory for approved Plan Mode files. Relative paths are resolved from the project root, and the resolved path must stay within the project root. Defaults to ~/.hopcode/plans.',
        showInDialog: false,
    },
    ...
    general: {
        ...
        properties: {
            ...
            cleanupPeriodDays: {
                ...
                default: 30,
                minimum: 0,
                description: 'Number of days to retain ~/.hopcode/file-history/ session backups used by /rewind. Backups older than this are removed by a background housekeeping pass that runs at most once per day. Set to 0 for minimum retention (~1 hour) — protects sessions touched in the last hour, plus the currently active session. Other persistent caches will honor the same setting in the future.',
                showInDialog: true,
            },
            gitCoAuthor: {
                type: 'object',
                ...
                description: 'Attribution added to git commits and pull requests created through HopCode.',
                showInDialog: false,
                ...
                properties: {
                    commit: {
                        ...
                        requiresRestart: false,
                        default: true,
                        description: 'Add a Co-authored-by trailer to git commit messages AND attach a per-file AI-attribution git note (`refs/notes/ai-attribution`) for commits made through HopCode. Disabling skips both.',
                        showInDialog: true,
                    },
                    pr: {
                        type: 'boolean',
                        ...
                        requiresRestart: false,
                        default: true,
                        description: 'Append a HopCode attribution line to PR descriptions when running `gh pr create`.',
                        showInDialog: true,
                    },
                },
            },
            ...
            preventSystemSleep: {
                ...
                requiresRestart: true,
                default: true,
                description: 'Prevent the system from sleeping while HopCode is streaming a model response or executing tools. Idle prompt time and permission prompts do not inhibit sleep.',
                showInDialog: true,
            },
            chatRecording: {
                type: 'boolean',
    ...
    ui: {
        ...
        properties: {
            ...
            showStatusInTitle: {
                ...
                requiresRestart: false,
                default: true,
                description: 'Show HopCode session name and status in the terminal window title',
                showInDialog: true,
            },
            hideTips: {
                type: 'boolean',
            ...
            enableUserFeedback: {
                ...
                requiresRestart: false,
                default: true,
                description: 'Show optional feedback dialog after conversations to help improve HopCode performance.',
                showInDialog: true,
            },
            ...
            customBannerTitle: {
                ...
                requiresRestart: false,
                default: '',
                description: 'Replace the default ">_ HopCode" title shown in the banner info panel. The version suffix is always appended.',
                showInDialog: false,
            },
            ...
            customAsciiArt: {
                ...
                requiresRestart: false,
                default: undefined,
                description: 'Replace the default HOPCODE ASCII art. Accepts an inline string, {"path": "..."}, or {"small": ..., "large": ...} for width-aware selection.',
                showInDialog: false,
    ...
    model: {
        ...
        properties: {
            ...
            skipWorkflowUsageWarning: {
                ...
                requiresRestart: false,
                default: false,
                description: 'Suppress the one-time Workflow tool usage banner that describes the HOPCODE_MAX_TOKENS_PER_WORKFLOW env knob. The banner fires at most once per session regardless of this setting.',
                showInDialog: false,
            },
            skipLoopDetection: {
                type: 'boolean',
            ...
            generationConfig: {
                ...
                properties: {
                    ...
                    toolResultContentFormat: {
                        ...
                        requiresRestart: false,
                        default: 'parts',
                        description: 'Controls how text-only tool results are serialized in OpenAI-compatible requests. Use "parts" for the default content-part array shape. Use "string" only for legacy OpenAI-compatible runtimes whose tool templates ignore text content parts (for example older GLM-5.1 vLLM/SGLang templates; hoptrendy/hopcode#3361). Tool-returned media is still handled by splitToolMedia.',
                        parentKey: 'generationConfig',
                        showInDialog: false,
                        options: [
                    ...
                    contextWindowSize: {
                        ...
                        requiresRestart: false,
                        default: undefined,
                        description: "Overrides the default context window size for the selected model. Use this setting when a provider's effective context limit differs from HopCode's default. This value defines the model's assumed maximum context capacity, not a per-request token limit.",
                        parentKey: 'generationConfig',
                        showInDialog: false,
                    },
                },
            ...
            fileFiltering: {
                ...
                properties: {
                    ...
                    customIgnoreFiles: {
                        ...
                        category: 'Context',
                        requiresRestart: true,
                        default: [...DEFAULT_HOPCODE_CUSTOM_IGNORE_FILE_NAMES],
                        description: 'Project-root-relative ignore files to use instead of the defaults (`.agentignore`, `.aiignore`) when respecthopcodeignore is enabled. .hopcodeignore is always included when respecthopcodeignore is enabled.',
                        showInDialog: false,
                        items: { type: 'string' },
                    },
    ...
    memory: {
        ...
        properties: {
            ...
            enableTeamMemory: {
                ...
                requiresRestart: false,
                default: false,
                description: 'Enable a project memory tier shared with collaborators via the git-tracked `.hopcode/team-memory/` directory. Off by default; writes to it are secret-scanned and reviewable in the git diff.',
                showInDialog: false,
            },
            enableTeamMemorySync: {
                ...
                requiresRestart: false,
                default: false,
                description: 'When team memory is enabled, automatically commit, fast-forward-pull, and push the `.hopcode/team-memory/` directory at session start so collaborators stay in sync. Off by default; requires a configured git upstream.',
                showInDialog: false,
            },
        },
    },
    ...
    tools: {
        ...
        properties: {
            ...
            sandboxImage: {
                ...
                requiresRestart: true,
                default: undefined,
                description: 'Sandbox image URI used by Docker/Podman when --sandbox-image and HOPCODE_SANDBOX_IMAGE are not set.',
                showInDialog: false,
            },
            toolSearch: {
                type: 'object',
            ...
            computerUse: {
                ...
                properties: {
                    ...
                    idleTimeoutMs: {
                        ...
                        minimum: 0,
                        maximum: 2147483647,
                        description: 'Milliseconds to keep the cua-driver process alive after the last computer_use__* call. The default is 300000 (5 minutes). Set to 0 to keep it running until hopcode exits.',
                        showInDialog: false,
                    },
                    maxImageDimension: {
                        type: 'number',
    ...
    mcp: {
        ...
        properties: {
            ...
            toolIdleTimeoutMs: {
                ...
                minimum: 10000,
                maximum: 3600000,
                description: 'Idle timeout in milliseconds for MCP tool calls. If the MCP server does not produce any response or progress update within this time, the call is aborted. Default: 300000 (5 minutes). Can be overridden via HOPCODE_CODE_MCP_TOOL_IDLE_TIMEOUT_MS environment variable.',
                showInDialog: false,
            },
        },
    },
            ...
            powershell: {
                ...
                properties: {
                    enabled: {
                        ...
                        requiresRestart: true,
                        default: false,
                        description: 'Master switch for PowerShell execution. When false, all PowerShell commands are blocked.',
                        showInDialog: false,
                    },
                    mode: {
                        type: 'string',
                        ...
                        requiresRestart: true,
                        default: 'ask',
                        description: 'Default behavior when a PowerShell command does not match the allowlist or blocklist.',
                        showInDialog: false,
                    },
                    allowlist: {
                        type: 'array',
                        ...
                        requiresRestart: true,
                        default: [],
                        description: 'Command patterns that are automatically allowed. Supports * wildcard matching.',
                        showInDialog: false,
                        items: {
                            type: 'string',
                    ...
                    blocklist: {
                        ...
                        requiresRestart: true,
                        default: [],
                        description: 'Command patterns that are always blocked. Supports * wildcard matching.',
                        showInDialog: false,
                        items: {
                            type: 'string',
                            description: 'Command pattern (supports * wildcard)',
            ...
            webSearch: {
                ...
                properties: {
                    default: {
                        ...
                        requiresRestart: true,
                        default: undefined,
                        description: 'The default web search provider to use (e.g., "duckduckgo", "tavily", "google").',
                        showInDialog: false,
                    },
                    mode: {
                        type: 'string',
                        ...
                        requiresRestart: true,
                        default: 'auto',
                        description: 'Provider selection mode: "auto" tries providers in priority order with failover, "manual" uses only the default provider.',
                        showInDialog: false,
                    },
                    provider: {
                        type: 'array',
                        ...
                        requiresRestart: true,
                        default: [],
                        description: 'List of configured web search providers with their credentials and options.',
                        showInDialog: false,
                        items: {
                            type: 'object',
            ...
            arena: {
                ...
                properties: {
                    worktreeBaseDir: {
                        ...
                        requiresRestart: true,
                        default: undefined,
                        description: 'Custom base directory for Arena worktrees. Defaults to ~/.hopcode/arena.',
                        showInDialog: false,
                    },
                    preserveArtifacts: {
                        type: 'boolean',
    ...
    stopHookBlockingCap: {
        ...
        description: 'Maximum consecutive blocking Stop/SubagentStop hook decisions before HopCode overrides the hook loop and ends the turn. Can be overridden by HOPCODE_STOP_HOOK_BLOCK_CAP.',
    ...
    experimental: {
        ...
        properties: {
            cron: {
                ...
                requiresRestart: true,
                default: true,
                description: 'Enable in-session cron/loop tools. When enabled, the model can create recurring prompts using cron_create, cron_list, and cron_delete tools. Can be disabled via HOPCODE_DISABLE_CRON=1 environment variable.',
                showInDialog: true,
            },
            todoStopGuard: {
                type: 'boolean',
            ...
            cronRecurringMaxAgeDays: {
                ...
                requiresRestart: true,
                default: 7,
                description: 'Days a recurring cron/loop job lives before auto-expiring (it fires one final time, then is deleted). Set to 0 to disable expiry so jobs run until deleted — useful for long-running daemon deployments. Can be overridden via the HOPCODE_CODE_CRON_MAX_AGE_DAYS environment variable.',
            ...
            agentTeam: {
                ...
                requiresRestart: true,
                default: false,
                description: 'Enable agent team collaboration tools (experimental). When enabled, the model can create agent teams and coordinate work using team_create, team_delete, send_message, task_create, task_update, and task_list tools. Can also be enabled via HOPCODE_ENABLE_AGENT_TEAM=1 environment variable.',
                showInDialog: true,
            },
            artifact: {
                type: 'boolean',
    ...
    artifact: {
        ...
        properties: {
            autoOpen: {
                ...
                requiresRestart: true,
                default: true,
                description: 'Open published artifacts in the browser automatically. Set to false to publish without launching a browser. HOPCODE_ARTIFACT_NO_AUTO_OPEN=1 overrides this setting.',
                showInDialog: false,
            },
            publisher: {
                type: 'enum',
