 ...
 */
import type { MCPServerConfig, BugCommandSettings, TelemetrySettings, OutboundCorrelationSettings, AuthType, ChatCompressionSettings, ModelProvidersConfig, ProviderProtocolConfig } from '@hoptrendy/hopcode-core';
...
declare const SETTINGS_SCHEMA: {
    ...
    readonly providerProtocol: {
        ...
        readonly description: "Maps a custom modelProviders provider id to the SDK protocol that routes its requests (e.g. {\"idealab\": \"openai\"}). Lets a custom provider id reuse a built-in protocol. Built-in provider ids (openai, gemini, anthropic, vertex-ai, hopcode-oauth) are routed automatically and need no entry.";
        readonly showInDialog: false;
        readonly mergeStrategy: MergeStrategy.REPLACE;
    };
    readonly plansDirectory: {
        ...
        readonly description: "Custom directory for approved Plan Mode files. Relative paths are resolved from the project root, and the resolved path must stay within the project root. Defaults to ~/.hopcode/plans.";
        readonly showInDialog: false;
    };
    readonly env: {
        readonly type: "object";
    ...
    readonly general: {
        ...
        readonly properties: {
            ...
            readonly cleanupPeriodDays: {
                ...
                readonly default: 30;
                readonly minimum: 0;
                readonly description: "Number of days to retain ~/.hopcode/file-history/ session backups used by /rewind. Backups older than this are removed by a background housekeeping pass that runs at most once per day. Set to 0 for minimum retention (~1 hour) — protects sessions touched in the last hour, plus the currently active session. Other persistent caches will honor the same setting in the future.";
                readonly showInDialog: true;
            };
            readonly gitCoAuthor: {
                ...
                readonly description: "Attribution added to git commits and pull requests created through HopCode.";
                readonly showInDialog: false;
                ...
                readonly properties: {
                    readonly commit: {
                        ...
                        readonly requiresRestart: false;
                        readonly default: true;
                        readonly description: "Add a Co-authored-by trailer to git commit messages AND attach a per-file AI-attribution git note (`refs/notes/ai-attribution`) for commits made through HopCode. Disabling skips both.";
                        readonly showInDialog: true;
                    };
                    readonly pr: {
                        readonly type: "boolean";
                        ...
                        readonly requiresRestart: false;
                        readonly default: true;
                        readonly description: "Append a HopCode attribution line to PR descriptions when running `gh pr create`.";
                        readonly showInDialog: true;
                    };
                };
            };
            ...
            readonly preventSystemSleep: {
                ...
                readonly requiresRestart: true;
                readonly default: true;
                readonly description: "Prevent the system from sleeping while HopCode is streaming a model response or executing tools. Idle prompt time and permission prompts do not inhibit sleep.";
                readonly showInDialog: true;
            };
    ...
    readonly ui: {
        ...
        readonly properties: {
            ...
            readonly showStatusInTitle: {
                ...
                readonly requiresRestart: false;
                readonly default: true;
                readonly description: "Show HopCode session name and status in the terminal window title";
                readonly showInDialog: true;
            };
            readonly hideTips: {
                readonly type: "boolean";
            ...
            readonly enableUserFeedback: {
                ...
                readonly requiresRestart: false;
                readonly default: true;
                readonly description: "Show optional feedback dialog after conversations to help improve HopCode performance.";
                readonly showInDialog: true;
            };
            ...
            readonly customBannerTitle: {
                ...
                readonly requiresRestart: false;
                readonly default: string;
                readonly description: "Replace the default \">_ HopCode\" title shown in the banner info panel. The version suffix is always appended.";
                readonly showInDialog: false;
            };
            ...
            readonly customAsciiArt: {
                ...
                readonly description: "Replace the default HOPCODE ASCII art. Accepts an inline string, {\"path\": \"...\"}, or {\"small\": ..., \"large\": ...} for width-aware selection.";
                readonly showInDialog: false;
    ...
    readonly outboundCorrelation: {
        ...
        readonly description: "SECURITY-RELEVANT. Controls what client-side correlation data hopcode writes into outbound LLM API requests (DashScope, OpenAI, Anthropic, etc.) — separate from `telemetry.*` which governs data flow into the operator's OWN OTLP collector. All values default to off. Opt in only when the LLM provider also reports into your OTel collector for cross-process trace stitching (e.g. ARMS Tracing + DashScope).";
        readonly showInDialog: false;
        readonly jsonSchemaOverride: {
            readonly type: "object";
            readonly properties: {
    ...
    readonly model: {
        ...
        readonly properties: {
            ...
            readonly skipWorkflowUsageWarning: {
                ...
                readonly requiresRestart: false;
                readonly default: false;
                readonly description: "Suppress the one-time Workflow tool usage banner that describes the HOPCODE_MAX_TOKENS_PER_WORKFLOW env knob. The banner fires at most once per session regardless of this setting.";
                readonly showInDialog: false;
            };
            ...
            readonly generationConfig: {
                ...
                readonly properties: {
                    ...
                    readonly toolResultContentFormat: {
                        ...
                        readonly description: "Controls how text-only tool results are serialized in OpenAI-compatible requests. Use \"parts\" for the default content-part array shape. Use \"string\" only for legacy OpenAI-compatible runtimes whose tool templates ignore text content parts (for example older GLM-5.1 vLLM/SGLang templates; hoptrendy/hopcode#3361). Tool-returned media is still handled by splitToolMedia.";
                        readonly parentKey: "generationConfig";
                        readonly showInDialog: false;
                        readonly options: readonly [{
                    ...
                    readonly contextWindowSize: {
                        ...
                        readonly description: "Overrides the default context window size for the selected model. Use this setting when a provider's effective context limit differs from HopCode's default. This value defines the model's assumed maximum context capacity, not a per-request token limit.";
                        readonly parentKey: "generationConfig";
                        readonly showInDialog: false;
                    };
                };
        ...
        readonly properties: {
            ...
            readonly clearContextOnIdle: {
                ...
                readonly properties: {
                    ...
                    readonly toolResultsTotalCharsThreshold: {
                        ...
                        readonly requiresRestart: false;
                        readonly default: number;
                        readonly description: "Total compactable tool result output characters allowed in history before clearing oldest results. Use -1 to disable. This is a soft threshold: protected recent tool results may keep the total above it.";
                        readonly showInDialog: false;
                    };
                };
            };
            readonly fileFiltering: {
                ...
                readonly properties: {
                    ...
                    readonly respectHopcodeIgnore: {
                        readonly type: "boolean";
                        readonly label: "Respect .hopcodeignore";
                        readonly category: "Context";
                        readonly requiresRestart: true;
                        readonly default: true;
                        readonly description: "Respect .hopcodeignore files when searching";
                        readonly showInDialog: true;
                    };
                    readonly customIgnoreFiles: {
                        ...
                        readonly requiresRestart: true;
                        readonly default: string[];
                        readonly description: "Project-root-relative ignore files to use instead of the defaults (`.agentignore`, `.aiignore`) when respecthopcodeignore is enabled. .hopcodeignore is always included when respecthopcodeignore is enabled.";
                        readonly showInDialog: false;
                        readonly items: {
                            readonly type: "string";
                        };
    ...
    readonly memory: {
        ...
        readonly properties: {
            ...
            readonly enableTeamMemory: {
                ...
                readonly requiresRestart: false;
                readonly default: false;
                readonly description: "Enable a project memory tier shared with collaborators via the git-tracked `.hopcode/team-memory/` directory. Off by default; writes to it are secret-scanned and reviewable in the git diff.";
                readonly showInDialog: false;
            };
            readonly enableTeamMemorySync: {
                ...
                readonly requiresRestart: false;
                readonly default: false;
                readonly description: "When team memory is enabled, automatically commit, fast-forward-pull, and push the `.hopcode/team-memory/` directory at session start so collaborators stay in sync. Off by default; requires a configured git upstream.";
                readonly showInDialog: false;
            };
        };
    };
    ...
    readonly tools: {
        ...
        readonly properties: {
            ...
            readonly sandboxImage: {
                ...
                readonly requiresRestart: true;
                readonly default: string | undefined;
                readonly description: "Sandbox image URI used by Docker/Podman when --sandbox-image and HOPCODE_SANDBOX_IMAGE are not set.";
                readonly showInDialog: false;
            };
            readonly toolSearch: {
                readonly type: "object";
            ...
            readonly approvalMode: {
                ...
                readonly options: readonly [{
                    ...
                    readonly value: ApprovalMode.IZN;
                    readonly label: "IZN";
                }];
            };
            readonly autoAccept: {
            ...
            readonly toolOutputBatchBudget: {
                ...
                readonly description: "Per-message budget (characters) for the combined output of one batch of tool calls; the largest results are offloaded to disk when exceeded. Set to -1 to disable.";
                readonly showInDialog: false;
            };
            readonly computerUse: {
                ...
                readonly requiresRestart: true;
                readonly default: {};
                readonly description: "Cross-platform desktop automation via the cua-driver native driver (trycua/cua). On first invocation a pinned, signed + notarized binary (~20MB) is downloaded into ~/.hopcode/computer-use/ and the user is walked through macOS Accessibility / Screen Recording permissions if needed. Exposes cua-driver's full tool surface (click, type_text, scroll, drag, press_key, get_window_state, page, launch_app, and more).";
                readonly showInDialog: false;
                readonly properties: {
                    readonly enabled: {
                        readonly type: "boolean";
                    ...
                    readonly idleTimeoutMs: {
                        ...
                        readonly minimum: 0;
                        readonly maximum: 2147483647;
                        readonly description: "Milliseconds to keep the cua-driver process alive after the last computer_use__* call. The default is 300000 (5 minutes). Set to 0 to keep it running until hopcode exits.";
                        readonly showInDialog: false;
                    };
    ...
    readonly mcp: {
        ...
        readonly properties: {
            ...
            readonly toolIdleTimeoutMs: {
                ...
                readonly description: "Idle timeout in milliseconds for MCP tool calls. If the MCP server does not produce any response or progress update within this time, the call is aborted. Default: 300000 (5 minutes). Can be overridden via HOPCODE_CODE_MCP_TOOL_IDLE_TIMEOUT_MS environment variable.";
                readonly showInDialog: false;
            };
        };
    };
    readonly security: {
        ...
        readonly properties: {
            ...
            readonly powershell: {
                readonly type: "object";
                readonly label: "PowerShell Security";
                readonly category: "Security";
                readonly requiresRestart: true;
                readonly default: {};
                readonly description: "PowerShell security policy settings.";
                readonly showInDialog: false;
                readonly properties: {
                    readonly enabled: {
                        readonly type: "boolean";
                        readonly label: "Enable PowerShell";
                        readonly category: "Security";
                        readonly requiresRestart: true;
                        readonly default: false;
                        readonly description: "Master switch for PowerShell execution. When false, all PowerShell commands are blocked.";
                        readonly showInDialog: false;
                    };
                    readonly mode: {
                        readonly type: "string";
                        readonly label: "PowerShell Mode";
                        readonly category: "Security";
                        readonly requiresRestart: true;
                        readonly default: "ask";
                        readonly description: "Default behavior when a PowerShell command does not match the allowlist or blocklist.";
                        readonly showInDialog: false;
                    };
                    readonly allowlist: {
                        readonly type: "array";
                        readonly label: "PowerShell Allowlist";
                        readonly category: "Security";
                        readonly requiresRestart: true;
                        readonly default: string[];
                        readonly description: "Command patterns that are automatically allowed. Supports * wildcard matching.";
                        readonly showInDialog: false;
                        readonly items: {
                            readonly type: "string";
                            readonly description: "Command pattern (supports * wildcard)";
                        };
                    };
                    readonly blocklist: {
                        readonly type: "array";
                        readonly label: "PowerShell Blocklist";
                        readonly category: "Security";
                        readonly requiresRestart: true;
                        readonly default: string[];
                        readonly description: "Command patterns that are always blocked. Supports * wildcard matching.";
                        readonly showInDialog: false;
                        readonly items: {
                            readonly type: "string";
                            readonly description: "Command pattern (supports * wildcard)";
    ...
    readonly advanced: {
        ...
        readonly properties: {
            readonly webSearch: {
                ...
                readonly requiresRestart: true;
                readonly default: {};
                readonly description: "Configuration for the web_search tool.";
                readonly showInDialog: false;
                readonly properties: {
                    readonly default: {
                        readonly type: "string";
                        readonly label: "Default Provider";
                        readonly category: "Advanced";
                        readonly requiresRestart: true;
                        readonly default: string | undefined;
                        readonly description: "The default web search provider to use (e.g., \"duckduckgo\", \"tavily\", \"google\").";
                        readonly showInDialog: false;
                    };
                    readonly mode: {
                        readonly type: "string";
                        readonly label: "Search Mode";
                        readonly category: "Advanced";
                        readonly requiresRestart: true;
                        readonly default: "auto";
                        readonly description: "Provider selection mode: \"auto\" tries providers in priority order with failover, \"manual\" uses only the default provider.";
                        readonly showInDialog: false;
                    };
                    readonly provider: {
                        readonly type: "array";
                        ...
                        readonly description: "List of configured web search providers with their credentials and options.";
                        readonly showInDialog: false;
                        readonly items: {
                            readonly type: "object";
                            readonly description: "Provider configuration object";
                        };
                    };
                };
            };
            ...
            readonly arena: {
                ...
                readonly properties: {
                    readonly worktreeBaseDir: {
                        ...
                        readonly requiresRestart: true;
                        readonly default: string | undefined;
                        readonly description: "Custom base directory for Arena worktrees. Defaults to ~/.hopcode/arena.";
                        readonly showInDialog: false;
                    };
    ...
    readonly stopHookBlockingCap: {
        ...
        readonly requiresRestart: true;
        readonly default: 8;
        readonly description: "Maximum consecutive blocking Stop/SubagentStop hook decisions before HopCode overrides the hook loop and ends the turn. Can be overridden by HOPCODE_STOP_HOOK_BLOCK_CAP.";
        readonly showInDialog: false;
        readonly jsonSchemaOverride: {
            readonly type: "integer";
            readonly minimum: 1;
    ...
    readonly experimental: {
        ...
        readonly properties: {
            readonly cron: {
                ...
                readonly requiresRestart: true;
                readonly default: true;
                readonly description: "Enable in-session cron/loop tools. When enabled, the model can create recurring prompts using cron_create, cron_list, and cron_delete tools. Can be disabled via HOPCODE_DISABLE_CRON=1 environment variable.";
                readonly showInDialog: true;
            };
            ...
            readonly cronRecurringMaxAgeDays: {
                ...
                readonly requiresRestart: true;
                readonly default: 7;
                readonly description: "Days a recurring cron/loop job lives before auto-expiring (it fires one final time, then is deleted). Set to 0 to disable expiry so jobs run until deleted — useful for long-running daemon deployments. Can be overridden via the HOPCODE_CODE_CRON_MAX_AGE_DAYS environment variable.";
                readonly showInDialog: false;
                readonly jsonSchemaOverride: {
                    readonly type: "number";
                    readonly minimum: 0;
            ...
            readonly agentTeam: {
                ...
                readonly requiresRestart: true;
                readonly default: false;
                readonly description: "Enable agent team collaboration tools (experimental). When enabled, the model can create agent teams and coordinate work using team_create, team_delete, send_message, task_create, task_update, and task_list tools. Can also be enabled via HOPCODE_ENABLE_AGENT_TEAM=1 environment variable.";
                readonly showInDialog: true;
            };
            readonly artifact: {
                readonly type: "boolean";
    ...
    readonly artifact: {
        ...
        readonly properties: {
            readonly autoOpen: {
                ...
                readonly requiresRestart: true;
                readonly default: true;
                readonly description: "Open published artifacts in the browser automatically. Set to false to publish without launching a browser. HOPCODE_ARTIFACT_NO_AUTO_OPEN=1 overrides this setting.";
                readonly showInDialog: false;
            };
            readonly publisher: {
                readonly type: "enum";
