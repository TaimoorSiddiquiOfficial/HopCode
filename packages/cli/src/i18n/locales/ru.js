...
export default {
  ...
  'block processing, erase original prompt, and show stderr to user only':
    '????????????? ?????????, ??????? ???????? ?????? ? ???????? stderr ?????? ????????????',
  'stdout shown to HopCode': 'stdout ??????? Qwen',
  ...
  'Example: /language output ???': '??????: /language output ???',
  'Example: /language output Português': '??????: /language output Português',
  ...
  'Note: Your existing API key in settings.json will not be cleared when using Qwen OAuth. You can switch back to OpenAI authentication later if needed.':
    '??????????: ??? ???????????? ???? API ? settings.json ?? ????? ?????? ??? ????????????? Qwen OAuth. ?? ?????? ????????????? ??????? ?? ??????????? OpenAI ????? ??? ?????????????.',
  ...
  'Configure authentication information with Qwen-OAuth or Alibaba Cloud Coding Plan':
    '????????? ?????????????? Qwen ????? Qwen-OAuth ??? Alibaba Cloud Coding Plan',
