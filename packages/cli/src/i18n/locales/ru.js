...
// Русский перевод для HopCode CLI
...
export default {
  ...
  'for help on HopCode': 'Справка по HopCode',
  ...
  'Analyzes the project and creates a tailored HOPCODE.md file.':
    'Анализ проекта и создание адаптированного файла HOPCODE.md',
  'List available HopCode tools. Usage: /tools [desc]':
    'Просмотр доступных инструментов HopCode. Использование: /tools [desc]',
  ...
  'Workspace is untrusted; workspace settings are ignored by the merged config. Run /trust first to persist skills changes here, or edit ~/.hopcode/settings.json directly to manage skills at user scope.':
    'Рабочая область не является доверенной; настройки рабочей области игнорируются объединённой конфигурацией. Сначала выполните /trust или отредактируйте ~/.hopcode/settings.json напрямую, чтобы управлять навыками на уровне пользователя.',
  ...
  'All available skills are disabled. Edit ~/.hopcode/settings.json or .hopcode/settings.json (skills.disabled) to re-enable.':
    'Все доступные навыки отключены. Отредактируйте ~/.hopcode/settings.json или .hopcode/settings.json (skills.disabled), чтобы снова их включить.',
  ...
  Bundled: 'Встроенный',
  'Available HopCode CLI tools:': 'Доступные инструменты HopCode CLI:',
  ...
  'Generate with HopCode (Recommended)':
    'Сгенерировать с помощью HopCode (Рекомендуется)',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with HopCode.':
    'Вы устанавливаете расширение от {{originSource}}. Некоторые функции могут работать не идеально с HopCode.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run HopCode in one of these supported IDEs: VS Code or VS Code forks.':
    'Интеграция с IDE не поддерживается в вашем окружении. Для использования этой функции запустите HopCode в одной из поддерживаемых IDE: VS Code или форках VS Code.',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage HopCode hooks': 'Управлять хуками HopCode',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask HopCode.':
    'Это меню только для чтения. Чтобы добавить или изменить хуки, отредактируйте settings.json напрямую или спросите HopCode.',
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask HopCode.':
    'Чтобы снова включить хуки, удалите "disableAllHooks" из settings.json или спросите HopCode.',
  // Hooks - Source
  Project: 'Проект',
  User: 'Пользователь',
  Skill: 'Навык',
  ...
  'Right before HopCode concludes its response':
    'Непосредственно перед завершением ответа HopCode',
  ...
  'Successfully added HOPCODE.md files from the following directories if there are:\n- {{directories}}':
    'Успешно добавлены файлы HOPCODE.md из следующих директорий (если они есть):\n- {{directories}}',
  ...
  "HopCode won't ask before using allowed tools.":
    'HopCode не будет спрашивать перед использованием разрешённых инструментов.',
  'HopCode will ask before using these tools.':
    'HopCode спросит перед использованием этих инструментов.',
  'HopCode is not allowed to use denied tools.':
    'HopCode не может использовать запрещённые инструменты.',
  ...
  'HopCode can read files in the workspace, and make edits when auto-accept edits is on.':
    'HopCode может читать файлы в рабочей области и вносить правки, когда автоприём правок включён.',
  'HopCode will be able to read files in this directory and make edits when auto-accept edits is on.':
    'HopCode сможет читать файлы в этом каталоге и вносить правки, когда автоприём правок включён.',
  ...
  'You can run any shell commands from HopCode using ! (e.g. !ls).':
    'Вы можете выполнять любые shell-команды в HopCode с помощью ! (например, !ls).',
  ...
  'You can resume a previous conversation by running hopcode --continue or hopcode --resume.':
    'Вы можете продолжить предыдущий разговор, запустив hopcode --continue или hopcode --resume.',
  ...
  'Add a HOPCODE.md file to give HopCode persistent project context.':
    'Добавьте файл HOPCODE.md, чтобы предоставить HopCode постоянный контекст проекта.',
  ...
  'Starting HopCode OAuth authentication...':
    'Запуск аутентификации HopCode OAuth...',
  'Successfully authenticated with HopCode OAuth.':
    'Успешная аутентификация через HopCode OAuth.',
  'Failed to authenticate with HopCode OAuth: {{error}}':
    'Ошибка аутентификации через HopCode OAuth: {{error}}',
  ...
  '  qwen auth hopcode-oauth     - Authenticate with HopCode OAuth (discontinued)':
    '  qwen auth hopcode-oauth     - Аутентификация через HopCode OAuth (прекращено)',
