...
export default {
  ...
  'toolDisplayName.TaskGet': '取得任務',
  'toolDisplayName.TaskUpdate': '更新任務',
  'toolDisplayName.TaskList': '任務列表',
  'toolDisplayName.TaskOutput': '任務輸出',
  'toolDisplayName.TaskReady': '任務就緒',
  ...
  'toolDisplayName.BgStop': '停止背景任務',
  'toolDisplayName.Browser': '瀏覽器',
  'toolDisplayName.RepoMap': '倉庫地圖',
  ...
  'Voice dictation is not supported on {{platform}}.':
    '語音聽寫不支援 {{platform}}。',
  'Voice dictation needs microphone access, which is unavailable in this WSL session. Use WSLg/PulseAudio, or run HopCode on a host with a microphone.':
    '語音聽寫需要麥克風存取，但目前 WSL 會話不可用。請使用 WSLg/PulseAudio，或在具備麥克風的主機上執行 HopCode。',
