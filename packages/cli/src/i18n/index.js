...
import { Storage, resolveBundleDir } from '@hoptrendy/hopcode-core';
...
const getUserLocalesDir = () => path.join(Storage.getGlobalHopCodeDir(), 'locales');
/**
...
export function resolveLanguageSetting(settingsLanguage) {
    return (process.env['HOPCODE_LANG'] || settingsLanguage || 'auto');
}
