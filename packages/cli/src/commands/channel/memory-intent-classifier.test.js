...
describe('BridgeChannelMemoryIntentClassifier', () => {
    it('uses an isolated bridge session and parses classifier JSON', async () => {
        ...
        expect(bridge.prompt).toHaveBeenCalledWith('classifier-session', expect.stringContaining('"你记一下以后回复前说 1122"'), {});
    ...
    it('logs cancelSession cleanup failures without dropping the result', async () => {
        ...
        expect(stderrSpy).toHaveBeenCalledWith('[classifier] cancelSession failed: transport closed\n');
