...
describe('startCommand.handler', () => {
    ...
    it('registers session cleanup on the replacement bridge before restoring sessions', async () => {
        ...
        try {
            ...
            expect(mockChannelConnect.mock.invocationCallOrder[1]).toBeLessThan(mockRouterRestoreSessions.mock.invocationCallOrder[0]);
