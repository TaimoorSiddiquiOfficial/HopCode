...
import { QWEN_DAEMON_TOKEN_ENV, HOPCODE_SERVER_TOKEN_ENV, } from '../../serve/channel-worker-env.js';
...
export const statusCommand = {
    ...
    handler: async (argv) => {
        ...
        const sessionsPath = path.join(Storage.getGlobalHopCodeDir(), 'channels', 'sessions.json');
