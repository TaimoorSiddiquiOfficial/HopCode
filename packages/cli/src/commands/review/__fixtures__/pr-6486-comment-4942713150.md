...
![toggle works](https://raw.githubusercontent.com/QwenLM/hopcode/pr-assets/pr-6486-model-toggle-verify/1-toggle-works.png)

**Shortcuts panel (`?`) renders the new binding:**
![shortcuts](https://raw.githubusercontent.com/QwenLM/hopcode/pr-assets/pr-6486-model-toggle-verify/3-shortcuts.png)
...
![dual-fire](https://raw.githubusercontent.com/QwenLM/hopcode/pr-assets/pr-6486-model-toggle-verify/2-dualfire.png)
