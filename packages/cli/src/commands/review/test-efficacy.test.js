...
import { isWorkspaceMember, planTestEfficacy, classifyProbeRun, safeRmWithin, probeCreateFailureDetail, probeCleanupFailureDetail, } from './test-efficacy.js';
...
describe('probeCreateFailureDetail', () => {
    ...
    it('names the add failure, and folds in the sweep stderr that explains it', () => {
        const got = probeCreateFailureDetail(new Error("fatal: '/w/wt-probe' already exists"), "fatal: '/w/wt-probe' is not a working tree\n");
    ...
    it('survives a non-Error throw', () => {
        expect(probeCreateFailureDetail('boom', '')).toBe('probe worktree could not be created: boom');
    });
});
