...
import { customProvider, generateCustomEnvKey, CUSTOM_API_KEY_ENV_PREFIX, } from './customProvider.js';
...
describe('generateCustomEnvKey', () => {
    it('produces a deterministic URL-based key', () => {
        ...
        expect(key1).toBe(`${CUSTOM_API_KEY_ENV_PREFIX}OPENAI_HTTPS_API_EXAMPLE_COM_V1`);
    });
