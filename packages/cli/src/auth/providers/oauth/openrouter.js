...
import { OPENROUTER_ENV_KEY, OPENROUTER_BASE_URL, getOpenRouterModelsWithFallback, selectRecommendedOpenRouterModels, getPreferredOpenRouterModelId, } from './openrouterOAuth.js';
...
export async function createOpenRouterProviderInstallPlan({ apiKey, models, }) {
