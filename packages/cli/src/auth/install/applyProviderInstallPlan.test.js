...
describe('applyProviderInstallPlan', () => {
    ...
    it('persists env, auth selection, selected model, and merged model providers', async () => {
        ...
        expect(settings.setValue).toHaveBeenCalledWith(SettingScope.User, 'env.TEST_API_KEY', 'sk-test');
        expect(process.env['TEST_API_KEY']).toBe('sk-test');
        expect(settings.setValue).toHaveBeenCalledWith(SettingScope.User, 'modelProviders.openai', [
        ...
        expect(settings.setValue).toHaveBeenCalledWith(SettingScope.User, 'security.auth.selectedType', AuthType.USE_OPENAI);
        expect(settings.setValue).toHaveBeenCalledWith(SettingScope.User, 'model.name', 'new-model');
        ...
        expect(config.getModelsConfig().syncAfterAuthRefresh).toHaveBeenCalledWith(AuthType.USE_OPENAI, 'new-model');
    ...
    it('writes provider state and legacy credentials', async () => {
        ...
        expect(settings.setValue).toHaveBeenCalledWith(SettingScope.User, 'security.auth.apiKey', 'legacy-key');
        expect(settings.setValue).toHaveBeenCalledWith(SettingScope.User, 'security.auth.baseUrl', 'https://example.com/v1');
        expect(settings.setValue).toHaveBeenCalledWith(SettingScope.User, 'codingPlan.baseUrl', 'https://coding.example.com/v1');
        expect(settings.setValue).toHaveBeenCalledWith(SettingScope.User, 'codingPlan.version', 'v1');
    });
...
//# sourceMappingURL=applyProviderInstallPlan.test.js.map