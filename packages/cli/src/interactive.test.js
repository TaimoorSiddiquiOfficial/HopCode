...
import { main, setupUnhandledRejectionHandler, validateDnsResolutionOrder, startInteractiveUI, } from './interactive.js';
...
describe('interactive.tsx main function', () => {
    ...
    afterEach(() => {
        ...
        if (originalEnvGeminiSandbox !== undefined) {
            process.env['HOPCODE_SANDBOX'] = originalEnvGeminiSandbox;
        }
        else {
            delete process.env['HOPCODE_SANDBOX'];
        }
