...
vi.mock('../i18n/index.js', () => ({
    ...
    resolveLanguageSetting: (settingsLang) => process.env['HOPCODE_LANG'] || settingsLang || 'auto',
}));
...
describe('initializeApp', () => {
    ...
    it('should initialize i18n with HOPCODE_LANG env var if set', async () => {
        vi.stubEnv('HOPCODE_LANG', 'zh');
        await initializeApp(mockConfig, mockSettings);
