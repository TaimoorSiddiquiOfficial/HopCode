...
import { MCP_COMMANDS, TOP_LEVEL_COMMANDS, handleCriticalError, isExpectedPtyRaceError, resolveBootstrapRoute, runCliEntry, runCliEntryPoint, } from './cli.js';
...
describe('bootstrap import boundaries', () => {
    it('keeps fast-path-only dependencies out of static imports', () => {
        ...
        expect(source).not.toContain("from '@hoptrendy/hopcode-core'");
    ...
    it('reloads the CLI through a stable shim after an update', () => {
        ...
        try {
            ...
            writeFileSync(path.join(wrongDir, 'hopcode'), '#!/bin/sh\necho wrong-launcher\n');
