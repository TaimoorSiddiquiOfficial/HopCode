 ...
 */
import { AuthType, InputFormat, isDebugLoggingDegraded, isBareMode, logUserPrompt, HOPCODE_SIMPLE_ENV_VAR, Storage, createDebugLogger, } from '@hoptrendy/hopcode-core';
...
export async function main() {
    ...
    // to run HopCode. It is now safe to perform expensive initialization that
