 ...
 */
import { createDebugLogger, buildSessionRecoveryPlanFromApiHistory, SendMessageType, TURN_INTERRUPTION_HISTORY_TAIL_COUNT, } from '@hoptrendy/hopcode-core';
...
class Session {
    ...
    async ensureConfigInitialized(options) {
        ...
        try {
            ...
            // `HOPCODE_CODE_PROFILE_STARTUP` is unset, so this adds zero overhead
