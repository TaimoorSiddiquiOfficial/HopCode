 ...
 */
import { InputFormat, ToolConfirmationOutcome, ToolNames, } from '@hoptrendy/hopcode-core';
    ...
    async handleOutgoingPermissionRequest(toolCall) {
        ...
        try {
            ...
            const response = await this.sendControlRequest({
                ...
                blocked_path: null,
            }, this.context.sdkCanUseToolTimeoutMs ?? DEFAULT_CAN_USE_TOOL_TIMEOUT_MS, this.context.abortSignal);
            if (response.subtype !== 'success') {
