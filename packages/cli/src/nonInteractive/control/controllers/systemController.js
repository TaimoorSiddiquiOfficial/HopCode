...
import { createDebugLogger, MCPServerConfig, AuthProviderType, normalizeReasoningEffort, loadUsageDashboard, } from '@hoptrendy/hopcode-core';
            ...
            if (normalized) {
                try {
                    ...
                    if (this.context.config.getReasoningEffort() !== normalized) {
                        debugLogger.warn(`[SystemController] Effort '${normalized}' was not applied (thinking may be disabled)`);
                    }
                    else {
