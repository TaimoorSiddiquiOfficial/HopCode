import type { ActiveGoal, SubagentConfig, McpToolProgressData, ShellProgressData } from '@hoptrendy/hopcode-core';
/**
...
export type PermissionMode = 'default' | 'plan' | 'auto-edit' | 'auto' | 'izn';
/**
