...
export declare function installWorkspaceSkill(workspace: string, request: WorkspaceSkillInstallRequest, githubToken?: string): Promise<WorkspaceSkillMutationResult>;
export declare function deleteWorkspaceSkill(workspace: string, scope: WorkspaceSkillScope, skillNameInput: string, installedPath: string): Promise<WorkspaceSkillMutationResult>;
