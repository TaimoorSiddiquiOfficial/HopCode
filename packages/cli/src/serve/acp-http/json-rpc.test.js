...
import { isNotification, isRequest, isResponse, parseInbound, HOPCODE_METHOD_NS, RPC, } from './json-rpc.js';
describe('json-rpc helpers', () => {
    ...
    it('exposes the hopcode extension namespace', () => {
        expect(HOPCODE_METHOD_NS).toBe('_hopcode/');
    });
});
