...
vi.mock('@hoptrendy/hopcode-core', () => {
    ...
    class Storage {
        ...
        static getGlobalHopCodeDir() {
            return process.env['HOPCODE_HOME'] ?? '/tmp/.hopcode';
        }
        static getGlobalSettingsPath() {
            return `${Storage.getGlobalHopCodeDir()}/settings.json`;
        }
        getWorkspaceSettingsPath() {
            return `${this.workspace}/.hopcode/settings.json`;
        }
    }
    class ModelsConfig {
    ...
    return {
        ...
        DEFAULT_HOPCODE_CUSTOM_IGNORE_FILE_NAMES: ['.agentignore', '.aiignore'],
        HOPCODE_DIR: '.hopcode',
        Storage,
        ModelsConfig,
...
import { WorkspacePermissionRulesSessionRequiredError, WorkspaceSkillNotFoundError, WorkspaceSettingsPartialPersistError, } from '../types.js';
// ---------------------------------------------------------------------------
// Helpers
// ---------------------------------------------------------------------------
...
describe('createDaemonWorkspaceService', () => {
    ...
    describe('setWorkspaceSkillEnabled', () => {
        ...
        it('uses the canonical skill name and refreshes every active session', async () => {
            ...
            expect(persistDisabledSkills).toHaveBeenCalledWith('/workspace', 'review', false);
            expect(invalidate).toHaveBeenCalledWith('/workspace');
            expect(invokeWorkspaceCommand).toHaveBeenCalledWith('qwen/control/workspace/skills/refresh', { cwd: '/workspace' });
