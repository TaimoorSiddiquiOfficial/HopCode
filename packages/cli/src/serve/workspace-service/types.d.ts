 ...
 * individual fields.
 */
import type { ServeWorkspaceMcpStatus, ServeWorkspaceSkillsStatus, ServeWorkspaceProvidersStatus, ServeWorkspaceExtensionsStatus, ServeWorkspaceHooksStatus, ServeWorkspaceEnvStatus, ServeWorkspacePreflightStatus, DaemonStatusProvider } from '@hoptrendy/acp-bridge';
...
export interface DaemonWorkspaceServiceDeps {
    ...
    persistDisabledSkills: (workspace: string, skillName: string, enabled: boolean) => Promise<PersistDisabledSkillResult>;
    persistSetting?: (workspace: string, scope: SettingScope, key: string, value: unknown) => Promise<void | LoadedSettings>;
    persistSettings?: (workspace: string, writes: WorkspaceSettingsWrite[]) => Promise<void>;
