...
const { createSubSessionLauncher, MAX_CONCURRENT_SUB_SESSIONS_PER_CALLER, MAX_CONCURRENT_SUB_SESSIONS_TOTAL, } = await import('./create-sub-session.js');
const chunk = (text) => ({
    type: 'session_update',
...
function makeFakeBridge(opts) {
    ...
    const bridge = {
        ...
        async *subscribeEvents(_sessionId, o) {
            subscribeCalls++;
