...
export interface ServeOptions {
     ...
     * forwards `HOPCODE_SERVE_MCP_CLIENT_BUDGET` to the child's env so
...
export interface CapabilitiesEnvelope {
    ...
    /**
     * HopCode CLI/SDK version served by this daemon. Optional because this is
     * additive to v=1; older v=1 daemons omit it.
     */
...
export declare const STAGE1_FEATURES: readonly ("capabilities" | "rate_limit" | "health" | "daemon_status" | "session_create" | "session_scope_override" | "session_load" | "session_resume" | "unstable_session_resume" | "session_list" | "session_info" | "session_source_metadata" | "session_prompt" | "session_cancel" | "session_events" | "session_artifacts" | "session_artifacts_persistence" | "slow_client_warning" | "typed_event_schema" | "session_set_model" | "client_identity" | "client_heartbeat" | "session_permission_vote" | "permission_vote" | "workspace_mcp" | "workspace_skills" | "workspace_providers" | "auth_provider_install" | "workspace_memory" | "workspace_memory_remember" | "workspace_memory_forget" | "workspace_memory_dream" | "workspace_agents" | "workspace_agent_generate" | "workspace_env" | "workspace_preflight" | "session_context" | "session_context_usage" | "session_supported_commands" | "session_tasks" | "session_stats" | "session_lsp" | "session_status" | "session_close" | "session_archive" | "session_metadata" | "session_organization" | "session_export" | "session_transcript" | "session_transcript_pagination" | "mcp_guardrails" | "workspace_mcp_manage" | "mcp_guardrail_events" | "mcp_server_runtime_mutation" | "workspace_file_read" | "workspace_file_bytes" | "workspace_file_write" | "session_approval_mode_control" | "workspace_tool_toggle" | "workspace_skill_toggle" | "workspace_skill_manage" | "workspace_settings" | "workspace_permissions" | "workspace_voice" | "workspace_voice_transcription" | "workspace_trust" | "workspace_init" | "workspace_github_setup" | "workspace_mcp_restart" | "session_recap" | "session_generation" | "session_btw" | "session_shell_command" | "mcp_workspace_pool" | "mcp_pool_restart" | "require_auth" | "allow_origin" | "auth_device_flow" | "permission_mediation" | "prompt_absolute_deadline" | "writer_idle_timeout" | "non_blocking_prompt" | "session_language" | "session_rewind" | "workspace_hooks" | "session_hooks" | "workspace_extensions" | "session_branch" | "workspace_reload" | "channel_reload" | "channel_control" | "workspace_channel_observed_contacts" | "multi_workspace_sessions" | "multi_workspace_session_rewind" | "multi_workspace_session_shell" | "persistent_workspace_registration" | "workspace_runtime_removal" | "workspace_qualified_rest_core" | "workspace_qualified_voice" | "extension_management_v2" | "workspace_persisted_transcript" | "workspace_session_export" | "workspace_archived_session_export" | "workspace_qualified_acp" | "client_mcp_over_ws" | "cdp_tunnel_over_ws" | "browser_automation_mcp" | "voice_transcribe")[];
