...
import { SubagentManager, type SubagentConfig } from '@hoptrendy/hopcode-core';
import { InvalidClientIdError, type AcpSessionBridge } from './acp-session-bridge.js';
import type { WorkspaceRegistry } from './workspace-registry.js';
import { type ServeWorkspaceAgentDetail, type ServeWorkspaceAgentSummary } from '@hoptrendy/acp-bridge/status';
/**
