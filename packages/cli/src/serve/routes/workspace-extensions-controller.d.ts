 ...
 */
import { ExtensionManager, type ClaudeMarketplaceConfig, type ExtensionSetting } from '@hoptrendy/hopcode-core';
import type { Request, Response } from 'express';
import type { AcpSessionBridge } from '../acp-session-bridge.js';
import { type ServeWorkspaceExtensionsStatus } from '@hoptrendy/acp-bridge/status';
