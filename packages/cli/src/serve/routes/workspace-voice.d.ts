...
type PersistSetting = (workspace: string, scope: SettingScope, key: string, value: unknown) => Promise<void | LoadedSettings>;
type PersistSettings = (workspace: string, writes: WorkspaceSettingsWrite[]) => Promise<void>;
