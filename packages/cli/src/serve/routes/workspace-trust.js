 ...
 */
import { FatalConfigError } from '@hoptrendy/hopcode-core';
...
export function registerWorkspaceTrustRoutes(app, deps) {
    const { boundWorkspace, workspace, mutate, safeBody, parseAndValidateClientId, } = deps;
    app.get('/workspace/trust', async (_req, res) => {
        try {
