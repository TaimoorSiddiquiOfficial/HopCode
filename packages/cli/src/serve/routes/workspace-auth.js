 ...
 */
import { ALL_PROVIDERS } from '@hoptrendy/hopcode-core';
...
export function registerWorkspaceAuthRoutes(app, deps) {
    const { mutate, deviceFlowRegistry, getSupportedDeviceFlowProviders, sendBridgeError, boundWorkspace, allowPrivateAuthBaseUrl, installAuthProvider, } = deps;
