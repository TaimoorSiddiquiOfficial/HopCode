...
import { SkillManager, Storage } from '@hoptrendy/hopcode-core';
...
async function ensureDirectoryWithoutSymlinks(directory) {
    const missing = [];
...
export async function installWorkspaceSkill(workspace, request, githubToken) {
...
export async function deleteWorkspaceSkill(workspace, scope, skillNameInput, installedPath) {
