...
import { readCronTasks, updateCronTasks, getCronFilePath, createDebugLogger, SessionService, taskHasLegacyCondition, } from '@hoptrendy/hopcode-core';
 ...
 */
async function bindAndNameSessions(bridge, boundWorkspace, tasks, renamed, spawnTimeoutMs, binding) {
...
export function startScheduledTaskKeepalive(opts) {
    ...
    const tick = async () => {
        ...
        await bindAndNameSessions(bridge, boundWorkspace, tasks, renamed, spawnTimeoutMs, binding);
    };
