...
import { createDebugLogger, stripTerminalControlSequences, } from '@hoptrendy/hopcode-core';
            ...
            if (info.completion === 'sent') {
                ...
                void (async () => {
                    try {
                        ...
                        const turnSettled = turn.then(() => 'ok', () => 'rejected');
                        ...
                        if (!(err instanceof Error && err.name === 'AbortError') &&
                            ...
                            log.debug('sub-session: sent-mode drain error', sessionId, String(err));
                        }
                    }
                    finally {
