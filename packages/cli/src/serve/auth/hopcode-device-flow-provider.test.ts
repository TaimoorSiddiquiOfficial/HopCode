...
function fakeClient(
  ...
  return {
    setCredentials: () => {},
    getCredentials: () =>
      ({}) as ReturnType<IHopCodeOAuth2Client['getCredentials']>,
    getAccessToken: async () => ({}),
    requestDeviceAuthorization: async () =>
      ({}) as Awaited<
        ReturnType<IHopCodeOAuth2Client['requestDeviceAuthorization']>
      >,
    pollDeviceToken: async () =>
      ({}) as Awaited<ReturnType<IHopCodeOAuth2Client['pollDeviceToken']>>,
    refreshAccessToken: async () =>
      ({}) as Awaited<ReturnType<IHopCodeOAuth2Client['refreshAccessToken']>>,
    ...overrides,
  };
}
