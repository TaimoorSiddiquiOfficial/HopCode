...
// `@hoptrendy/acp-bridge` in #4175 PR 22b — the bridge package owns the
...
import { canonicalizeWorkspace, canonicalizeWorkspaces, MAX_WORKSPACE_PATH_LENGTH, } from '@hoptrendy/acp-bridge/workspacePaths';
