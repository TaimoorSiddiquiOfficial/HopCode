...
import { StandardFileSystemService, decodeBufferWithEncodingInfo, detectLineEnding, encodeTextFileContent, loadIgnoreRules, isWithinRoot, } from '@hoptrendy/hopcode-core';
import { createAuditPublisher, } from './audit.js';
import { FsError, wrapAsFsError } from './errors.js';
import { canonicalizeWorkspaces, resolveWithinWorkspace, } from './paths.js';
...
class WorkspaceFileSystemImpl {
    ...
    async resolve(input, intent) {
        try {
            return await resolveWithinWorkspace(input, this.deps.workspaces.map((workspace) => workspace.path), intent);
        }
        catch (err) {
    ...
    async edit(p, oldText, newText, opts) {
        ...
        try {
            ...
            // a `.gitignore`d / `.hopcodeignore`d file (build artifacts,
