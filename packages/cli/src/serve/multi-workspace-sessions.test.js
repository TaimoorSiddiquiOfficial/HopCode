...
import { SESSION_TRANSCRIPT_MAX_INDEX_BYTES, SessionService, Storage, createDebugLogger, resetDebugLoggingState, setDebugLogSession, } from '@hoptrendy/hopcode-core';
...
function makeBridge(workspaceCwd, summaries = [], options = {}) {
    ...
    const bridge = {
        ...
        async changeSessionCwd(sessionId) {
