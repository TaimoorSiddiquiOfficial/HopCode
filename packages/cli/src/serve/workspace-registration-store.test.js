...
import { WorkspaceRegistrationStore, WorkspaceRegistrationStoreError, getWorkspaceRegistrationStorePath, workspaceRegistrationId, workspaceRegistrationScopeHash, } from './workspace-registration-store.js';
const cleanup = [];
