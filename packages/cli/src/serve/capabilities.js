...
export const SERVE_CAPABILITY_REGISTRY = {
    ...
    // hierarchical HOPCODE.md state and accepts append/replace writes scoped
    // to either the bound workspace or the global ~/.hopcode directory.
    ...
    // hopcode-action workflow set into the bound workspace after
    ...
    // `HOPCODE_SERVE_NO_MCP_POOL=1` env var falls back to per-session MCP
