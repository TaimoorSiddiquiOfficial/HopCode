...
import type { CompactionThresholds, CompressionStatus, MCPServerConfig, ThoughtSummary, ToolCallConfirmationDetails, ToolConfirmationOutcome, ToolResultDisplay, AgentStatus, ArenaDiffSummary } from '@hoptrendy/hopcode-core';
...
export declare const GOAL_STATUS_KINDS: readonly ["set", "achieved", "cleared", "failed", "aborted", "checking"];
...
export type SlashCommandProcessorResult = {
    ...
    type: 'handled';
} | SubmitPromptResult | StartImmediateSubagentActionReturn;
