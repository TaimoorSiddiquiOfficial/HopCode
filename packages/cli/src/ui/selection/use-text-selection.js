...
export function TextSelectionController(props) {
    ...
    const baselineViewportRectRef = useRef(null);
    ...
    const applyHighlight = useCallback(() => {
        ...
        const shouldHighlight = normalized && (!selection.isCollapsed || selection.mode !== 'char');
    ...
    const handleMouse = useCallback((event) => {
        ...
        if (event.name === 'move') {
            ...
            if (propsRef.current.getScrollState().scrollTop !==
    ...
    useEffect(() => {
        ...
        return buffer.subscribe((frame) => {
            ...
            if (scrollTop !== baselineScrollTopRef.current ||
