...
export const AppContainer = (props: AppContainerProps) => {
  ...
  const {
    ...
    historyManager.jumpToSearchResult,
    historyManager.canLoadOlderHistory,
    historyManager.canLoadNewerHistory,
    historyManager.loadOlderHistory,
    historyManager.loadNewerHistory,
    historyManager.windowInfo,
    remountStaticHistory,
    toggleVimEnabled,
    isProcessing,
    setIsProcessing,
  ...
  // Update terminal title with HopCode status and thoughts
  useEffect(() => {
    ...
    // Note: We don't need to reset the window title on exit because HopCode is already doing that elsewhere
  }, [
    streamingState,
    thought,
    settings.merged.ui?.showStatusInTitle,
