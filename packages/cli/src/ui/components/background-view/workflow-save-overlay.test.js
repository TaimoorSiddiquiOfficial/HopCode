...
import { saveWorkflowScript } from '@hoptrendy/hopcode-core';
...
describe('WorkflowSaveOverlay', () => {
    ...
    it('saves to project scope on submit, then closes on the next key', async () => {
        mockedSave.mockResolvedValue({
            ...
            name: 'flow',
            scope: 'project',
            path: '/proj/.hopcode/workflows/flow.js',
        });
        ...
        expect(lastFrame() ?? '').toContain('Saved to /proj/.hopcode/workflows/flow.js');
        await press({ name: 'return' });
    ...
    it('Tab toggles to user scope', async () => {
        mockedSave.mockResolvedValue({
            ...
            name: 'flow',
            scope: 'user',
            path: '/home/.hopcode/workflows/flow.js',
        });
