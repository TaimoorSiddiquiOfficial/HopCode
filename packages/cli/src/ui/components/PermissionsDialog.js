    ...
    return [
        {
            ...
            description: t('Checked in at .hopcode/settings.json'),
            value: SettingScope.Workspace,
            key: 'project',
        },
        {
            label: t('User settings'),
            description: t('Saved in at ~/.hopcode/settings.json'),
    ...
    return [
        {
            id: 'allow',
            label: t('Allow'),
            description: t("HopCode won't ask before using allowed tools."),
        },
        {
            id: 'ask',
            label: t('Ask'),
            description: t('HopCode will ask before using these tools.'),
        },
        {
            id: 'deny',
            label: t('Deny'),
            description: t('HopCode is not allowed to use denied tools.'),
        },
        {
            id: 'workspace',
            label: t('Workspace'),
