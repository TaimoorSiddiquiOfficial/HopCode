...
describe('InstalledTab', () => {
    ...
    it('surfaces activation warnings and reloads the installed list', async () => {
        ...
        const statuses = [];
        render(_jsx(InstalledTab, { config: config, isActive: true, onLockChange: vi.fn(), onStatus: (status) => statuses.push(status), extensionsUpdateState: new Map(), reloadSignal: 0 }));
