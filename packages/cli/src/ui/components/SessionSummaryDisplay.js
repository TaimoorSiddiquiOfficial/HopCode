...
export const SessionSummaryDisplay = ({ duration, width, }) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(StatsDisplay, { title: t('Agent powering down. Goodbye!'), duration: duration, width: width }), hasMessages && canResume && (_jsx(Box, { marginTop: 1, children: _jsxs(Text, { color: theme.text.secondary, children: [t('To continue this session, run'), ' ', _jsxs(Text, { color: theme.text.accent, children: ["hopcode --resume ", stats.sessionId] })] }) }))] }));
};
