...
import { HookEventName, HooksConfigSource, HookType, } from '@hoptrendy/hopcode-core';
...
describe('HookConfigDetailStep', () => {
    const createMockHookEvent = () => ({
        ...
        shortDescription: 'Right before HopCode concludes its response',
        description: '',
        exitCodes: [
    ...
    it('should render source for Extensions with path', () => {
        const hookEvent = createMockHookEvent();
        const hookConfig = createMockHookConfig(HooksConfigSource.Extensions, 'ralph-wiggum', '/Users/test/.hopcode/extensions/ralph-wiggum');
        const { lastFrame } = render(_jsx(HookConfigDetailStep, { hookEvent: hookEvent, hookConfig: hookConfig }));
        expect(lastFrame()).toContain('Extensions');
        expect(lastFrame()).toContain('/Users/test/.hopcode/extensions/ralph-wiggum');
    });
