...
import { HookEventName, HooksConfigSource, hookEventSupportsMatcher, } from '@hoptrendy/hopcode-core';
...
describe('hooks constants', () => {
    ...
    describe('createEmptyHookEventInfo', () => {
        ...
        it('should create empty info for Stop', () => {
            ...
            expect(info.shortDescription).toBe('Right before HopCode concludes its response');
