...
describe('SessionPicker', () => {
    ...
    describe('Search', () => {
        it('substring filters across customTitle, prompt, and gitBranch', async () => {
            ...
            const mockService = createMockSessionService(sessions);
            const { stdin, lastFrame } = render(_jsx(KeypressProvider, { kittyProtocolEnabled: false, children: _jsx(SessionPicker, { sessionService: mockService, onSelect: vi.fn(), onCancel: vi.fn() }) }));
            await wait(100);
        ...
        it('list-mode j/k navigate the list', async () => {
            ...
            const mockService = createMockSessionService(sessions);
            const onSelect = vi.fn();
            const { stdin } = render(_jsx(KeypressProvider, { kittyProtocolEnabled: false, children: _jsx(SessionPicker, { sessionService: mockService, onSelect: onSelect, onCancel: vi.fn() }) }));
            await wait(100);
        ...
        it('Backspace edits the query; emptying it returns to list mode', async () => {
            ...
            const mockService = createMockSessionService(sessions);
            const onCancel = vi.fn();
            const { stdin, lastFrame } = render(_jsx(KeypressProvider, { kittyProtocolEnabled: false, children: _jsx(SessionPicker, { sessionService: mockService, onSelect: vi.fn(), onCancel: onCancel }) }));
            await wait(100);
            stdin.write('/logim');
            await wait(30);
        ...
        it('Enter in search commits the filter; second Enter selects', async () => {
            ...
            const mockService = createMockSessionService(sessions);
            const onSelect = vi.fn();
            const { stdin, lastFrame } = render(_jsx(KeypressProvider, { kittyProtocolEnabled: false, children: _jsx(SessionPicker, { sessionService: mockService, onSelect: onSelect, onCancel: vi.fn() }) }));
            await wait(100);
            stdin.write('/special');
            await flush();
        ...
        it('Space → preview works on the highlighted row in filtered-list', async () => {
            ...
            const { stdin, lastFrame } = render(_jsx(KeypressProvider, { kittyProtocolEnabled: false, children: _jsx(ConfigContext.Provider, { value: {
                        getShouldUseNodePtyShell: () => false,
                        getIdeMode: () => false,
                        isTrustedFolder: () => false,
                    }, children: _jsx(SettingsContext.Provider, { value: {
                            merged: {},
                        }, children: _jsx(SessionPicker, { sessionService: service, onSelect: vi.fn(), onCancel: vi.fn(), enablePreview: true }) }) }) }));
            await wait(100);
            stdin.write('/login');
            await wait(30);
        ...
        it('Ctrl+B toggles branch in filtered-list', async () => {
            ...
            const mockService = createMockSessionService(sessions);
            const { stdin, lastFrame } = render(_jsx(KeypressProvider, { kittyProtocolEnabled: false, children: _jsx(SessionPicker, { sessionService: mockService, onSelect: vi.fn(), onCancel: vi.fn(), currentBranch: "main" }) }));
            await wait(100);
            stdin.write('/login');
            await wait(30);
