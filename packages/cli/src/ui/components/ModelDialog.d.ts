...
export declare function ModelDialog({ onClose, isFastModelMode, isVoiceModelMode, isVisionModelMode, persistScope, availableTerminalHeight, }: ModelDialogProps): React.JSX.Element;
export {};
