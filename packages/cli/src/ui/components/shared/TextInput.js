...
export function TextInput({ value, onChange, onSubmit, onTab, onUp, onDown, placeholder, height = 1, isActive = true, validationErrors = [], inputWidth = 80, initialCursorOffset, mask = false, ellipsizeOverflow = false, }) {
