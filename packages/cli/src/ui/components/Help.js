...
const HelpTabs = ({ activeTab }) => (_jsxs(Box, { flexDirection: "row", children: [_jsx(Text, { bold: true, color: theme.text.accent, children: "HopCode" }), _jsx(Text, { color: theme.text.secondary, children: " " }), TAB_DEFS.map(({ tab, labelKey }) => {
