...
export const HopCodeRespondingSpinner = ({ nonRespondingDisplay, spinnerType = 'dots' }) => {
    const streamingState = useStreamingContext();
    const isScreenReaderEnabled = useIsScreenReaderEnabled();
    if (streamingState === StreamingState.Responding) {
        return (_jsx(HopCodeSpinner, { spinnerType: spinnerType, altText: SCREEN_READER_RESPONDING }));
    }
...
export const HopCodeSpinner = ({ spinnerType = 'dots', altText, }) => {
    const isScreenReaderEnabled = useIsScreenReaderEnabled();
...
//# sourceMappingURL=HopCodeRespondingSpinner.js.map