...
describe('ThinkingViewer mouse tracking', () => {
    ...
    it('subscribes the wheel handler WITH bypassVpGate (works in non-VP)', () => {
        render(_jsx(ThinkingViewer, { data: { text: 'Inspecting the repository', durationMs: 1200 }, onClose: () => { }, useAlternateScreen: false }));
...
//# sourceMappingURL=ThinkingViewer.test.js.map