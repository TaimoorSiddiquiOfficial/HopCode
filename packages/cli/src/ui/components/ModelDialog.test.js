...
const renderComponent = (props = {}, contextValue = undefined, settingsValue = undefined) => {
    ...
    const mockConfig = {
        ...
        getAllConfiguredModels: vi.fn(() => getFilteredHopCodeModels().map((m) => ({
            id: m.id,
            label: m.label,
...
describe('<ModelDialog />', () => {
    ...
    it('passes all model options to DescriptiveRadioButtonSelect', () => {
        ...
        expect(props.items[0].value).toBe(`${AuthType.HOPCODE_OAUTH}::${DEFAULT_HOPCODE_MODEL}`);
    ...
    it('initializes with the model from ConfigContext', () => {
        ...
        const expectedIndex = qwenModels.findIndex((m) => m.id === DEFAULT_HOPCODE_MODEL);
    ...
    it('updates initialIndex when config context changes', () => {
        ...
        const qwenModels = getFilteredHopCodeModels();
        const expectedCoderIndex = qwenModels.findIndex((m) => m.id === DEFAULT_HOPCODE_MODEL);
