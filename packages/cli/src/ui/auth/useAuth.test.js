...
import { AuthType, deepseekProvider, openRouterProvider, tokenPlanProvider, customProvider, generateCustomEnvKey as generateCustomApiKeyEnvKey, getDefaultModelIds, resolveBaseUrl, } from '@hoptrendy/hopcode-core';
...
describe('normalizeCustomModelIds', () => {
    ...
    it('deduplicates while preserving order', () => {
        const result = normalizeCustomModelIds('hopcode/qwen3-coder,openai/gpt-4.1,hopcode/qwen3-coder');
        expect(result).toEqual(['hopcode/qwen3-coder', 'openai/gpt-4.1']);
    });
