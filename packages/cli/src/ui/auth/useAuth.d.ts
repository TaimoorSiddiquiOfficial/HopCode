 ...
 */
import { AuthType, type Config, type ProviderConfig, type ProviderSetupInputs } from '@hoptrendy/hopcode-core';
...
export declare const useAuthCommand: (settings: LoadedSettings, config: Config, addItem: (item: HistoryItemWithoutId, timestamp: number) => void, onAuthChange?: () => void) => {
    ...
    hopCodeAuthState: import("../hooks/useHopCodeAuth.js").HopCodeAuthState;
    closeAuthDialog: () => void;
    handleProviderSubmit: (providerConfig: ProviderConfig, inputs: ProviderSetupInputs) => Promise<void>;
    openAuthDialog: () => void;
    cancelAuthentication: () => void;
