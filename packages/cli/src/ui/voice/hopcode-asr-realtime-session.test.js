...
import { deriveQwenRealtimeUrl, openQwenAsrRealtimeStream, } from './hopcode-asr-realtime-session.js';
class FakeSocket {
    OPEN = 1;
...
describe('hopcode-asr-realtime-session', () => {
    afterEach(() => {
        vi.useRealTimers();
    });
...
//# sourceMappingURL=hopcode-asr-realtime-session.test.js.map