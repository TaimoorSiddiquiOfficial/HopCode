 ...
 */
import { IdeClient, logIdeConnection, IdeConnectionEvent, IdeConnectionType, } from '@hoptrendy/hopcode-core';
import { HOPCODE_COMPANION_EXTENSION_NAME, getIdeInstaller, IDEConnectionStatus, ideContextStore, } from '@hoptrendy/hopcode-core';
    ...
    if (!currentIDE) {
        return {
            ...
            action: () => ({
                type: 'message',
                messageType: 'error',
                content: t('IDE integration is not supported in your current environment. To use this feature, run HopCode in one of these supported IDEs: VS Code or VS Code forks.'),
            }),
        };
    }
