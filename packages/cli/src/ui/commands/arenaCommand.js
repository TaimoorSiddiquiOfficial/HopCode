...
import { ArenaManager, ArenaEventType, isTerminalStatus, isSuccessStatus, ArenaSessionStatus, AuthType, createDebugLogger, stripStartupContext, } from '@hoptrendy/hopcode-core';
    ...
    if (!parsed.task) {
        return {
            ...
            content: [
                ...
                '  /arena start --models hopcoder-plus,kimi-for-coding "fix the bug"',
            ].join('\n'),
        };
    }
