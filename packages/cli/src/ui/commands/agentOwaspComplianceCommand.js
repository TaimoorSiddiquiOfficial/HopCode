 ...
 */
export const agentOwaspComplianceCommand = {
 ...
 */
async function performOwaspComplianceCheck(context) {
    const results = [];
 ...
 */
async function checkOwaspRisk(context, risk) {
    const findings = [];
        ...
        case 1: // Excessive Agency
            {
                ...
                if (!hasUserConfirmation) {
                    ...
                    recommendations.push('Require explicit user confirmation for destructive or irreversible actions');
                    if (status === 'compliant')
                        status = 'partial';
                }
            }
 ...
 */
async function checkForPermissionChecks(_context) {
    // Implemented: check if approval mode is NOT izn
    return process.env['HOPCODE_APPROVAL_MODE'] !== 'izn';
}
async function checkForLeastPrivilege(_context) {
    return false; // TODO: Scan for permission scopes
}
async function checkForUserConfirmation(_context) {
    return false; // TODO: Check if destructive commands require confirmation
}
async function checkForInputSanitization(_context) {
    return false; // TODO: Scan for sanitization functions
}
async function checkForPromptSeparation(_context) {
    return false; // TODO: Check prompt template structure
}
async function checkForExternalInputValidation(_context) {
    return false; // TODO: Check for input validation
}
async function checkForMemoryEncryption(_context) {
    return false; // TODO: Check memory encryption settings
}
async function checkForMemoryIsolation(_context) {
    return false; // TODO: Check memory isolation
}
async function checkForMemoryValidation(_context) {
    return false; // TODO: Check memory validation
}
async function checkForContextLimits(_context) {
    return false; // TODO: Check if context limits are configured
}
async function checkForSensitiveDataFiltering(_context) {
    return false; // TODO: Check for PII filtering
}
async function checkForContextRotation(_context) {
    return false; // TODO: Check context rotation
}
async function checkForHumanOversight(_context) {
...
async function checkForCriticalActionReview(_context) {
    return false; // TODO: Check for critical action review
}
async function checkForConfidenceThresholds(_context) {
    return false; // TODO: Check confidence thresholds
}
async function checkForDataClassification(_context) {
    return false; // TODO: Check data classification
}
async function checkForOutputFiltering(_context) {
    return false; // TODO: Check output filtering
}
async function checkForLoggingRedaction(_context) {
    return false; // TODO: Check logging redaction
}
async function checkForSandboxEnvironment(_context) {
    return false; // TODO: Check if sandbox is configured
}
async function checkForActionLimits(_context) {
    return false; // TODO: Check action rate limits
}
async function checkForRollbackCapability(_context) {
    return false; // TODO: Check rollback capability
}
async function checkForRateLimiting(_context) {
    return false; // TODO: Check rate limiting
}
async function checkForResourceLimits(_context) {
    return false; // TODO: Check resource limits
}
async function checkForCircuitBreaker(_context) {
    return false; // TODO: Check circuit breaker
}
async function checkForDependencyScanning(_context) {
    return false; // TODO: Check if Dependabot or similar is configured
}
async function checkForPinnedVersions(_context) {
    return false; // TODO: Check package.json for pinned versions
}
async function checkForMcpSecurityAudit(_context) {
    return false; // TODO: Check if MCP security audit is run regularly
}
async function checkForCodeReview(_context) {
    return false; // TODO: Check for code review process
}
async function checkForSecurityTesting(_context) {
    // TODO: Check for security tests
    return false; // Needs implementation
}
async function checkForVulnerabilityScanning(_context) {
...
//# sourceMappingURL=agentOwaspComplianceCommand.js.map