 ...
 */
export const makeSkillTemplateCommand = {
    name: 'make-skill-template',
    description: 'Generate a complete MCP server skill from a description (tools, handlers, tests, config)',
 ...
 */
function extractSkillName(description) {
 ...
 */
async function generateSkillTemplate(context, skillName, description) {
 ...
 */
function generateMcpServer(skillName, description) {
 ...
 * Generate test file
 */
function generateTests(skillName, _description) {
    const camelCaseName = toCamelCase(skillName);
    return {
 ...
 * Generate TypeScript config
 */
function generateTsConfig(_skillName) {
    return {
        path: 'tsconfig.json',
 ...
 */
function updateMcpConfig(skillName, configPath) {
    try {
 ...
 */
function generateSuccessReport(skillName, files) {
...
//# sourceMappingURL=makeSkillTemplateCommand.js.map