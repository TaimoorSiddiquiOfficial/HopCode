 ...
 */
export const pythonMcpServerCommand = {
 ...
 */
async function generatePythonMcpServer(projectName, _description, outputDir) {
 ...
 */
function generateServerCode(projectName, description) {
 ...
 * Generate tools module
 */
function generateToolsModule(projectName, _description) {
    return `"""
 ...
 * Generate pyproject.toml
 */
function generatePyproject(projectName) {
    return `[build-system]
requires = ["hatchling"]
 ...
 * Generate .env.example
 */
function generateEnvExample(_description) {
...
Generated by [HopCode CLI](https://github.com/TaimoorSiddiquiOfficial/HopCode)
 ...
 * Generate test file
 */
function generateTests(projectName, _description) {
    return `"""
 ...
 * Generate Dockerfile
 */
function generateDockerfile(_projectName) {
 ...
 */
function generateSuccessReport(projectName, outputDir, generatedFiles) {
...
//# sourceMappingURL=pythonMcpServerCommand.js.map