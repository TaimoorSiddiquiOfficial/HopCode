 ...
 */
import { SESSION_TITLE_MAX_LENGTH, tryGenerateSessionTitle, } from '@hoptrendy/hopcode-core';
...
export const renameCommand = {
    ...
    action: async (context, args) => {
        ...
        if (!name) {
            ...
            const outcome = await tryGenerateSessionTitle(config, context.abortSignal ?? new AbortController().signal).finally(() => {
                clearInterval(timer);
