...
import { ApiResponseEvent, AuthType, MAIN_SOURCE, Storage, getTokenUsageFilePath, recordTokenUsageFromApiResponse, } from '@hoptrendy/hopcode-core';
...
describe('statsCommand', () => {
    ...
    describe('historical token usage subcommands', () => {
        ...
        it('stats export writes CSV with a default filename', async () => {
            ...
            expect(result.content).toContain('Token usage exported to CSV: hopcode-token-usage-month-2025-07.csv');
            const csv = await readFile(path.join(tempDir, 'hopcode-token-usage-month-2025-07.csv'), 'utf-8');
