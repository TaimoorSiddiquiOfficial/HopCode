...
export interface OpenDialogActionReturn {
    ...
    dialog: 'help' | 'arena_start' | 'arena_select' | 'arena_stop' | 'arena_status' | 'auth' | 'theme' | 'editor' | 'settings' | 'statusline' | 'memory' | 'model' | 'fast-model' | 'voice-model' | 'vision-model' | 'subagent_create' | 'subagent_list' | 'skills_manage' | 'trust' | 'permissions' | 'approval-mode' | 'effort' | 'resume' | 'delete' | 'branch' | 'extensions_manage' | 'hooks' | 'mcp' | 'manage-models' | 'rewind' | 'diff' | 'stats';
}
...
export type SlashCommandActionReturn = ToolActionReturn | MessageActionReturn | StreamMessagesActionReturn | QuitActionReturn | OpenDialogActionReturn | LoadHistoryActionReturn | SubmitPromptActionReturn | ConfirmShellCommandsActionReturn | StartImmediateSubagentActionReturn | ConfirmActionReturn;
