...
import { GitHubDeviceFlowAuth, createDebugLogger, } from '@hoptrendy/hopcode-core';
 ...
 */
export const githubDeviceAuthCommand = {
    ...
    action: async (context, _args) => {
        try {
            ...
            const deviceAuth = new GitHubDeviceFlowAuth(GITHUB_OAUTH_CLIENT_ID, GITHUB_OAUTH_CLIENT_SECRET);
            let verificationUri = '';
            let userCode = '';
 ...
 */
function saveAccessToken(_context, token) {
    try {
        ...
        debugLogger.info(`GitHub OAuth token received (length: ${token.length}). ` +
...
//# sourceMappingURL=githubDeviceAuthCommand.js.map