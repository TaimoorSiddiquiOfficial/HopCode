 ...
 */
async function performSecurityReview(context, targetPath) {
 ...
 * Collect all files to scan
 */
async function collectFilesToScan(rootPath) {
    const files = [];
 ...
 */
function generateSecurityReviewReport(results, targetPath) {
    const totalIssues = results.critical.length +
        results.high.length +
...
//# sourceMappingURL=securityReviewCommand.js.map