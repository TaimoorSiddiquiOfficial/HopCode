 ...
 */
import { AuthType, HOPCODE_OAUTH_MODELS, } from '@hoptrendy/hopcode-core';
import { t } from '../../i18n/index.js';
const CACHED_HOPCODE_OAUTH_MODELS = HOPCODE_OAUTH_MODELS.map((model) => ({
    id: model.id,
    label: model.name ?? model.id,
    description: model.description,
    isVision: model.capabilities?.vision ?? false,
}));
function getHopCodeOAuthModels() {
 ...
 */
export function getFilteredHopCodeModels() {
