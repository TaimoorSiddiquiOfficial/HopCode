...
import { getAvailableModelsForAuthType, getFilteredHopCodeModels, getOpenAIAvailableModelFromEnv, } from './availableModels.js';
...
describe('availableModels', () => {
    ...
    describe('getAvailableModelsForAuthType', () => {
        ...
        it('should use config models for hopcode-oauth when config is provided', () => {
            ...
            const models = getAvailableModelsForAuthType(AuthType.HOPCODE_OAUTH, mockConfig);
