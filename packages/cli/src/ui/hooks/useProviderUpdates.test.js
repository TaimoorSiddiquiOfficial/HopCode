...
import { AuthType, CODING_PLAN_CHINA_BASE_URL, CODING_PLAN_ENV_KEY, codingPlanProvider, TOKEN_PLAN_BASE_URL, tokenPlanProvider, buildProviderTemplate, computeModelListVersion, PROVIDER_METADATA_NS, } from '@hoptrendy/hopcode-core';
...
describe('useProviderUpdates', () => {
    ...
    it('switches model when previous model is no longer available', async () => {
        ...
        expect(mockModelsConfig.syncAfterAuthRefresh).toHaveBeenCalledWith(AuthType.USE_OPENAI, 'qwen3.5-plus', undefined);
    });
