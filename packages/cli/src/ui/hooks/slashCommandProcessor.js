...
import { createDebugLogger, logSlashCommand, makeSlashCommandEvent, SlashCommandStatus, ToolConfirmationOutcome, IdeClient, addMCPStatusChangeListener, removeMCPStatusChangeListener, MCPServerStatus, recordSkillInvocation, } from '@hoptrendy/hopcode-core';
                ...
                if (commandToExecute.action) {
                    ...
                    if (result) {
                        switch (result.type) {
                            ...
                            case 'dialog':
                                switch (result.dialog) {
                                    ...
                                    case 'help':
                                        ...
                                        return { type: 'handled' };
                                    default: {
                                        throw new Error(`Unhandled slash command result: ${String(result.dialog)}`);
                                    }
                                }
                            case 'load_history': {
                            ...
                            default: {
                                throw new Error(`Unhandled slash command result: ${String(result.type)}`);
                            }
                        }
                    }
                    return { type: 'handled' };
