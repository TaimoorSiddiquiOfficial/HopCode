...
describe('useCommandCompletion', () => {
    ...
    describe('Completion mode detection', () => {
        ...
        it('should use slash completion for mid-input model-invocable commands', async () => {
            ...
            const { result } = renderHook(() => useCommandCompletion(useTextBufferForTest('please /store'), testRootDir, [skillCommand, builtInCommand], mockCommandContext, false, mockConfig));
            await waitFor(() => {
