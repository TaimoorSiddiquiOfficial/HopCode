...
import { getErrorMessage, isNodeError, Storage, isSubpath, unescapePath, readManyFiles, shouldRunVisionBridge, emptyMcpResourceText, formatMcpResourceContents, summarizeMcpResource, } from '@hoptrendy/hopcode-core';
...
export async function resolveAtCommandQuery({ query, config, onDebugMessage, messageId: userMessageTimestamp, signal, }) {
    ...
    for (const atPathPart of atPathCommandParts) {
        ...
        if (!isSubpath(projectTempDir, absolutePathName) &&
        ...
        const qwenIgnored = respectFileIgnore.respectHopCodeIgnore &&
            fileDiscovery.shouldIgnoreFile(pathName, {
