...
import { RESIZE_REPAINT_SETTLE_MS, useResizeSettleRepaint, } from './useResizeSettleRepaint.js';
describe('useResizeSettleRepaint (#4891)', () => {
    ...
    const setup = (initialWidth) => {
        const refreshStatic = vi.fn();
        const view = renderHook(({ width }) => useResizeSettleRepaint(width, refreshStatic), { initialProps: { width: initialWidth } });
...
//# sourceMappingURL=useResizeSettleRepaint.test.js.map