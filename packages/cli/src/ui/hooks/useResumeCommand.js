...
import { SessionService, buildSessionRecoveryPlan, } from '@hoptrendy/hopcode-core';
...
export function useResumeCommand(options) {
    ...
    const { config, settings, historyManager, startNewSession, setSessionName, remount, } = options;
