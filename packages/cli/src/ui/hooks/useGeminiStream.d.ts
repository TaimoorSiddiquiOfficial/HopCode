 ...
 */
import { type Config, type EditorType, type GeminiClient, type Logger, type ThoughtSummary, type SteerInput, SendMessageType, ApprovalMode } from '@hoptrendy/hopcode-core';
