...
active = true, recentCommands) {
    ...
    const { completionMode, query, completionStart, completionEnd, isMidInputSlashCompletion, } = useMemo(() => {
    ...
    const slashCommandsForCompletion = useMemo(() => isMidInputSlashCompletion
        ? slashCommands.filter(isMidInputCompletableCommand)
        : slashCommands, [isMidInputSlashCompletion, slashCommands]);
    const { suggestions, activeSuggestionIndex, visibleStartIndex, showSuggestions, isLoadingSuggestions, isPerfectMatch, dismissed, setSuggestions, setShowSuggestions, setActiveSuggestionIndex, setIsLoadingSuggestions, setIsPerfectMatch, setVisibleStartIndex, resetCompletionState, dismissCompletion, navigateUp, navigateDown, } = useCompletion({ query });
    useAtCompletion({
