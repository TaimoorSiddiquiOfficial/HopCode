...
import { SlashCommandStatus, ToolConfirmationOutcome, makeFakeConfig, } from '@hoptrendy/hopcode-core';
const { logSlashCommand, recordSkillInvocationMock, debugLoggerMock } = vi.hoisted(() => ({
...
describe('useSlashCommandProcessor', () => {
    ...
    const setupProcessorHook = (builtinCommands = [], fileCommands = [], mcpCommands = [], setIsProcessing = vi.fn(), settings = mockSettings, extensionRefreshState) => {
