...
export const HopCodeLight = new Theme('HopCode Light', 'light', {
    hljs: {
        display: 'block',
        overflowX: 'auto',
        padding: '0.5em',
...
}, hopcodeLightColors, lightSemanticColors);
//# sourceMappingURL=hopcode-light.js.map