...
import { read as readJsonlFile, createDebugLogger, } from '@hoptrendy/hopcode-core';
import pLimit from 'p-limit';
import { getInsightPrompt, runSideQuery, } from '@hoptrendy/hopcode-core';
...
function normalizeSessionFacet(facet, sessionId) {
    ...
    const normalizedFacet = {
        ...
        HOPCODE_helpfulness: normalizeInsightEnum(rawFacet['HOPCODE_helpfulness'], HOPCODE_HELPFULNESS_LEVELS, 'moderately_helpful'),
