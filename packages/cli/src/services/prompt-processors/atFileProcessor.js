 ...
 */
import { flatMapTextParts, readPathFromWorkspace, createDebugLogger, } from '@hoptrendy/hopcode-core';
            ...
            for (const injection of injections) {
                ...
                try {
                    ...
                    if (fileContentParts.length === 0) {
                        const uiMessage = `File '@{${pathStr}}' was ignored by .gitignore or .hopcodeignore and was not included in the prompt.`;
