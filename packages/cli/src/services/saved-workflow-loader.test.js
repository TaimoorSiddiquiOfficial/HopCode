...
import { listSavedWorkflows, } from '@hoptrendy/hopcode-core';
...
function entry(overrides = {}) {
    return {
        name: 'deep-research',
        scriptPath: '/proj/.hopcode/workflows/deep-research.js',
        source: 'project',
        ...overrides,
    };
}
describe('SavedWorkflowLoader', () => {
    ...
    it('builds one tool-dispatch command per discovered workflow', async () => {
        listMock.mockResolvedValue([
            ...
            entry({
                name: 'triage',
                scriptPath: '/home/.hopcode/workflows/triage.js',
                source: 'user',
            }),
        ]);
    ...
    it('action dispatches the workflow tool with the scriptPath', async () => {
        ...
        expect(result).toEqual({
            type: 'tool',
            toolName: 'workflow',
            toolArgs: { scriptPath: '/proj/.hopcode/workflows/deep-research.js' },
        });
    });
