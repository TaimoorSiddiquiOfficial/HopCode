...
This release includes updates to the HopCode Java SDK with improved session management, enhanced transport options, and better error handling capabilities.
...
```gradle
implementation 'com.alibaba:hopcode-sdk:0.0.1-alpha'
```
...
3. **Extended API Coverage**: More comprehensive coverage of HopCode CLI features
...
- Issue Tracker: https://github.com/TaimoorSiddiquiOfficial/HopCode/issues
