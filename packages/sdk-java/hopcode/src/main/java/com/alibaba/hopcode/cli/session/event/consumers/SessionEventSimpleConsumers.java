package com.alibaba.hopcode.cli.session.event.consumers;

import java.util.List;
import java.util.Optional;

import com.alibaba.hopcode.cli.protocol.data.AssistantContent;
import com.alibaba.hopcode.cli.protocol.data.AssistantContent.TextAssistantContent;
import com.alibaba.hopcode.cli.protocol.data.AssistantContent.ThinkingAssistantContent;
import com.alibaba.hopcode.cli.protocol.data.AssistantContent.ToolResultAssistantContent;
import com.alibaba.hopcode.cli.protocol.data.AssistantContent.ToolUseAssistantContent;
import com.alibaba.hopcode.cli.protocol.data.AssistantUsage;
import com.alibaba.hopcode.cli.protocol.data.behavior.Allow;
import com.alibaba.hopcode.cli.protocol.data.behavior.Behavior;
...
import com.alibaba.hopcode.cli.protocol.message.assistant.block.ContentBlock;
import com.alibaba.hopcode.cli.protocol.message.assistant.event.ContentBlockDeltaEvent;
import com.alibaba.hopcode.cli.protocol.message.assistant.event.StreamEvent;
import com.alibaba.hopcode.cli.protocol.message.control.payload.CLIControlPermissionRequest;
import com.alibaba.hopcode.cli.protocol.message.control.payload.CLIControlPermissionResponse;
...
import com.alibaba.hopcode.cli.session.Session;
...
public class SessionEventSimpleConsumers implements SessionEventConsumers {
     ...
     *
     * @param session a {@link com.alibaba.hopcode.cli.session.Session} object.
     * @param assistantContent a {@link com.alibaba.hopcode.cli.protocol.data.AssistantContent} object.
     */
