...
import com.alibaba.hopcode.cli.session.event.consumers.AssistantContentConsumers;
...
import com.alibaba.hopcode.cli.transport.process.ProcessTransport;
...
/**
 * Main entry point for interacting with the HopCode CLI. Provides static methods for simple queries and session management.
 *
 * @author skyfire
 * @version $Id: 0.0.1
 */
public class HopCodeCli {
    private static final Logger log = LoggerFactory.getLogger(HopCodeCli.class);

    /**
     * Sends a simple query to the HopCode CLI and returns a list of responses.
     *
