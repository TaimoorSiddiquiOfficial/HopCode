...
class SessionTest {
    ...
    void partialSendPromptSuccessfully() throws SessionControlException, SessionSendPromptException {
        Session session = HopCodeCli.newSession(new TransportOptions().setIncludePartialMessages(true));
    ...
    void testJSON() {
        String json
                ...
                + " HopCode SDK for Java today?\",\"type\":\"text\"}],\"id\":\"ed8374fe-a4eb-4fc0-9780-9bd2fd831cda\","
