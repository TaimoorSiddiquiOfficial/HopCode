package com.alibaba.hopcode.cli.example;

import com.alibaba.fastjson2.JSON;
import com.alibaba.hopcode.cli.HopCodeCli;
...
import com.alibaba.hopcode.cli.protocol.data.behavior.Behavior.Operation;
...
import com.alibaba.hopcode.cli.session.event.consumers.AssistantContentSimpleConsumers;
import com.alibaba.hopcode.cli.session.event.consumers.SessionEventSimpleConsumers;
...
import com.alibaba.hopcode.cli.protocol.message.assistant.block.TextBlock;
...
public class SessionExample {
    ...
    public static void main(String[] args) {
        Session session = HopCodeCli.newSession();
        try {
