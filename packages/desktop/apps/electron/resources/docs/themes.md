...
This guide explains how to customize the visual theme of HopCode.

## Overview

HopCode uses a 6-color theme system with support for both app-level defaults and per-workspace overrides.
