...
export const CHANNEL_MAP = {
    ...
    setQwenExtensionSetting: invoke(RPC_CHANNELS.settings.SET_HOPCODE_EXTENSION_SETTING),
    getHopCodePermissionSettings: invoke(RPC_CHANNELS.settings.GET_HOPCODE_PERMISSION_SETTINGS),
    setQwenPermissionRules: invoke(RPC_CHANNELS.settings.SET_HOPCODE_PERMISSION_RULES),
