...
export const CHANNEL_MAP = {
  ...
  listHopCodeProviders: invoke(RPC_CHANNELS.settings.LIST_HOPCODE_PROVIDERS),
  connectHopCodeProvider: invoke(RPC_CHANNELS.settings.CONNECT_HOPCODE_PROVIDER),
  ...
  sethopcodecoreSetting: invoke(RPC_CHANNELS.settings.SET_HOPCODE_CORE_SETTING),
  sethopcodemcpserver: invoke(RPC_CHANNELS.settings.SET_HOPCODE_MCP_SERVER),
  removehopcodemcpserver: invoke(RPC_CHANNELS.settings.REMOVE_HOPCODE_MCP_SERVER),
  sethopcodehook: invoke(RPC_CHANNELS.settings.SET_HOPCODE_HOOK),
  removehopcodehook: invoke(RPC_CHANNELS.settings.REMOVE_HOPCODE_HOOK),
  setQwenExtensionSetting: invoke(
    RPC_CHANNELS.settings.SET_HOPCODE_EXTENSION_SETTING,
  ),
  getHopCodePermissionSettings: invoke(
  ...
  // Memory settings
  getHopCodeMemorySettings: invoke(RPC_CHANNELS.memory.GET_SETTINGS),
  setHopCodeMemorySettings: invoke(RPC_CHANNELS.memory.SET_SETTINGS),
  getHopCodeMemorySettingsPath: invoke(RPC_CHANNELS.memory.GET_SETTINGS_PATH),
  getHopCodeMemoryPaths: invoke(RPC_CHANNELS.memory.GET_PATHS),
