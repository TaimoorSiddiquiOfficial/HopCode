export function gethopcodeCapabilityCacheKey(workspaceId, workingDirectory, connectionSlug) {
...
export function hopcodeCapabilitiesFromSkills(skills) {
...
function providerSkillFromDetail(detail) {
    return {
        ...
        metadata: {
            name: detail.name,
            description: detail.description ?? 'HopCode skill',
        },
        content: detail.body ?? '',
...
//# sourceMappingURL=hopcode-capability-cache.js.map