...
const ChatPage = React.memo(function ChatPage({ sessionId }) {
    ...
    const { activeWorkspaceId, llmConnections, workspaceDefaultLlmConnection, onOptimisticDefaultModelChange, onSendMessage, onOpenFile, onOpenUrl, workspaces, onRespondToPermission, onRespondToCredential, onMarkSessionRead, onMarkSessionUnread, onSetActiveViewingSession, getDraft, hydrateDraftAttachments, onInputChange, onAttachmentsChange, enabledSources, skills, getHopCodeCapabilitySnapshot, labels, onSessionLabelsChange, enabledModes, sessionStatuses, onSessionSourcesChange, onRenameSession, onFlagSession, onUnflagSession, onArchiveSession, onUnarchiveSession, onSessionStatusChange, onDeleteSession, leadingAction, isCompactMode, sessionListSearchQuery, isSearchModeActive, chatDisplayRef, onChatMatchInfoChange, isFocusedPanel, } = useAppShellContext();
    ...
    const HopCodeCapabilitySnapshot = getHopCodeCapabilitySnapshot?.(activeWorkspaceId, workingDirectory, effectiveConnectionSlug);
    const displaySession = React.useMemo(() => {
        if (!session || !HopCodeCapabilitySnapshot)
            return session;
        const cachedCommands = HopCodeCapabilitySnapshot.availableCommands;
        const cachedSkills = HopCodeCapabilitySnapshot.availableSkills;
        const cachedSkillDetails = HopCodeCapabilitySnapshot.availableSkillDetails;
    ...
    }, [session, HopCodeCapabilitySnapshot]);
