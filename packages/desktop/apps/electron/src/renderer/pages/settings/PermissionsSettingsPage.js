...
const HOPCODE_PERMISSIONS_DOC_URL = 'https://hopcode.dev/docs/en/users/configuration/settings/#permissions';
...
export default function PermissionsSettingsPage() {
    ...
    const loadSettings = useCallback(async () => {
        ...
        setError(null);
        try {
            const result = await window.electronAPI.getHopCodePermissionSettings();
            setSettings(result);
        }
        catch (loadError) {
