...
export default function AiSettingsPage() {
  ...
  const hopcodeConnection = useMemo(
    () =>
      llmConnections.find((connection) => connection.providerType === 'hopcode') ??
      llmConnections[0],
    [llmConnections],
  );
  ...
  const modelOptions = useMemo(
    () =>
      getModelOptionsForConnection(hopcodeConnection).map((option) => ({
        ...option,
