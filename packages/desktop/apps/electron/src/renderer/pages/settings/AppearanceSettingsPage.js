...
export default function AppearanceSettingsPage() {
    ...
    useEffect(() => {
        window.electronAPI?.getHomeDir?.().then((home) => setPetsFolder(`${home}/.hopcode/pets`));
    }, []);
