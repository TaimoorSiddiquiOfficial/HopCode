...
export default function SourceInfoPage({ sourceSlug, workspaceId, onDelete }) {
    ...
    return (_jsxs(Info_Page, { loading: loading, error: error ?? undefined, empty: !source && !loading && !error ? t('sourceInfo.notFound') : undefined, children: [_jsx(Info_Page.Header, { title: sourceName, titleMenu: _jsx(SourceMenu, { sourceSlug: sourceSlug, sourceName: sourceName, onOpenInNewWindow: handleOpenInNewWindow, onShowInFinder: handleOpenSourceFolder, onDelete: handleDelete }) }), source && (_jsxs(Info_Page.Content, { children: [_jsx(Info_Page.Hero, { avatar: _jsx(SourceAvatar, { source: source, fluid: true }), title: source.config.name, tagline: source.config.tagline }), source.config.mcp?.transport === 'stdio' && !localMcpEnabled && (_jsxs(Info_Alert, { variant: "warning", icon: _jsx(AlertCircle, { className: "h-4 w-4" }), children: [_jsx(Info_Alert.Title, { children: t('sourceInfo.sourceDisabled') }), _jsx(Info_Alert.Description, { children: t('sourceInfo.localMcpDisabled') })] })), _jsx(Info_Section, { title: t('sourceInfo.connection'), description: getConnectionDescription(source, t), actions: _jsx(EditPopover, { trigger: _jsx(EditButton, {}), ...getEditConfig('source-config', source.folderPath), secondaryAction: {
                                label: t('common.editFile'),
                                filePath: `${source.folderPath}/config.json`,
                            } }), children: _jsxs(Info_Table, { footer: source.config.connectionError && (_jsx("div", { className: "px-4 py-2 border-t border-border/30 bg-destructive/5", children: _jsxs("div", { className: "flex items-start gap-2 text-sm text-destructive", children: [_jsx(AlertCircle, { className: "h-4 w-4 shrink-0 mt-0.5" }), _jsx("span", { children: source.config.connectionError })] }) })), children: [_jsx(Info_Table.Row, { label: t('common.type'), value: source.config.type.toUpperCase() }), sourceUrl && (_jsx(Info_Table.Row, { label: t('common.url'), children: _jsx("button", { onClick: handleOpenUrl, className: "truncate hover:underline text-foreground focus:outline-none focus-visible:underline text-left block w-full", children: sourceUrl }) })), _jsx(Info_Table.Row, { label: t('sourceInfo.lastTested'), value: formatRelativeTime(source.config.lastTestedAt, t) })] }) }), source.config.type !== 'mcp' && permissionsConfig && apiPermissionsData.length > 0 && (_jsx(Info_Section, { title: t('sourceInfo.permissions'), description: getPermissionsDescription(source, t), actions: _jsx(EditPopover, { trigger: _jsx(EditButton, {}), ...getEditConfig('source-permissions', source.folderPath), secondaryAction: {
                                label: t('common.editFile'),
                                filePath: `${source.folderPath}/permissions.json`,
                            } }), children: _jsx(PermissionsDataTable, { data: apiPermissionsData, fullscreen: true, fullscreenTitle: "Permissions" }) })), source.config.type === 'mcp' && (_jsx(Info_Section, { title: t('sourceInfo.tools'), description: t('sourceInfo.toolsDesc'), actions: _jsx(EditPopover, { trigger: _jsx(EditButton, {}), ...getEditConfig('source-tool-permissions', source.folderPath), secondaryAction: {
                                label: t('common.editFile'),
                                filePath: `${source.folderPath}/permissions.json`,
                            } }), children: _jsx(ToolsDataTable, { data: toolsData, loading: mcpToolsLoading, error: mcpToolsError ?? undefined }) })), source.config.type === 'mcp' && permissionsConfig && mcpPermissionsData.length > 0 && (_jsx(Info_Section, { title: t('sourceInfo.permissions'), description: getPermissionsDescription(source, t), actions: _jsx(EditPopover, { trigger: _jsx(EditButton, {}), ...getEditConfig('source-permissions', source.folderPath), secondaryAction: {
                                label: t('common.editFile'),
                                filePath: `${source.folderPath}/permissions.json`,
                            } }), children: _jsx(PermissionsDataTable, { data: mcpPermissionsData, hideTypeColumn: true, fullscreen: true, fullscreenTitle: "Permissions" }) })), source.guide?.raw && (_jsx(Info_Section, { title: t('sourceInfo.documentation'), description: t('sourceInfo.documentationDesc'), actions: _jsx(EditPopover, { trigger: _jsx(EditButton, {}), ...getEditConfig('source-guide', source.folderPath), secondaryAction: {
                                label: t('common.editFile'),
