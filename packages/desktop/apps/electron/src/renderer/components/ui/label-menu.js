...
export function InlineLabelMenu({ open, onOpenChange, items, onSelect, onAddLabel, filter = '', position, className, states = [], activeStateId, onSelectState, }) {
    ...
    return (_jsx("div", { ref: menuRef, "data-inline-menu": true, className: cn('fixed z-dropdown', MENU_CONTAINER_STYLE, className), style: { left: Math.round(position.x) - 10, bottom: bottomPosition, minWidth: 200, maxWidth: 260 }, children: _jsx("div", { ref: listRef, className: MENU_LIST_STYLE, children: showAddLabel ? (_jsxs("div", { "data-selected": "true", onClick: () => {
                    onAddLabel?.(filter);
                    onOpenChange(false);
