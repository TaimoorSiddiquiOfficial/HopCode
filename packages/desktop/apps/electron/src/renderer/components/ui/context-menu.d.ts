...
declare function ContextMenuContent({ className, onKeyDown, children, ...props }: React.ComponentProps<typeof ContextMenuPrimitive.Content>): React.JSX.Element;
declare function ContextMenuItem({ className, inset, variant, shortcut, children, onClick, ...props }: React.ComponentProps<typeof ContextMenuPrimitive.Item> & {
    inset?: boolean;
