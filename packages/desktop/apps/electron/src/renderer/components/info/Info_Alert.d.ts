...
declare function Info_AlertRoot({ variant, inline, icon, className, children, ...props }: Info_AlertProps): React.JSX.Element;
declare function Info_AlertTitle({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>): React.JSX.Element;
declare function Info_AlertDescription({ className, ...props }: React.HTMLAttributes<HTMLParagraphElement>): React.JSX.Element;
