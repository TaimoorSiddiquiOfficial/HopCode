...
export interface ElectronAPI {
  ...
  sessionCommand(
    ...
    | ShareResult
    | RefreshTitleResult
    | import('@craft-agent/shared/protocol').HopCodePermissionSettings
    | HopCodeCoreSettingsSnapshot
    | { count: number }
    | {
        success: boolean;
  ...
  // Memory settings
  getHopCodeMemorySettings(
    workspaceId?: string,
  ): Promise<import('@craft-agent/shared/config').HopCodeMemorySettings>;
  setHopCodeMemorySettings(
    settings: Partial<import('@craft-agent/shared/config').HopCodeMemorySettings>,
    workspaceId?: string,
  ): Promise<import('@craft-agent/shared/config').HopCodeMemorySettings>;
  getHopCodeMemorySettingsPath(): Promise<string>;
  getHopCodeMemoryPaths(
    workspaceId?: string,
  ): Promise<import('@craft-agent/shared/config').HopCodeMemoryPaths>;
  openQwenMemoryPath(
    target: import('@craft-agent/shared/config').HopCodeMemoryPathTarget,
    workspaceId?: string,
  ): Promise<void>;
