...
const EXPECTED_CHANNELS: string[] = [
  ...
  'sessions:watchFiles',
  'settings:connectHopCodeProvider',
  ...
  'settings:listHopCodeProviders',
  'settings:removehopcodehook',
  'settings:removehopcodemcpserver',
  'settings:setDefaultThinkingLevel',
  'settings:setGlobalPermissionMode',
  'settings:setNetworkProxy',
  'settings:sethopcodecoreSetting',
  'settings:setQwenExtensionSetting',
  'settings:sethopcodehook',
  'settings:sethopcodemcpserver',
