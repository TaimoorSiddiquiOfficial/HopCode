...
import type { Session, UnreadSummary, CreateSessionOptions, FileAttachment, SendMessageOptions, SessionEvent, PermissionResponseOptions, CredentialResponse, SessionCommand, ShareResult, RefreshTitleResult, FileSearchResult, SessionSearchResult, LlmConnectionSetup, HopCodeProviderCatalog, HopCodeProviderConnectParams, HopCodeProviderConnectResult, TestLlmConnectionParams, TestLlmConnectionResult, SkillFile, SkillMarketplaceInstallResult, SkillMarketplaceItem, SessionFile, OAuthResult, McpToolsResult, GitBashStatus, UpdateInfo, WorkspaceSettings, PermissionModeState, BrowserInstanceInfo, DeepLinkNavigation, TestAutomationPayload, TestAutomationResult, WindowCloseRequest, DirectoryListingResult, RemoteSessionTransferPayload, ImportRemoteSessionTransferResult, AvailableSlashCommand, PermissionRuleType, PermissionSettingsScope, HopCodeCoreSettingKey, HopCodeCoreSettingsSnapshot, HopCodeHookDefinition, HopCodeHookEvent, HopCodeMcpServerConfig, HopCodePermissionSettings, HopCodeSettingValue, HopCodeSettingsScope } from '@craft-agent/shared/protocol';
export interface ElectronAPI {
    ...
    sessionCommand(sessionId: string, command: SessionCommand): Promise<void | ShareResult | RefreshTitleResult | import('@craft-agent/shared/protocol').HopCodePermissionSettings | HopCodeCoreSettingsSnapshot | {
        count: number;
    } | {
        success: boolean;
    ...
    listHopCodeProviders(sessionId?: string): Promise<HopCodeProviderCatalog>;
    connectHopCodeProvider(params: HopCodeProviderConnectParams, sessionId?: string): Promise<HopCodeProviderConnectResult>;
    ...
    getHopCodeMemorySettings(workspaceId?: string): Promise<import('@craft-agent/shared/config').HopCodeMemorySettings>;
    setHopCodeMemorySettings(settings: Partial<import('@craft-agent/shared/config').HopCodeMemorySettings>, workspaceId?: string): Promise<import('@craft-agent/shared/config').HopCodeMemorySettings>;
    getHopCodeMemorySettingsPath(): Promise<string>;
    getHopCodeMemoryPaths(workspaceId?: string): Promise<import('@craft-agent/shared/config').HopCodeMemoryPaths>;
    openQwenMemoryPath(target: import('@craft-agent/shared/config').HopCodeMemoryPathTarget, workspaceId?: string): Promise<void>;
    ...
    setQwenCoreSetting(scope: HopCodeSettingsScope, key: HopCodeCoreSettingKey, value: HopCodeSettingValue): Promise<HopCodeCoreSettingsSnapshot>;
    setQwenMcpServer(scope: HopCodeSettingsScope, name: string, server: HopCodeMcpServerConfig): Promise<HopCodeCoreSettingsSnapshot>;
    removeQwenMcpServer(scope: HopCodeSettingsScope, name: string): Promise<HopCodeCoreSettingsSnapshot>;
    setQwenHook(scope: HopCodeSettingsScope, event: HopCodeHookEvent, index: number | undefined, hook: HopCodeHookDefinition): Promise<HopCodeCoreSettingsSnapshot>;
    removeQwenHook(scope: HopCodeSettingsScope, event: HopCodeHookEvent, index: number): Promise<HopCodeCoreSettingsSnapshot>;
    setQwenExtensionSetting(extensionId: string, settingKey: string, scope: HopCodeSettingsScope, value: HopCodeSettingValue): Promise<HopCodeCoreSettingsSnapshot>;
    getHopCodePermissionSettings(): Promise<HopCodePermissionSettings>;
    setQwenPermissionRules(scope: PermissionSettingsScope, ruleType: PermissionRuleType, rules: string[]): Promise<HopCodePermissionSettings>;
