...
Environment variables (from .env or environment):
  HOPCODE_CODE_VERSION         - Optional npm version for bundled HopCode
...
echo "=== Building HopCode Desktop AppImage (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# 4. Vendor HopCode CLI package
echo "Vendoring HopCode CLI..."
cd "$ROOT_DIR"
bun run scripts/vendor-hopcode.ts
...
# electron-builder outputs: hopcode-Desktop-x86_64.AppImage or hopcode-Desktop-aarch64.AppImage
BUILT_APPIMAGE_NAME="hopcode-Desktop-${LINUX_ARCH}.AppImage"
...
# Rename to our standard naming convention: hopcode-Desktop-x64.AppImage, hopcode-Desktop-arm64.AppImage
APPIMAGE_NAME="hopcode-Desktop-${ARCH}.AppImage"
