...
echo "=== Building HopCode Desktop DMG (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder.yml uses artifactName to output: hopcode-Desktop-${arch}.dmg
DMG_NAME="hopcode-Desktop-${ARCH}.dmg"
