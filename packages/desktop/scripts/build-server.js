...
function showHelp() {
    console.log(`
Standalone server build script for HopCode
...
# HopCode Server — convenience entry point
...
async function main() {
    ...
    console.log(`=== Building HopCode Server ${version} for ${platform}-${arch} ===`);
