...
- Node.js 22 or newer for the HopCode runtime and related tooling
...
3. Start the Electron app in development mode:
   ...
   To run against a local HopCode checkout instead of a vendored or npm
   runtime, pass the source root:

   ```bash
   CRAFT_BRAND=modelstudio \
   HOPCODE_CODE_ROOT=/path/to/hopcode \
