...
/**
 * Get the HopCode environment marker for session detection.
 * This marker is embedded in the system prompt and allows us to identify
 * HopCode sessions in exported logs.
 */
...
- Global: \`~/.hopcode/skills/{slug}/SKILL.md\` or \`~/.agents/skills/{slug}/SKILL.md\`
- Workspace: \`${workspacePath}/skills/{slug}/SKILL.md\`
- Project: \`{projectRoot}/.hopcode/skills/{slug}/SKILL.md\` or \`{projectRoot}/.agents/skills/{slug}/SKILL.md\`
