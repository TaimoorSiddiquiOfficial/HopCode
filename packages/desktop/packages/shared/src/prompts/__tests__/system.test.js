...
const CO_AUTHOR_TRAILER = 'Co-Authored-By: HopCode <agents-noreply@craft.do>';
...
describe('includeCoAuthoredBy handling', () => {
    ...
    it('falls back to getCoAuthorPreference() when the arg is omitted (#576)', () => {
        ...
        const prompt = getSystemPrompt(undefined, undefined, '/tmp/workspace', '/tmp/workspace', undefined, 'HopCode Backend'
