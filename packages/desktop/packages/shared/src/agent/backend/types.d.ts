...
import type { PermissionResponseOptions, HopCodeSkillDeleteRequest, HopCodeSkillDeleteResult, HopCodeSkillInstallRequest, HopCodeSkillInstallResult, HopCodeSkillSetEnabledRequest, HopCodeSkillSetEnabledResult } from '../../protocol/dto.ts';
...
export interface AgentBackend {
     ...
     */
    setSourceServers(mcpServers: Record<string, SdkMcpServerConfig>, apiServers: Record<string, unknown>, intendedSlugs?: string[]): void | Promise<void>;
    /**
...
export interface BackendConfig extends CoreBackendConfig {
     ...
     * Qwen-only builds instantiate HopCodeAgent.
     */
