import type { AgentProvider, BackendConfig, BackendHostRuntimeContext, CoreBackendConfig, LlmAuthType, LlmProviderType } from '../types.ts';
...
export interface ProviderDriver {
    ...
    testConnection?: (args: DriverTestConnectionArgs) => Promise<{
        success: boolean;
        error?: string;
    } | null>;
...
export declare function getBackendRuntime(config: BackendConfig): BackendRuntimePayload;
export declare function getDefaultProviderType(provider: AgentProvider): LlmProviderType;
