...
function createAgent(
  cwd: string,
  onSdkSessionIdUpdate?: HopCodeAgentConfig['onSdkSessionIdUpdate'],
  onMidTurnMessagesDrained?: HopCodeAgentConfig['onMidTurnMessagesDrained'],
): HopCodeAgent {
...
async function readNextQueuedEvent(
  ...
  const queue = (agent as unknown as HopCodeAvailableCommandsInternals).eventQueue;
