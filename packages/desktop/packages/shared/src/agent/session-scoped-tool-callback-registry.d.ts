...
export interface SessionScopedToolCallbacks {
    ...
    sendAgentMessageFn?: (sessionId: string, message: string, attachments?: Array<{
        path: string;
        name?: string;
    }>) => Promise<void>;
    /**
    ...
    getMessagingBindingsFn?: (sessionId: string) => Array<{
        platform: string;
        channelId: string;
        channelName?: string;
        enabled: boolean;
 ...
 */
export declare function registerSessionScopedToolCallbacks(sessionId: string, callbacks: SessionScopedToolCallbacks): void;
/**
 ...
 */
export declare function mergeSessionScopedToolCallbacks(sessionId: string, callbacks: Partial<SessionScopedToolCallbacks>): void;
/**
 * Unregister callbacks for a session
 */
export declare function unregisterSessionScopedToolCallbacks(sessionId: string): void;
/**
 * Get callbacks for a session
 */
export declare function getSessionScopedToolCallbacks(sessionId: string): SessionScopedToolCallbacks | undefined;
