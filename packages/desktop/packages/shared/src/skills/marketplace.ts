  ...
  [
    {
      ...
      description:
        'Use Bailian CLI when you want HopCode to run Aliyun Model Studio CLI workflows for text, multimodal input, image generation and editing, video generation and editing, speech, file upload, app calls, knowledge retrieval, web search, and model listing.',
      iconKey: 'bailian-cli',
      websiteUrl:
    ...
    },
    {
      ...
      description:
        'Use Bailian Docs LLM Wiki when you want HopCode to answer Bailian platform questions from its model metadata, wiki pages, and raw documentation. It helps with model specs, API parameters, error codes, pricing, quotas, SDK usage, OpenAI-compatible interfaces, and multimodal capabilities.',
    ...
    },
    {
      ...
      description:
        'Use Spark Video Episode when you want HopCode to orchestrate the Spark Video pipeline end to end, from premise and script through storyboard, clip rendering, review, retries, and final stitching with user approval gates.',
      iconKey: 'spark-video',
      websiteUrl:
