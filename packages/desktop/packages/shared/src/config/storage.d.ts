...
export declare const DEFAULT_CONVERSATION_WORKSPACE_NAME = "hopcode";
export declare const DEFAULT_CONVERSATION_WORKSPACE_KIND: "conversation";
export declare const DEFAULT_CONVERSATION_WORKSPACE_PATH_ENV = "HOPCODE_DEFAULT_WORKSPACE_DIR";
/**
