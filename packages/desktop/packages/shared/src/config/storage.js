...
import { HOPCODE_CODE_CONNECTION_SLUG } from './llm-connections.ts';
...
function stripQwenRuntimeModelFields(connection) {
    if (connection.providerType !== 'hopcode')
        return;
...
function createHopCodeConnection(existing) {
    return {
...
function normalizeToHopCodeOnly(target) {
