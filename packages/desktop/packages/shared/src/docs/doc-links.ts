...
export const DOCS: Record<DocFeature, DocInfo> = {
  ...
  permissions: {
    ...
    title: 'Permissions',
    summary:
      'Control how much autonomy your agent has. Plan mode is plan-first, Ask before edits prompts before changes, Edit automatically applies edits, and IZN runs without prompts.',
  },
  labels: {
