 ...
 */
export { type SystemColorName, type SystemColor, type CustomColor, type EntityColor, SYSTEM_COLOR_NAMES, } from './types.ts';
export { resolveEntityColor, parseSystemColor, isSystemColorName, isSystemColor, deriveDarkVariant, type ParsedSystemColor, } from './resolve.ts';
