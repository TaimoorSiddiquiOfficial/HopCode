...
export declare const RPC_CHANNELS: {
    ...
    readonly settings: {
        ...
        readonly LIST_HOPCODE_PROVIDERS: "settings:listHopCodeProviders";
        readonly CONNECT_HOPCODE_PROVIDER: "settings:connectHopCodeProvider";
        ...
        readonly GET_HOPCODE_CORE_SETTINGS: "settings:getQwenCoreSettings";
        readonly SET_HOPCODE_CORE_SETTING: "settings:setQwenCoreSetting";
        readonly SET_HOPCODE_MCP_SERVER: "settings:setQwenMcpServer";
        readonly REMOVE_HOPCODE_MCP_SERVER: "settings:removeQwenMcpServer";
        readonly SET_HOPCODE_HOOK: "settings:setQwenHook";
        readonly REMOVE_HOPCODE_HOOK: "settings:removeQwenHook";
        readonly SET_HOPCODE_EXTENSION_SETTING: "settings:setQwenExtensionSetting";
        readonly GET_HOPCODE_PERMISSION_SETTINGS: "settings:getHopCodePermissionSettings";
        readonly SET_HOPCODE_PERMISSION_RULES: "settings:setQwenPermissionRules";
