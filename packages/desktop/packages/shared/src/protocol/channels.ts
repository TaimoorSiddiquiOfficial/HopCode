...
export const RPC_CHANNELS = {
  ...
  settings: {
    ...
    LIST_HOPCODE_PROVIDERS: 'settings:listHopCodeProviders',
    ...
    SET_HOPCODE_CORE_SETTING: 'settings:sethopcodecoreSetting',
    SET_HOPCODE_MCP_SERVER: 'settings:sethopcodemcpserver',
    REMOVE_HOPCODE_MCP_SERVER: 'settings:removehopcodemcpserver',
    SET_HOPCODE_HOOK: 'settings:sethopcodehook',
    REMOVE_HOPCODE_HOOK: 'settings:removehopcodehook',
    SET_HOPCODE_EXTENSION_SETTING: 'settings:setQwenExtensionSetting',
    GET_HOPCODE_PERMISSION_SETTINGS: 'settings:getHopCodePermissionSettings',
    SET_HOPCODE_PERMISSION_RULES: 'settings:setQwenPermissionRules',
