 ...
 */
export type WorkerCommand = StartCommand | SubmitPairingPhoneCommand | SendTextCommand | SendFileCommand | ShutdownCommand;
...
export type WorkerEvent = ReadyEvent | QrEvent | PairingCodeEvent | ConnectedEvent | DisconnectedEvent | IncomingEvent | SendResultEvent | ErrorEvent | UnavailableEvent;
...
export declare function encodeMessage(msg: WorkerCommand | WorkerEvent): string;
/**
 ...
 */
export declare function parseFrames<T>(buffer: string): {
    messages: T[];
    rest: string;
};
