...
declare const PlatformContext: import("react").Context<PlatformActions>;
 ...
 * ```
 */
export declare function PlatformProvider({ children, actions }: PlatformProviderProps): import("react").JSX.Element;
/**
 ...
 * ```
 */
export declare function usePlatform(): PlatformActions;
