...
import { type BadgeVariant } from './PreviewOverlay';
...
export declare function DataTableOverlay({ isOpen, onClose, title, subtitle, theme, badgeVariant, headerActions, children, }: DataTableOverlayProps): React.JSX.Element;
