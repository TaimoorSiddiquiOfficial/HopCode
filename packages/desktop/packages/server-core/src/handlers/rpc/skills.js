...
async function shouldLoadSkillsFromQwenAcp(workspaceRootPath) {
    ...
    const { getDefaultLlmConnection, getLlmConnection, HOPCODE_CODE_CONNECTION_SLUG, } = await import('@craft-agent/shared/config');
    ...
    return (connectionSlug === HOPCODE_CODE_CONNECTION_SLUG ||
