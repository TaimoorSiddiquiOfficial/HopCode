...
import type { Session, SessionStatus, AvailableSlashCommand, CreateSessionOptions, FileAttachment, SendMessageOptions, PermissionResponseOptions, CredentialResponse, PermissionModeState, UnreadSummary, ShareResult, RefreshAvailableCommandsOptions, PermissionRuleType, PermissionSettingsScope, HopCodeCoreSettingKey, HopCodeCoreSettingsSnapshot, HopCodeHookDefinition, HopCodeHookEvent, HopCodeMcpServerConfig, HopCodePermissionSettings, HopCodeProviderCatalog, HopCodeProviderConnectParams, HopCodeProviderConnectResult, HopCodeSettingValue, HopCodeSettingsScope, HopCodeSkillDeleteRequest, HopCodeSkillDeleteResult, HopCodeSkillInstallRequest, HopCodeSkillInstallResult, HopCodeSkillSetEnabledRequest, HopCodeSkillSetEnabledResult } from '@craft-agent/shared/protocol';
...
export interface ISessionManager {
    ...
    sendMessage(sessionId: string, message: string, attachments?: FileAttachment[], storedAttachments?: StoredAttachment[], options?: SendMessageOptions, existingMessageId?: string, eventClientId?: string): Promise<void>;
     ...
     */
    exportRemoteSessionTransfer(sessionId: string, workspaceId: string): Promise<import('@craft-agent/shared/protocol').RemoteSessionTransferPayload | null>;
    /**
     ...
     */
    importRemoteSessionTransfer(workspaceId: string, payload: import('@craft-agent/shared/protocol').RemoteSessionTransferPayload): Promise<import('@craft-agent/shared/protocol').ImportRemoteSessionTransferResult>;
