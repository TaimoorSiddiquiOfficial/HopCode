...
export type MessagingPlatformRuntimeState = 'disconnected' | 'connecting' | 'connected' | 'reconnect_required' | 'error';
...
export declare const DEFAULT_BINDING_CONFIG: BindingConfig;
export declare function getDefaultBindingConfig(platform: PlatformType): BindingConfig;
export declare function normalizeBindingConfig(platform: PlatformType, config?: Partial<BindingConfig>): BindingConfig;
...
export declare const DEFAULT_MESSAGING_CONFIG: MessagingConfig;
