...
export declare const ConfigValidateSchema: z.ZodObject<{
    ...
    target: "config" | "all" | "preferences" | "permissions" | "sources" | "statuses" | "automations" | "tool-icons";
...
export declare const CredentialPromptSchema: z.ZodObject<{
    ...
    mode: "query" | "header" | "basic" | "bearer" | "multi-header";
    sourceSlug: string;
...
export declare const CallLlmSchema: z.ZodObject<{
    ...
    outputFormat?: "validation" | "summary" | "analysis" | "classification" | "extraction" | "comparison" | undefined;
    attachments?: (string | {
        path: string;
        startLine?: number | undefined;
        endLine?: number | undefined;
...
export declare const SpawnSessionSchema: z.ZodObject<{
    ...
    permissionMode?: "ask" | "auto-edit" | "safe" | "allow-all" | undefined;
    thinkingLevel?: "off" | "low" | "medium" | "high" | "max" | "xhigh" | undefined;
    attachments?: {
        path: string;
        name?: string | undefined;
    }[] | undefined;
