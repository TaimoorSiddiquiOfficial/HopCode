...
description: Generate a branded hopcode desktop package from a minimal brandId and logo. Use when the user wants a custom, white-label, rebranded, ModelStudio/OpenWork/HopCode desktop client, installer, DMG/EXE/AppImage, or one-click brand build.
---
...
changes in the current worktree are not mutated. Default to the hopcode desktop branch; do not clone from
...
git clone --branch dragon/feat-unstable-desktop-app --single-branch \
  https://github.com/QwenLM/hopcode.git \
  "$BUILD_ROOT/hopcode"
