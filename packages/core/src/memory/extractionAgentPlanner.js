...
import { AUTO_MEMORY_INDEX_FILENAME, getAutoMemoryRoot, getUserAutoMemoryRoot, } from './paths.js';
...
async function buildTopicSummaryBlock(projectRoot) {
    // User-level scan is best-effort: a read failure on `~/.hopcode/memories/`
