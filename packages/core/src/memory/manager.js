...
export class MemoryManager {
     ...
     */
    appendToUserMemory(userMemory, memoryDir, indexContent, userSection, teamSection, options) {
        return appendManagedAutoMemoryToUserMemory(userMemory, memoryDir, indexContent, userSection, teamSection, options);
    }
    // ─── Dream utilities ──────────────────────────────────────────────────────────
    /**
