...
export declare function appendManagedAutoMemoryToUserMemory(userMemory: string, memoryDir: string, indexContent?: string | null, userSection?: UserAutoMemorySection, teamSection?: TeamAutoMemorySection, options?: BuildMemoryPromptOptions): string;
