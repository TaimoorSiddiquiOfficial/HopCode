...
describe('skill project paths', () => {
    ...
    it('resolves the project skills root', () => {
        expect(getProjectSkillsRoot(projectRoot)).toBe(path.join(projectRoot, '.hopcode', 'skills'));
    });
    it('allows paths inside project .hopcode/skills', () => {
        const skillPath = path.join(projectRoot, '.hopcode', 'skills', 'my-skill', 'SKILL.md');
...
describe('assertRealProjectSkillPath – symlink traversal', () => {
    ...
    it('rejects a path whose parent is a symlink pointing outside skills dir', async () => {
        // Create a symlink: .hopcode/skills/escape -> ../../outside
