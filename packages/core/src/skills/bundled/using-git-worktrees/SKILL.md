...
2. ~/.hopcode/worktrees/<project-name>/ (global location)
...
### For Global Directory (~/.hopcode/worktrees)
...
case $LOCATION in
  .worktrees|worktrees)
    ...
    ;;
  ~/.hopcode/worktrees/*)
    path="~/.hopcode/worktrees/$project/$BRANCH_NAME"
    ;;
esac
...
- **writing-plans** — before executing any tasks
