...
import { AUTONOMOUS_SENTINEL_DYNAMIC, AutonomousLoopTickResolver, } from './autonomous-loop.js';
describe('AutonomousLoopTickResolver', () => {
    it('delivers the full preamble only after a tick is marked delivered', () => {
        ...
        expect(delivered.modelText).toContain('# Autonomous loop tick (dynamic pacing)');
    });
...
//# sourceMappingURL=autonomous-loop.test.js.map