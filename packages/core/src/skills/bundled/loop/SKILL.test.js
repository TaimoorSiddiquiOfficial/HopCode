...
describe('bundled loop skill', () => {
    ...
    it('documents prompt-only input as self-paced and non-recurring', () => {
        ...
        expect(body).toContain('Call LoopWakeup only if continued follow-up is useful.');
    ...
    it('teaches the self-paced loop to lean on monitor/background-task notifications', () => {
        ...
        expect(body).toContain('If the notification says the watched condition was met');
        ...
        expect(body).toContain('one owned by another agent routes its notification only to that agent');
