...
description: Implementation quality checklist — invoke when asked to run a standards check or quality gate review
agentOnly: true
---
...
- [ ] Every new service/class is wired to the runtime
- [ ] Every new export is reachable from the package entry point
- [ ] If types were changed, all consumers updated
...
- [ ] Shell commands are safe (no unquoted variables)
...
Review your changes against each section. Report any violations before marking the task complete. If a violation is found:
