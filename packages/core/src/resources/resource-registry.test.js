...
function makeResource(uri, serverName, name = uri) {
...
describe('ResourceRegistry', () => {
    ...
    describe('registerResource', () => {
        ...
        it('should overwrite on re-registration of the same (serverName, uri)', () => {
            ...
            expect(registry.getResource('server-a', 'file:///a.txt')?.name).toBe('new');
    ...
    describe('getResource', () => {
        it('should return undefined for an unknown resource', () => {
            expect(registry.getResource('server-a', 'file:///nope.txt')).toBeUndefined();
        });
    });
