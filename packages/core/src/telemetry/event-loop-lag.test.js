...
describe('startEventLoopLagMonitor', () => {
    ...
    it('converts nanosecond histogram values to milliseconds', () => {
        ...
        histogram.percentile.mockImplementation((percentile) => percentile === 50 ? 20_000_000 : 45_000_000);
        const monitor = startEventLoopLagMonitor({ resolutionMs: 10 });
        expect(monitor.snapshot()).toEqual({
            meanMs: 12,
            p50Ms: 20,
...
//# sourceMappingURL=event-loop-lag.test.js.map