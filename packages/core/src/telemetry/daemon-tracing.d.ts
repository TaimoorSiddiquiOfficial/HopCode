...
export declare const DAEMON_TRACEPARENT_META_KEY = "hopcode.telemetry.traceparent";
export declare const DAEMON_TRACESTATE_META_KEY = "hopcode.telemetry.tracestate";
