...
describe('HopCodeLogger', () => {
  ...
  beforeEach(() => {
    ...
    (HopCodeLogger as any).instance = undefined;
  });
  ...
  describe('logHookCallEvent', () => {
    ...
    it('should not include error when telemetry log prompts disabled', () => {
      ...
      (HopCodeLogger as unknown as { instance: undefined }).instance =
        undefined;
    ...
    it('should sanitize hook name to remove sensitive information', () => {
      ...
      const event = new HookCallEvent(
        'PreToolUse',
        'command',
        '/home/user/.hopcode/hooks/check-secrets.sh --api-key=secret123',
        { tool_name: 'read_file' },
        100,
        true,
      );
