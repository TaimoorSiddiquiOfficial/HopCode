...
describe('telemetry/config helpers', () => {
  ...
  describe('resolveTelemetrySettings', () => {
    ...
    it('accepts sensitiveSpanAttributeMaxLength at the configured maximum', async () => {
      ...
      const resolvedFromEnv = await resolveTelemetrySettings({
        env: {
          HOPCODE_TELEMETRY_SENSITIVE_SPAN_ATTRIBUTE_MAX_LENGTH: String(
            SENSITIVE_SPAN_ATTRIBUTE_MAX_LENGTH_LIMIT,
          ),
        },
      });
    ...
    it('rejects invalid sensitive span max length env values', async () => {
      await expect(
        ...
        /HOPCODE_TELEMETRY_SENSITIVE_SPAN_ATTRIBUTE_MAX_LENGTH.*got ''/,
      );
      ...
      await expect(
        ...
        /HOPCODE_TELEMETRY_SENSITIVE_SPAN_ATTRIBUTE_MAX_LENGTH.*got ' {3}'/,
      );
      ...
      await expect(
        ...
        /HOPCODE_TELEMETRY_SENSITIVE_SPAN_ATTRIBUTE_MAX_LENGTH.*got 'abc'/,
      );
      ...
      await expect(
        ...
        /HOPCODE_TELEMETRY_SENSITIVE_SPAN_ATTRIBUTE_MAX_LENGTH.*got '1e3'/,
      );
      ...
      await expect(
        ...
        /HOPCODE_TELEMETRY_SENSITIVE_SPAN_ATTRIBUTE_MAX_LENGTH.*got '0'/,
      );
      ...
      await expect(
        ...
        /HOPCODE_TELEMETRY_SENSITIVE_SPAN_ATTRIBUTE_MAX_LENGTH.*got '9007199254740992'/,
      );
      ...
      await expect(
        ...
        /HOPCODE_TELEMETRY_SENSITIVE_SPAN_ATTRIBUTE_MAX_LENGTH.*104857600/,
      );
    });
