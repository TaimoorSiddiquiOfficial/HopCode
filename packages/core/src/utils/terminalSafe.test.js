...
import { stripDisplayControlChars, stripTerminalControlSequences, } from './terminalSafe.js';
describe('stripDisplayControlChars', () => {
    it('preserves printable ASCII and TAB', () => {
        expect(stripDisplayControlChars('hello\tworld 123')).toBe('hello\tworld 123');
    });
    ...
    it('keeps characters adjacent to the bidi range (U+2029, U+202F, U+2065, U+206A)', () => {
        ...
        const input = 'a\u2029b\u202Fc\u2065d\u206Ae';
        expect(stripDisplayControlChars(input)).toBe('a\u2029b\u202Fc\u2065d\u206Ae');
    });
    it('defends against Trojan-Source style sequences (CVE-2021-42574)', () => {
        ...
        expect(stripDisplayControlChars(trojan)).toBe('/* } if (isAdmin) begin admin only */');
    });
...
//# sourceMappingURL=terminalSafe.test.js.map