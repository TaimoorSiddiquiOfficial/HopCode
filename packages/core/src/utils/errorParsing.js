...
export function parseAndFormatApiError(error, authType) {
    if (isStructuredError(error)) {
        // HopCode OAuth quota errors have their own user-friendly message
        if (error.message.startsWith('HopCode OAuth quota exceeded:') ||
            error.message.startsWith('HopCode OAuth free tier has been discontinued')) {
