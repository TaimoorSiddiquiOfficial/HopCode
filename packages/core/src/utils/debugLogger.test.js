...
import { createDebugLogger, isDebugLoggingDegraded, resetDebugLoggingState, runWithoutDebugLogSession, setDebugLogSession, } from './debugLogger.js';
...
describe('debugLogger', () => {
    ...
    describe('createDebugLogger', () => {
        ...
        it.each(['', ' ', '0', 'false', 'off', 'no'])('does not write debug log when QWEN_DEBUG_LOG_FILE is %j', async (value) => {
    ...
    describe('latest debug log symlink', () => {
        ...
        it('creates a symlink to the current session log file', async () => {
            ...
            expect(fs.symlink).toHaveBeenCalledWith('92ec0176-d354-4147-848b-5cd2d80609c4.txt', expectedLatestPath);
        });
