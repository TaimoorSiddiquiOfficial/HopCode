...
import { __resetWorkerScriptResolutionForTests, __setWorkerThresholdForTests, FzfWorkerHandle, installInProcessFzfTransport, } from './fzfWorkerHandle.js';
describe('FzfWorkerHandle', () => {
    ...
    describe('worker transport (real worker_threads)', () => {
        ...
        it('create() rejects and disposes on init failure', async () => {
            ...
            await expect(FzfWorkerHandle.create(null, {
                fuzzy: 'v2',
            })).rejects.toThrow();
        });
        it('rejects pending find() when worker crashes unexpectedly', async () => {
            ...
            fs.writeFileSync(outfile, `import { parentPort } from 'node:worker_threads';
...
//# sourceMappingURL=fzfWorkerHandle.test.js.map