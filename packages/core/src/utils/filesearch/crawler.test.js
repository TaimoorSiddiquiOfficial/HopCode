...
describe('crawler', () => {
    ...
    it('should use .hopcodeignore rules', async () => {
    ...
    it('should combine .gitignore and .hopcodeignore rules', async () => {
        tmpDir = await createTmpDir({
            '.gitignore': 'dist/',
            '.hopcodeignore': 'build/',
    ...
    describe('two-tier strategy: git ls-files + ripgrep fallback', () => {
        ...
        it('should preserve non-ASCII tracked paths from git output', async () => {
            ...
            expect(results).toEqual(expect.arrayContaining(['café.txt', '文档.md', 'plain/nested.txt']));
        });
