...
const symlinkSupported = (() => {
    try {
        const tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), 'workspace-symlink-test-'));
...
describe('WorkspaceContext with real filesystem', () => {
    ...
    describe('adding directories', () => {
        ...
        it.skipIf(!symlinkSupported)('should handle symbolic links correctly', () => {
    ...
    describe('applyRootDirectories', () => {
        it('should preserve runtime-added directories when changing roots', () => {
            ...
            workspaceContext.applyRootDirectories(WorkspaceContext.resolveRootDirectories(nextRoot));
