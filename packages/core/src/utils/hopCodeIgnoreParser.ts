...
export function normalizeHopCodeCustomIgnoreFileNames(
  ignoreFileNames: readonly string[] = DEFAULT_HOPCODE_CUSTOM_IGNORE_FILE_NAMES,
): string[] {
...
export function getHopCodeIgnoreFileNames(
...
export function formatHopCodeIgnoreFileNames(
  customIgnoreFileNames?: readonly string[],
): string {
...
export class HopCodeIgnoreParser implements HopCodeIgnoreFilter {
