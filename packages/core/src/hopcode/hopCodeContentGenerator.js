...
export class HopCodeContentGenerator extends OpenAIContentGenerator {
    debugLogger = createDebugLogger('HOPCODE');
    hopcodeClient;
    sharedManager;
    currentToken;
    constructor(hopcodeClient, contentGeneratorConfig, cliConfig) {
    ...
    async getValidToken() {
        try {
            ...
            const credentials = await this.sharedManager.getValidCredentials(this.hopcodeClient);
...
//# sourceMappingURL=hopCodeContentGenerator.js.map