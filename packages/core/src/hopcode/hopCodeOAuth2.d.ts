 ...
 */
export declare class HopCodeOAuthPollError extends Error {
 ...
 */
export declare class HopCodeOAuth2Client implements IHopCodeOAuth2Client {
    private credentials;
...
export declare enum HopCodeOAuth2Event {
    AuthUri = "auth-uri",
 ...
 */
export declare const HopCodeOAuth2Events: EventEmitter<[never]>;
export declare const hopCodeOAuth2Events: EventEmitter<[never]>;
export declare function getHopCodeOAuthClient(config: Config, options?: {
    requireCachedCredentials?: boolean;
}): Promise<HopCodeOAuth2Client>;
export declare const HOPCODE_CREDENTIAL_FILE_MODE = 384;
export declare function cacheHopCodeCredentials(credentials: HopCodeCredentials, opts?: {
    signal?: AbortSignal;
}): Promise<void>;
/**
 ...
 */
export declare function clearHopCodeCredentials(): Promise<void>;
export declare const clearCachedCredentialFile: typeof clearHopCodeCredentials;
export declare const clearHopcodeCredentials: typeof clearHopCodeCredentials;
