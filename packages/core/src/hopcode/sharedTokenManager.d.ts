...
import { type HopCodeCredentials } from './hopCodeOAuth2.js';
...
export declare class SharedTokenManager {
     ...
     */
    getValidCredentials(hopcodeClient: IHopCodeOAuth2Client, forceRefresh?: boolean): Promise<HopCodeCredentials>;
    /**
