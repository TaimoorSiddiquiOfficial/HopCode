 ...
 */
export declare class HopCodeContentGenerator extends OpenAIContentGenerator {
    private readonly debugLogger;
    private hopcodeClient;
    private sharedManager;
    private currentToken?;
    constructor(hopcodeClient: IHopCodeOAuth2Client, contentGeneratorConfig: ContentGeneratorConfig, cliConfig: Config);
    /**
