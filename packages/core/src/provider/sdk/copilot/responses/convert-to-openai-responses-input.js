...
export async function convertToOpenAIResponsesInput({ prompt, systemMessageMode, fileIdPrefixes, store, hasLocalShellTool = false, }) {
    const input = [];
    const warnings = [];
                    ...
                    switch (part.type) {
                        case 'text': {
                            input.push({
                                ...
                                id: part.providerOptions?.openai?.itemId ?? undefined,
                            });
                            break;
                        }
                        case 'tool-call': {
                            ...
                            if (hasLocalShellTool && part.toolName === 'local_shell') {
                                ...
                                input.push({
                                    ...
                                    id: part.providerOptions?.openai?.itemId ??
                                        undefined,
                                    action: {
                                        type: 'exec',
...
//# sourceMappingURL=convert-to-openai-responses-input.js.map