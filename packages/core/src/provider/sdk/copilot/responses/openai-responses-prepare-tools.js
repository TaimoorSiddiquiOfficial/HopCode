...
export function prepareResponsesTools({ tools, toolChoice, strictJsonSchema, }) {
    ...
    switch (type) {
        ...
        case 'tool':
            return {
                tools: openaiTools,
                toolChoice: toolChoice.toolName === 'code_interpreter' ||
...
//# sourceMappingURL=openai-responses-prepare-tools.js.map