...
import { openaiCompatibleProviderOptions, } from './openai-compatible-chat-options.js';
import { defaultOpenAICompatibleErrorStructure, } from '../openai-compatible-error.js';
...
export class OpenAICompatibleChatLanguageModel {
    ...
    chunkSchema; // type inferred via constructor
    ...
    async getArgs({ prompt, maxOutputTokens, temperature, topP, topK, frequencyPenalty, presencePenalty, providerOptions, stopSequences, responseFormat, seed, toolChoice, tools, }) {
        ...
        const compatibleOptions = Object.assign((await parseProviderOptions({
            provider: 'copilot',
            providerOptions,
...
// limited version of the schema, focussed on what is needed for the implementation
// this approach limits breakages when the API changes and increases efficiency
const createOpenAICompatibleChatChunkSchema = (errorSchema) => z.union([
    z.object({
        id: z.string().nullish(),
        created: z.number().nullish(),
        model: z.string().nullish(),
...
//# sourceMappingURL=openai-compatible-chat-language-model.js.map