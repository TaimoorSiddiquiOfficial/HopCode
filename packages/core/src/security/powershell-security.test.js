...
import { evaluatePowerShellCommand, resolvePowerShellConfig, DEFAULT_POWERSHELL_CONFIG, } from './powershell-security.js';
...
describe('evaluatePowerShellCommand', () => {
    ...
    it('blocklist works with * wildcard', () => {
        ...
        const result = evaluatePowerShellCommand('Stop-Process -Name chrome', config);
        expect(result.allowed).toBe(false);
        expect(result.isHardDenial).toBe(true);
    });
...
//# sourceMappingURL=powershell-security.test.js.map