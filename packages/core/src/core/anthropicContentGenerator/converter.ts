...
export interface ConvertGeminiRequestToAnthropicOptions {
   ...
   * stray thinking blocks. https://github.com/TaimoorSiddiquiOfficial/HopCode/issues/3786
   */
...
export class AnthropicContentConverter {
  ...
  async convertGeminiToolsToAnthropic(
    ...
    // `convertGeminiRequestToAnthropic` so a hopcode-oauth-style hot flip of
    ...
    // hot-mutated — non-hopcode-oauth providers recreate the generator on
   ...
   * already-satisfying. https://github.com/TaimoorSiddiquiOfficial/HopCode/issues/3786
   */
