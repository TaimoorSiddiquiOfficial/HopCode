 ...
 * https://github.com/TaimoorSiddiquiOfficial/HopCode/issues/3786
 */
...
export class AnthropicContentGenerator {
    ...
    async generateContentStream(request) {
        ...
        const inner = this.processStreamWithEmptyFallback(this.redactStreamErrors(stream), anthropicRequest, perRequestAc.signal, headers);
    ...
    buildSamplingParameters(request) {
        ...
        if (userMaxTokens !== undefined && userMaxTokens !== null) {
            ...
            const envMaxTokens = parsePositiveIntegerEnvValue(process.env['HOPCODE_MAX_OUTPUT_TOKENS']);
