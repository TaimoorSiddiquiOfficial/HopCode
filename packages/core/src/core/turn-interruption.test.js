...
import { buildSyntheticToolResponseParts, detectTurnInterruption, TURN_INTERRUPTION_HISTORY_TAIL_COUNT, } from './turn-interruption.js';
const reminder = (text) => ({
...
//# sourceMappingURL=turn-interruption.test.js.map