...
describe('GeminiContentGenerator', () => {
    ...
    it("maps reasoning effort 'medium' to MEDIUM", async () => {
        ...
        await generatorWithMedium.generateContent({ model: 'gemini-2.5-pro', contents: [] }, 'prompt-id');
        expect(mockGoogleGenAI.models.generateContent).toHaveBeenCalledWith(expect.objectContaining({
            config: expect.objectContaining({
                thinkingConfig: {
                    includeThoughts: true,
    ...
    it("clamps reasoning effort 'xhigh' to HIGH (Gemini has no xhigh tier)", async () => {
        ...
        await generatorWithXhigh.generateContent({ model: 'gemini-2.5-pro', contents: [] }, 'prompt-id');
        expect(mockGoogleGenAI.models.generateContent).toHaveBeenCalledWith(expect.objectContaining({
            config: expect.objectContaining({
                thinkingConfig: {
                    includeThoughts: true,
