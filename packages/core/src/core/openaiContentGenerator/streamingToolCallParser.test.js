...
describe('StreamingToolCallParser', () => {
    ...
    describe('Tool call metadata handling', () => {
        ...
        it.each([
            ...
            { index: 2, id: 'call_2' },
        ])('accepts and deduplicates a name after complete arguments at index $index', ({ index, id }) => {
    ...
    describe('Edge cases', () => {
        ...
        it('should handle JSON with unicode characters', () => {
            const result = parser.addChunk(0, '{"emoji": "??", "chinese": "??"}', 'call_1', 'function1');
            expect(result.complete).toBe(true);
    ...
    describe('Complex collision scenarios', () => {
        it('does not append continuation fragments to a completed remapped slot', () => {
            ...
            const remapped = parser.addChunk(0, '{"second":true}', undefined, 'function2');
