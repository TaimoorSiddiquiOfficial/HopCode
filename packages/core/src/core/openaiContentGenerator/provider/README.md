...
This folder contains the different provider implementations for the HopCode refactor system.
...
- `dashscope.ts` - DashScope (Qwen model family) specific provider implementation
...
The `DashScopeOpenAICompatibleProvider` handles DashScope (Qwen model family) specific features like cache control and metadata.
