...
// daemon deployment can tune it without code — the same way the HOPCODE_SERVE_*
...
export const HOPCODE_STREAM_IDLE_TIMEOUT_MS_ENV = 'HOPCODE_STREAM_IDLE_TIMEOUT_MS';
