...
export class InlineModificationHandler {
    getPreferredEditor;
    onEditorClose;
    constructor(getPreferredEditor, onEditorClose) {
        this.getPreferredEditor = getPreferredEditor;
     ...
     */
    applyInlineModify(toolCall, payload, signal) {
     ...
     */
    async launchEditorForModify(toolCall, signal) {
...
//# sourceMappingURL=inlineModificationHandler.js.map