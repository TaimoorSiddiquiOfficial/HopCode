...
import { REASONING_EFFORT_TIERS, clampReasoningEffort, normalizeReasoningEffort, } from './reasoning-effort.js';
...
describe('normalizeReasoningEffort', () => {
    ...
    it('returns undefined for non-string input without throwing', () => {
        ...
        expect(normalizeReasoningEffort(true)).toBeUndefined();
...
//# sourceMappingURL=reasoning-effort.test.js.map