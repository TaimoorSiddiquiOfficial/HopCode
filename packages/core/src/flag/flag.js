...
export const Flag = {
     ...
     */
    OPENCODE_EXPERIMENTAL_OUTPUT_TOKEN_MAX: process.env['OPENCODE_EXPERIMENTAL_OUTPUT_TOKEN_MAX']
     ...
     */
    OPENCODE_ENABLE_EXPERIMENTAL_MODELS: process.env['OPENCODE_ENABLE_EXPERIMENTAL_MODELS'] === 'true' ||
