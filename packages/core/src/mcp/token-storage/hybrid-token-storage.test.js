...
describe('HybridTokenStorage', () => {
    ...
    describe('storage selection', () => {
        ...
        it('should use file storage when HOPCODE_FORCE_FILE_STORAGE is set', async () => {
            process.env['HOPCODE_FORCE_FILE_STORAGE'] = 'true';
    ...
    describe('secret storage', () => {
        ...
        it('falls back to encrypted-file secrets when keychain is unavailable', async () => {
            ...
            expect(mockFileStorage.setSecret).toHaveBeenCalledWith('API_KEY', 'value');
