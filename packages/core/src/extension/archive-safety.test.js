...
describe('assertTarArchiveHasNoLinks', () => {
    ...
    it.runIf(process.platform !== 'win32')('rejects a large link set without throwing outside the promise', async () => {
        ...
        await expect(assertTarArchiveHasNoLinks(archive)).rejects.toThrow('more than 100 unsupported link entries');
    });
});
//# sourceMappingURL=archive-safety.test.js.map