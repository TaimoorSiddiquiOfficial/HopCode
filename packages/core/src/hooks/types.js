...
(function (HookEventName) {
    ...
    // TodoCreated - When a new todo item is added to the list (HopCode specific)
    HookEventName["TodoCreated"] = "TodoCreated";
    // TodoCompleted - When a todo item's status changes to 'completed' (HopCode specific)
