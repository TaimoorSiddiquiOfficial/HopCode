...
export const BACKGROUND_AGENT_CONCURRENCY_ENV = 'HOPCODE_CODE_MAX_BACKGROUND_AGENTS';
function normalizeBackgroundApprovalOutcome(outcome) {
...
export class BackgroundTaskRegistry {
    ...
    async resolvePendingApproval(agentId, callId, outcome, payload) {
        ...
        this.emitApprovalChange(entry);
        try {
            await approval.respond(normalizeBackgroundApprovalOutcome(outcome), payload);
        }
        catch (error) {
