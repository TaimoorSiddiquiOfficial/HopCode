...
import { getSubagentSessionDir, getAgentJsonlPath, getAgentMetaPath, attachJsonlTranscriptWriter, normalizeResumedAgentDepth, readAgentMeta, readLastTranscriptRecordUuidSync, writeAgentMeta, } from './agent-transcript.js';
...
describe('agent-transcript', () => {
    ...
    describe('normalizeResumedAgentDepth', () => {
        ...
        it('fails closed (no spawn capacity) on tampered or corrupt values', () => {
            ...
            expect(normalizeResumedAgentDepth(null)).toBe(undefined);
        });
    });
});
