...
export class GitHubSubagentRegistry {
    static GITHUB_AGENTS = [
        {
            name: 'github-reviewer',
            description: 'GitHub pull request reviewer agent. Use this agent to review PRs, analyze code changes, check for best practices, and provide constructive feedback.',
...
For clear communication, avoid using emojis.`,
        ...
        {
            name: 'github-triager',
            description: 'GitHub issue triage agent. Use this agent to analyze new issues, apply appropriate labels, suggest assignees, and provide helpful initial responses.',
...
For clear communication, avoid using emojis.`,
        ...
        },
        {
            ...
            description: 'GitHub Actions CI/CD monitoring agent. Use this agent to check workflow runs, analyze failures, view logs, and suggest fixes for CI issues.',
...
For clear communication, avoid using emojis.`,
        ...
        },
        {
            ...
            description: 'GitHub release management agent. Use this agent to create releases, generate changelogs, manage version tags, and coordinate release activities.',
...
For clear communication, avoid using emojis.`,
        ...
        },
        {
            ...
            description: 'GitHub security scanning agent. Use this agent to check for security alerts, review code scanning results, and identify potential vulnerabilities.',
...
For clear communication, avoid using emojis.`,
     ...
     */
    static getGitHubAgent(name) {
        const lowerName = name.toLowerCase();
        const agent = this.GITHUB_AGENTS.find((a) => a.name.toLowerCase() === lowerName);
        if (!agent) {
            return null;
        }
        return {
     ...
     */
    static isGitHubAgent(name) {
        const lowerName = name.toLowerCase();
        return this.GITHUB_AGENTS.some((agent) => agent.name.toLowerCase() === lowerName);
    }
    /**
     * Get names of all GitHub agents
     */
    static getGitHubAgentNames() {
        return this.GITHUB_AGENTS.map((agent) => agent.name);
    }
}
//# sourceMappingURL=github-agents.js.map