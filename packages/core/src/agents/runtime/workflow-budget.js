 ...
 *  - The env override `HOPCODE_MAX_TOKENS_PER_WORKFLOW` lets operators
 ...
 *    `HOPCODE_CODE_MAX_WORKFLOW_CONCURRENCY`). Operators sizing the cap
...
export const MAX_TOKENS_PER_WORKFLOW_ENV = 'HOPCODE_MAX_TOKENS_PER_WORKFLOW';
/**
...
export class WorkflowBudgetExceededError extends Error {
    ...
    constructor(runId, budgetTotal, spent) {
        ...
        // The previous "Increase HOPCODE_MAX_TOKENS_PER_WORKFLOW or unset
