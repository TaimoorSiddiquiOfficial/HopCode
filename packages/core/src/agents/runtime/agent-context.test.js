...
import { canSpawnNestedAgent, childLaunchDepth, getCurrentAgentDepth, getCurrentAgentId, getRuntimeContentGenerator, isTopLevelSession, runWithAgentContext, runWithRuntimeContentGenerator, spawnBlockReason, } from './agent-context.js';
...
describe('agent-context (depth) — #3731 Phase 3', () => {
    ...
    it('depthOverride pins the depth for background/foreground resume', async () => {
        ...
        await runWithAgentContext('resumed', async () => {
