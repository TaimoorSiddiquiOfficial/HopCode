...
export declare const MAX_WORKFLOW_AGENTS_ENV = "HOPCODE_CODE_MAX_WORKFLOW_AGENTS";
/**
...
export declare const MAX_WORKFLOW_CONCURRENCY_ENV = "HOPCODE_CODE_MAX_WORKFLOW_CONCURRENCY";
/**
...
export interface WorkflowRunRequest {
     ...
     * saved workflow (by name from `.hopcode/workflows/<name>.js`, or by
 ...
 */
onTokens?: (outputTokens: number, opts: WorkflowAgentOpts) => void): WorkflowAgentDispatch;
