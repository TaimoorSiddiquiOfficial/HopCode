...
import { WorkflowRunRegistry, MAX_RETAINED_TERMINAL_WORKFLOWS, } from './workflow-run-registry.js';
function reg(runId, overrides = {}) {
    return {
        runId,
        meta: null,
        description: 'wf',
...
describe('WorkflowRunRegistry', () => {
    ...
    it('register synthesizes description from meta.name when omitted', () => {
        const r = new WorkflowRunRegistry();
        const entry = r.register(reg('wf_named', {
...
//# sourceMappingURL=workflow-run-registry.test.js.map