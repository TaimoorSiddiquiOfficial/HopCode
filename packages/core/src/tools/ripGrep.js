...
import { getHopCodeIgnoreFileNames, HopCodeIgnoreParser, } from '../utils/hopCodeIgnoreParser.js';
...
function isHopCodeIgnoreFileName(ignoreFileName) {
...
class GrepToolInvocation extends BaseToolInvocation {
    ...
    async execute(signal) {
        try {
            ...
            if (filteringOptions.respectHopCodeIgnore) {
                allLines = this.filterHopCodeIgnoredMatches(allLines, searchPaths, resolvedPathCache, filteringOptions.customIgnoreFiles);
            }
    ...
    filterHopCodeIgnoredMatches(lines, searchPaths, resolvedPathCache, customIgnoreFiles) {
    ...
    async performRipgrepSearch(options) {
        ...
        if (filteringOptions.respectHopCodeIgnore) {
            ...
            const nonHopCodeIgnorePaths = [];
            const hopCodeIgnorePathsForRipgrep = [];
            const ignoreFileNames = getHopCodeIgnoreFileNames(filteringOptions.customIgnoreFiles);
    ...
    getFileFilteringOptions() {
        ...
        return {
            ...
            respectHopCodeIgnore: options?.respectHopCodeIgnore ??
