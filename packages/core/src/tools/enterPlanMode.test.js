...
describe('EnterPlanModeTool', () => {
    ...
    describe('constructor and metadata', () => {
        ...
        it('should require user opt-in in the tool description', () => {
            expect(tool.description).toContain('only after the user explicitly asks to switch into plan mode');
            expect(tool.description).toContain('If plan mode seems helpful but the user has not asked for it, ask first');
            expect(tool.description).not.toContain('before doing uncertain or complex work');
    ...
    describe('execute', () => {
        ...
        it('should return error when setApprovalMode throws', async () => {
            mockConfig.setApprovalMode.mockImplementation(() => {
...
//# sourceMappingURL=enterPlanMode.test.js.map