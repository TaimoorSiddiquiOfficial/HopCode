...
export interface LSToolParams {
  ...
  /**
   * Whether to respect .gitignore and .hopcodeignore patterns (optional, defaults to true)
   */
...
class LSToolInvocation extends BaseToolInvocation<LSToolParams, ToolResult> {
  ...
  async execute(_signal: AbortSignal): Promise<ToolResult> {
    try {
      ...
      const { filteredPaths, gitIgnoredCount, hopCodeIgnoredCount } =
    ...
    super(
      ...
      Kind.Search,
      {
        properties: {
          ...
          file_filtering_options: {
            description:
              'Optional: Whether to respect ignore patterns from .gitignore or .hopcodeignore',
            type: 'object',
            properties: {
              respect_git_ignore: {
                description:
