...
import { applySkillAllowedTools, collectAvailableSkillEntries, clearCollectedSkillEntriesCache, } from './skill-utils.js';
...
describe('applySkillAllowedTools', () => {
    ...
    it('no-ops without throwing when there is no permission manager', () => {
        ...
        expect(() => applySkillAllowedTools(undefined, ['Bash(git *)'])).not.toThrow();
    });
...
//# sourceMappingURL=skill-utils.test.js.map