...
export class TaskOutputTool extends BaseDeclarativeTool {
    config;
    static Name = ToolNames.TASK_OUTPUT;
    constructor(config) {
        super(TaskOutputTool.Name, ToolDisplayNames.TASK_OUTPUT, 'Records the output or result of a task. Use to attach findings or results to a task for later reference.', Kind.Think, {
            type: 'object',
            properties: {
                taskId: {
                    type: 'string',
