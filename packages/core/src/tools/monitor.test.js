...
describe('MonitorTool', () => {
    ...
    describe('schema', () => {
        it('declares monitor limits as integers', () => {
            const schema = monitorTool.schema.parametersJsonSchema;
    ...
    describe('validation', () => {
        ...
        it('rejects fractional max_events', () => {
            expect(validate({ command: 'tail -f log', max_events: 1.5 })).toBe('max_events must be a positive integer.');
        });
        ...
        it('rejects fractional idle_timeout_ms', () => {
            expect(validate({ command: 'tail -f log', idle_timeout_ms: 500.5 })).toBe('idle_timeout_ms must be a positive integer.');
        });
