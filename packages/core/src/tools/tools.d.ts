...
export type ToolResultDisplay = string | FileDiff | TodoResultDisplay | PlanResultDisplay | AgentResultDisplay | TeamResultDisplay | TaskListResultDisplay | AnsiOutputDisplay | McpToolProgressData | VisionBridgeNoticeDisplay | ShellProgressData;
