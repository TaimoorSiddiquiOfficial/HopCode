...
import { isPreapprovedHost, isPreapprovedUrl, } from './web-fetch-preapproved.js';
describe('isPreapprovedHost', () => {
    it('matches hostname-only entries on any path', () => {
        expect(isPreapprovedHost('docs.python.org', '/3/library/json.html')).toBe(true);
...
//# sourceMappingURL=web-fetch-preapproved.test.js.map