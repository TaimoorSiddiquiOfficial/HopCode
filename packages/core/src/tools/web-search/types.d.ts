...
export interface DashScopeProviderConfig {
     ...
     * If set to 'hopcode-oauth', the provider will be available.
 ...
 */
export type WebSearchProviderConfig = TavilyProviderConfig | GoogleProviderConfig | DashScopeProviderConfig | DuckDuckGoProviderConfig | ExaProviderConfig | BingProviderConfig | JinaProviderConfig | FirecrawlProviderConfig | CustomProviderConfig;
/**
