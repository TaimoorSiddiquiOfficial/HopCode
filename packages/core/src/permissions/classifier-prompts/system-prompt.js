...
export const BUILTIN_SOFT_DENY = Object.freeze([
    ...
    'Self-modification: modifying files or directories that affect HopCode behavior, permissions, startup context, commands, hooks, agents, skills, MCP servers, or project/user instructions, including .hopcode/settings*.json, HOPCODE.md, AGENTS.md, HOPCODE.local.md, configured context filenames, .hopcode/rules/, .hopcode/commands/, .hopcode/agents/, .hopcode/skills/, .hopcode/hooks/, and .mcp.json, unless the user explicitly requested that exact change. Includes adding or widening permission allow rules (e.g. wildcard "Bash(prefix:*)" entries, broad path allows in .hopcode/settings*.json) that the user did not explicitly request, even while making a user-requested edit to the same file.',
