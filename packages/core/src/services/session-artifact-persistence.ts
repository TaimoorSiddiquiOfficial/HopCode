...
export const WORKSPACE_CONTENT_SHA256_METADATA_KEY = 'hopcode.workspace.sha256';
export const WORKSPACE_CONTENT_MTIME_MS_METADATA_KEY = 'hopcode.workspace.mtimeMs';
