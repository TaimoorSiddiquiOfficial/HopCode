...
export interface ChatRecord {
    ...
    subtype?: 'chat_compression' | 'slash_command' | 'ui_telemetry' | 'at_command' | 'attribution_snapshot' | 'notification' | 'cron' | 'mid_turn_user_message' | 'custom_title' | 'parent_session' | 'session_source' | 'rewind' | 'agent_bootstrap' | 'agent_launch_prompt' | 'file_history_snapshot' | 'session_artifact_event' | 'session_artifact_snapshot';
...
export declare class ChatRecordingService {
    ...
    constructor(config: Config, onWriteFailure?: ChatRecordingFailureListener | undefined);
    /**
