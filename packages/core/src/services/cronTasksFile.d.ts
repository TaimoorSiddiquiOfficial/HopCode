 ...
 * under the user's runtime dir (`~/.hopcode/tmp/<project-hash>/`), NOT the
...
export declare const CRON_TASKS_DISPLAY_PATH = "~/.hopcode/tmp/<project-hash>/scheduled_tasks.json";
...
export declare function writeCronTasks(projectRoot: string, tasks: DurableCronTask[]): Promise<void>;
/**
 ...
 */
export declare function updateCronTasks(projectRoot: string, mutate: (tasks: DurableCronTask[]) => DurableCronTask[]): Promise<void>;
