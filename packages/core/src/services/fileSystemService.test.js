...
describe('StandardFileSystemService', () => {
    ...
    describe('writeTextFile', () => {
        ...
        it('should write file content using fs', async () => {
            ...
            expect(atomicWriteFile).toHaveBeenCalledWith('/test/file.txt', 'Hello, World!', { encoding: 'utf-8' });
        });
        ...
        it('should convert LF to CRLF when writing .bat files on Windows', async () => {
            ...
            expect(atomicWriteFile).toHaveBeenCalledWith('/test/script.bat', '@echo off\r\necho hello\r\nexit /b 0\r\n', { encoding: 'utf-8' });
        });
        it('should convert LF to CRLF when writing .cmd files on Windows', async () => {
            ...
            expect(atomicWriteFile).toHaveBeenCalledWith('/test/script.cmd', '@echo off\r\necho hello\r\n', { encoding: 'utf-8' });
        });
        ...
        it('should handle mixed line endings in .bat files on Windows', async () => {
            ...
            expect(atomicWriteFile).toHaveBeenCalledWith('/test/script.bat', 'line1\r\nline2\r\nline3\r\n', { encoding: 'utf-8' });
        });
        it('should be case-insensitive for .BAT extension on Windows', async () => {
            ...
            expect(atomicWriteFile).toHaveBeenCalledWith('/test/SCRIPT.BAT', 'echo hello\r\n', { encoding: 'utf-8' });
        });
        it('should not convert line endings for non-.bat/.cmd files on Windows', async () => {
            ...
            expect(atomicWriteFile).toHaveBeenCalledWith('/test/script.sh', '#!/bin/bash\necho hello\n', { encoding: 'utf-8' });
        });
    ...
    describe('writeTextFile with lineEnding preservation', () => {
        it('should convert LF to CRLF when lineEnding is crlf', async () => {
            ...
            expect(atomicWriteFile).toHaveBeenCalledWith('/test/file.txt', 'line1\r\nline2\r\n', { encoding: 'utf-8' });
        });
        ...
        it('should preserve CRLF for non-bat files on non-Windows when lineEnding is crlf', async () => {
            ...
            expect(atomicWriteFile).toHaveBeenCalledWith('/test/file.cs', 'using System;\r\nclass Foo {}\r\n', { encoding: 'utf-8' });
        });
    });
