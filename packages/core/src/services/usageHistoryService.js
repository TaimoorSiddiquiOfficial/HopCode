...
function getUsageHistoryPath() {
    return path.join(Storage.getGlobalHopCodeDir(), 'usage_record.jsonl');
}
    ...
    for (const projDir of projectDirs) {
        ...
        for (const file of files) {
            try {
                ...
                if (isNaN(startTime) || isNaN(endTime) || !sessionId)
                    continue;
                results.push(metricsToUsageRecord(sessionId, project, startTime, endTime, telemetry.getMetrics()));
            }
            catch (e) {
