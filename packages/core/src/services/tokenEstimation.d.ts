 ...
 */
export declare function estimatePromptTokens(history: Content[], userMessage: Content, lastPromptTokenCount: number, lastOutputTokenCount?: number, imageTokenEstimate?: number): number;
