 ...
 * a user can drop a Claude Code agent file into `.hopcode/agents/` and have it
 ...
 * its semantics would break existing `.hopcode/agents/*.md` files.
 */
...
/**
 * Mapping from Claude Code permissionMode → hopcode approvalMode.
 *
...
/**
 * Map a Claude Code `permissionMode` frontmatter value to a hopcode
