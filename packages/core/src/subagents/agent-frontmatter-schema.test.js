...
import { PERMISSION_MODE_VALUES, COLOR_VALUES, claudePermissionModeToApprovalMode, parseAgentHooks, parseAgentMcpServers, parseMaxTurns, isPermissionMode, isColor, } from './agent-frontmatter-schema.js';
describe('agent-frontmatter-schema', () => {
    ...
    describe('claudePermissionModeToApprovalMode bridge', () => {
        it('maps all 6 CC permissionMode values', () => {
            ...
            expect(claudePermissionModeToApprovalMode('acceptEdits')).toBe('auto-edit');
            expect(claudePermissionModeToApprovalMode('auto')).toBe('auto-edit');
            expect(claudePermissionModeToApprovalMode('bypassPermissions')).toBe('izn');
        ...
        it('does not walk the prototype chain for `__proto__` / `constructor`', () => {
            ...
            expect(claudePermissionModeToApprovalMode('hasOwnProperty')).toBeUndefined();
...
//# sourceMappingURL=agent-frontmatter-schema.test.js.map