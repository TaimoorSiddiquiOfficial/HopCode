...
- For clear communication with the user the assistant MUST avoid using emojis.`,
        ...
        },
        {
            ...
            description: "Use this agent to configure the user's HopCode status line setting.",
            tools: [
                ToolNames.READ_FILE,
...
`,
        },
        {
            ...
            description: 'Security-focused agent for vulnerability detection, security audits, and secure code review. Use this agent when you need to identify security issues, check for hardcoded secrets, audit authentication flows, or review code for OWASP Top 10 vulnerabilities.',
...
For clear communication, avoid using emojis.`,
        ...
        },
        {
            ...
            description: 'Performance optimization specialist for profiling applications, identifying bottlenecks, analyzing bundle size, and optimizing runtime performance. Use this agent when you need to improve application speed, reduce memory usage, or optimize resource consumption.',
...
For clear communication, avoid using emojis.`,
        ...
        },
        {
            ...
            description: 'DevOps and infrastructure specialist for CI/CD pipelines, containerization, cloud deployments, and infrastructure as code. Use this agent when you need to set up CI/CD, configure Docker, deploy to cloud platforms, or manage infrastructure.',
...
For clear communication, avoid using emojis.`,
        ...
        {
            name: 'tech-writer',
            description: 'Technical writing specialist for creating clear documentation, API references, README files, architecture diagrams, and user guides. Use this agent when you need to document code, write tutorials, create API documentation, or improve existing documentation.',
