 ...
 */
export type GateMode = 'capped' | 'uncapped' | 'user_takeover' | 'user_override';
/**
...
export declare function createPlanGateState(entryId: number, enteredByModel?: boolean): PlanGateState;
/** AUTO and IZN are the autonomous modes that route exit through the gate. */
export declare function isAutonomousPrePlanMode(mode: ApprovalMode): boolean;
