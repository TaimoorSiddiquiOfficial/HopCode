...
describe('parseGateAgentResult', () => {
    ...
    it('should throw on invalid JSON', () => {
        expect(() => parseGateAgentResult('not json at all')).toThrow('returned invalid JSON');
    });
    it('should throw on invalid decision value', () => {
        ...
        expect(() => parseGateAgentResult(json)).toThrow('returned invalid decision');
    });
...
//# sourceMappingURL=gateReviewAgents.test.js.map