...
export type GateAgentDecision = 'pass' | 'blocked' | 'needs_user' | 'unavailable';
/**
...
export type GateDecision = {
    kind: 'approved';
    nonBlockingFindings?: MergedGateFinding[];
} | {
    kind: 'blocked';
    findings: MergedGateFinding[];
} | {
    kind: 'needs_user';
    findings: MergedGateFinding[];
    questions: string[];
    ...
    kind: 'cap_escalation';
    blockingFindings: MergedGateFinding[];
};
/** Default number of capped review rounds per Plan Mode Entry. */
export declare const CAPPED_REVIEW_LIMIT = 5;
 ...
 */
export declare const CAP_ESCALATION_LABELS: {
    readonly CONTINUE: "Continue editing plan";
    readonly APPROVE: "Approve execution";
};
