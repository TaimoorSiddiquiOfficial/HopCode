...
import { type PlanGateState } from '../plan-gate/state.js';
...
import { ModelsConfig, type ModelProvidersConfig, type ProviderProtocolConfig, type AvailableModel, type RuntimeModelSnapshot } from '../models/index.js';
...
export declare class MCPServerConfig {
     ...
     * `new MCPServerConfig(...)` call sites. See issue #4615.
     */
    scope?: McpServerScope | undefined, alwaysLoadTools?: boolean | undefined);
}
/**
...
export interface ConfigParameters {
     ...
     * Overridable at runtime by `HOPCODE_CODE_MEMORY_TEAM` ('0'/'1') via
...
export declare class Config {
    ...
    private prePlanMode?;
    private planGateState?;
    private planGateEntryCounter;
