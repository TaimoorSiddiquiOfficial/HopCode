...
try {
    ...
    console.log('✅ AI SDK loaded:', ai.createOpenAI ? 'OpenAI factory available' : 'Missing OpenAI');
    // Test that OpenAI provider is available
    const openai = await import('@ai-sdk/openai');
    console.log('✅ OpenAI provider loaded:', openai.createOpenAI ? 'Factory function available' : 'Missing factory');
...
export {};
//# sourceMappingURL=test-openai-provider.js.map