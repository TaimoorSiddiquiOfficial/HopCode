...
@pytest.mark.asyncio
async def test_single_turn_query(fake_hopcode_path: str) -> None:
    result = query(
        "hello world",
        {
            "path_to_hopcode_executable": fake_hopcode_path,
        },
    )
...
@pytest.mark.asyncio
async def test_include_partial_messages(fake_hopcode_path: str) -> None:
    result = query(
        "stream partial",
        {
            "path_to_hopcode_executable": fake_hopcode_path,
...
@pytest.mark.asyncio
async def test_permission_callback_can_allow_tool_use(fake_hopcode_path: str) -> None:
...
@pytest.mark.asyncio
async def test_unknown_control_requests_are_rejected(fake_hopcode_path: str) -> None:
    result = query(
...
@pytest.mark.asyncio
async def test_dynamic_controls_and_status(fake_hopcode_path: str) -> None:
...
@pytest.mark.asyncio
async def test_session_id_resume_and_continue(fake_hopcode_path: str) -> None:
    explicit = query(
        "hello explicit",
        {
            "path_to_hopcode_executable": fake_hopcode_path,
...
@pytest.mark.asyncio
async def test_non_zero_process_exit_is_propagated(fake_hopcode_path: str) -> None:
    result = query(
        "please exit nonzero",
        {
            "path_to_hopcode_executable": fake_hopcode_path,
...
@pytest.mark.asyncio
async def test_async_context_manager(fake_hopcode_path: str) -> None:
    async with query(
        "hello context",
        {
            "path_to_hopcode_executable": fake_hopcode_path,
