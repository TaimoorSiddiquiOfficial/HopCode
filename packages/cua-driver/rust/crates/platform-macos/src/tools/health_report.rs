...
/// reports this id.
pub const CANONICAL_BUNDLE_ID: &str = "com.HopCode.cua-driver";
...
fn check_tcc_accessibility() -> CheckEntry {
    ...
    CheckEntry::fail(
        ...
        "Grant Accessibility to QwenCuaDriver.app in System Settings → Privacy & Security → \
         Accessibility. If the process bundle is not com.HopCode.cua-driver (see bundle_identity), \
...
mod tests {
    ...
    fn bundle_identity_in_test_host_fails_with_full_shape() {
        ...
        // bundle id is either absent or not com.HopCode.cua-driver. Either
