...
Run:
    python3 -m pytest Tests/integration/test_hermes_form_fill_hopcode.py -v
    # or pick one test:
    python3 -m pytest Tests/integration/test_hermes_form_fill_hopcode.py::TestQwenTextInput -v
"""
...
_ENDPOINT = os.environ.get("HERMES_HOPCODE_ENDPOINT", "http://127.0.0.1:8080/v1")
